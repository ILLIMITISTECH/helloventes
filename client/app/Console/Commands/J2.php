    ...
    public function handle()
    {
        ...
        foreach($users as $user){
            ...
            //$user->notify(new BonDebutDeSemaine());
                ...
                $taches = DB::table('actions')->select('actions.id', 'actions.deadline', 'actions.agent_id', 'actions.libelle',
                 'actions.created_at','actions.visibilite'
                    )
                ...
                $prenom = $user->prenom;
                $to = "$user->email";
                $subject = "Votre action arrivera à échéance dans 2 jours  !";
