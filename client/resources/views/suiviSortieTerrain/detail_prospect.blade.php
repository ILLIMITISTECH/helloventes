              ...
              <div class="row d-flex justify-content-center">
                <div class="row col-lg-12" style="display:flex;">
                    ...
                    <div style="border-radius: 1em; width:300px; height:320px; background-color:white;border: 1px solid
                        ...
                        <center>  
                        @if($prospect->logo) 
                            <img style="border-radius: 30em; width:100px;" src="{{url('imgs', $prospect->logo)}}">
                        @else  
                            <img style="border-radius: 30em; width:150px;" src="{{asset('Koyalis/images.jpg')}}">
                        @endif
                        </center>
                         <br>
                          <h4 style="color:black">{{$prospect->nom_entreprise}}</h4>
                          <i class="far fa-edit fa-2x mt-4"></i>
                          @php $secteur = DB::table('secteur_activites')->where('id', $prospect->secteur_activite)->first();  @endphp
                          
                          @if($secteur)
                          <h4 style="color:black">{{($secteur->libelle)}}</h4>
                          @endif
                          <br>
                         <a href="{{route('entreprise.edit',$prospect->id)}}"> 
                    ...
                    <div style="border-radius: 1em; width:750px; height:700px; background-color:white;border: 1px solid
                        ...
                        <div class="card-block text-center text-white">
                          <i class=" fas fa-user-tie fa-7x mt-5"></i>
                          <h4 style="color:black">Les points focaux</h4>
                          <i class="far fa-edit fa-2x mt-4"></i>
                          
                        @php $contacts = DB::table('contacts')->where('prospect_id', $prospect->id)->get();  @endphp
                          <br>
                           <center>
                            <table>
                              <tr>
