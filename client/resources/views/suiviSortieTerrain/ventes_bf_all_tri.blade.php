         ...
         <!--   @if(($trimestreM1 >= 01) && ($trimestreM1 <= 03))
          ...
          <div class="w-full overflow-hidden rounded-lg shadow-xs">
            ...
            <div class="w-full overflow-x-auto">
                ...
                @else
             @if($moiss >= 10)
             @if(($trimestre4 >= 10) && ($trimestre4 <= 12))
             
            <strong>Les ventes du 4em trimestre : BF </strong>
            <span style="margin-left: 20px;" class="px-2 py-1 font-semibold leading-tight text-green-700 bg-green-100 rounded-full dark:bg-green-700 dark:text-green-100">
                {{(number_format($total4)) ? number_format($total4) : '0'}} Fcfa
            </span>
             @endif 
             <table class="w-full whitespace-no-wrap">
                ...
                <tbody class="bg-white divide-y dark:divide-gray-700 dark:bg-gray-800">
                    @foreach($ventess as $ventes2)
                    
           
            @if(  (date("m", strtotime($ventes2->created_at)) >= 10) && (date("m", strtotime($ventes2->created_at)) <= 12) )
            
                    @php $op2 = DB::table('opportunites')->where('id', $ventes2->opportunite_id)->first(); @endphp
                    @php $com2 = DB::table('commerciaus')->where('id', $ventes2->commercial_id)->first(); @endphp
                    @if($com2)
                    @if($op2)
                  <tr class="text-gray-700 dark:text-gray-400">
                    ...
                    <td class="px-4 py-3 text-xs">
                      <span class="px-3 py-1 text-sm ">
                        {{(number_format($ventes2->montant)) ? number_format($ventes2->montant) : '0'}} Fcfa
                      </span>
                    </td>
          ...
          <div class="w-full overflow-hidden rounded-lg shadow-xs">
            ...
            <div class="w-full overflow-x-auto">
                ...
                @else
            @if($moiss >= 7) 
             @if(($trimestre3 >= 7) && ($trimestre3 <= 9))
            <strong>Les ventes du 3em trimestre : BF </strong>
            <span style="margin-left: 20px;" class="px-2 py-1 font-semibold leading-tight text-green-700 bg-green-100 rounded-full dark:bg-green-700 dark:text-green-100">
                {{(number_format($total3)) ? number_format($total3) : '0'}} Fcfa
            </span>
             @endif 
            ...
            @if(  (date("m", strtotime($ventes2->created_at)) >= 7) && (date("m", strtotime($ventes2->created_at)) <= 9) )
          ...
          <br>
           ...
           <div class="w-full overflow-hidden rounded-lg shadow-xs">
            ...
            <div class="w-full overflow-x-auto">
             ...
             @if(($trimestre2 >= 04) && ($trimestre2 <= 06))
            <strong>Les ventes du 2em trimestre : BF </strong>
            <span style="margin-left: 20px;" class="px-2 py-1 font-semibold leading-tight text-green-700 bg-green-100 rounded-full dark:bg-green-700 dark:text-green-100">
                {{(number_format($total2)) ? number_format($total2) : '0'}} Fcfa
            </span>
             @endif 
            ...
            @if(  (date("m", strtotime($ventes2->created_at)) >= 04) && (date("m", strtotime($ventes2->created_at)) <= 06) )
          ...
          <div class="w-full overflow-hidden rounded-lg shadow-xs">
            ...
            <div class="w-full overflow-x-auto">
                @if(count($ventess) == 0)
                <p>Pas de ventes du 1er trimestre</p>
                @else
                
                 @if(($trimestre1 >= 01) && ($trimestre1 <= 03))
            <strong>Les ventes du 1er trimestre : BF </strong>
            <span style="margin-left: 20px;" class="px-2 py-1 font-semibold leading-tight text-green-700 bg-green-100 rounded-full dark:bg-green-700 dark:text-green-100">
                {{(number_format($total1)) ? number_format($total1) : '0'}} Fcfa
            </span>
             @endif 
