        ...
        <div class="container px-6 mx-auto grid">
          <h2 class="my-6 text-2xl font-semibold text-gray-700 dark:text-gray-200">
           ...
           <div style = "margin-left: 600px; margin-top:-50px" > 
                                 <form action="{{route('filtre_rapport_prospect')}}" method="get" style="margsearchfin-top:5px; display:flex;">
            ...
            <div class="w-full overflow-x-auto">
              <table class="w-full whitespace-no-wrap">
                ...
                @php 
                    ...
                    $pros_op_total = DB::table('opportunites')->where('archiver', 0)->pluck('prospect_id')->toArray(); 
                    
                    $prospecte_total = DB::table('prospects')->pluck('id')->toArray();
