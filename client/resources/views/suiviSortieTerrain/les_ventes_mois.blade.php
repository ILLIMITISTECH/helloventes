            ...
            <div style="display-flex">
             ...
             <div style="margin-left:450px;">
                    <span 
                        ...
                        {{number_format(($les_vente_sum_mois)) ? number_format($les_vente_sum_mois) : '0'}} Fcfa
                      </span></div>
          </h2>
                              ...
                              @php
                                         ...
                                         $month_not_here = array("01","02","03","04","05","06","7","8","9","10","11","12");
                                            ...
                                            $result_month_not_heres = array_diff($month_not_here, $result_mois);
                                             $datnow = date('m');
                                        @endphp
                                 <form action="{{route('les_ventes_moisFiltre')}}" method="get" >
                                    ...
                                    <select name="searchCommerciau" style="width:220px;height:40px"  style="margin-right:10px; display:flex;">
                                        ...
                                        $entreprisess = DB::table('ventes')->whereYear('created_at', $annee)->whereMonth('created_at', $cemois)->pluck('commercial_id')->toArray();
            ...
            <div class="w-full overflow-x-auto">
             ...
             <table class="w-full whitespace-no-wrap">
                ...
                <tbody class="bg-white divide-y dark:divide-gray-700 dark:bg-gray-800">
                    @foreach($les_vente_mois as $ventes)
