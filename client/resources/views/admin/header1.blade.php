 ...
 -->												</button>
                                    ...
                                    <div class="col-lg-6 col-md-7 col-sm-6 col-xs-12">
                                        <div class="header-top-menu tabl-d-n">
                                            <ul class="nav navbar-nav mai-nav">
                                                
                                            </li>
                                               <li class="nav-item">
                                                   <a href="#" class="nav-link">
                                                    @foreach($headers as $header)
                                                      <b style="color:white;"><span class="admin-name">{{$header->nom_direction}}</span></b>  
                                                        @endforeach
                                                    </a>
                                                </li>
...
<!--                                                             <h1>Notifications</h1>
 -->                                                        </div>
                                                ...
                                                <li class="nav-item">
                                                   ...
                                                   <b style="color:white;"><span class="admin-name">Bienvenue, {{Auth::user()->prenom}}</span></b>        
