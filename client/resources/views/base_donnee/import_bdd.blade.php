      ...
      <main class="h-full pb-16 overflow-y-auto">
        ...
        <div class="container px-6 mx-auto grid">
          <h2 class="my-6 text-2xl font-semibold text-gray-700 dark:text-gray-200">
            ...
            <h3 style="text-align: justify;">Voir dans les images, un exemple des informations que doit contenir le fichier Excel à importer.
            <br>S'il vous plait de retirer la première ligne avant l'importation de votre fichier Excel.</h3>
