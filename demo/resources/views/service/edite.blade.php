                        	...
                        	<div class="navbar">
                            	<div class="navbar-inner">
	                                <ul class="breadcrumb">
	                                    ...
	                                    <li>
	                                        <a href="/services">Les Services</a> <span class="divider">/</span>	
	                                    </li>
                                            ...
                                            <div class="tab-pane" id="tab1">
                                                  ...
                                                  <fieldset>
                                                    <div class="control-group">
                                                      ...
                                                      <input name="deadline" type="text" class="form-control" value="{{$service->nom_service}}" placeholder="Date de suivi">
                                                      </div>                      
                                                    </div>
                                                    <div class="control-group">
