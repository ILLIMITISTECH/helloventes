<div class="row">
                            <div class="col-md-12">
                                <div class="main-card mb-3 card">
                                    <div class="card-header">Performance de mes directions
                                                    ...
                                                    <div class="widget-content-wrapper">
                                                        <div class="widget-content-left pr-2 fsize-1">
                                                            <div class="widget-numbers mt-0 fsize-3">
                                                                @if($agent->photo != null)
                                                                <img width="30" height="30" class="rounded-circle" src="{{asset($agent->photo)}}" alt="">
                                                                @else
                                                        ...
                                                        <div class="widget-content-right w-100">
                                                            <div class="text-muted opacity-6">
                                                                <b> <a href="{{route('user_agent.voir', $agent->id)}}" class="label label-info">{{substr($agent->prenom,0,1)}} {{substr($agent->nom,0,1)}}</a> </b>
                                                            </div> 
                                                        </div>
                                                    </div>
