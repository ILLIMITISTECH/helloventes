                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                        <ul class="breadcome-menu">
                                            ...
                                            <li><a href="/directions/create">Ajouter directions</a><span class="bread-blod"></span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
                        <div class="student-inner-std res-mg-b-30">
                            ...
                            <div class="student-dtl">
                                <h2>{{$direction->nom_direction}}</h2>
                                <form action="{{ route('directions.destroy',$direction->id) }}" method="POST">
                                  <a class="btn btn-success" href="{{ route('directions.edit',$direction->id) }}">Modifier</a>
                                    @csrf
                                    @method('DELETE')
