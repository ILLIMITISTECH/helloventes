            ...
            @include('admin.side_bar_dg')
                       ...
                       <div class="row-fluid">
                        ...
                        <div class="block">
                            ...
                            <div class="block-content collapse in">
                                <div class="span12">
                                <div class="chart" data-percent="{{intval($sum_suivi_actions/count($directions))}}">{{intval($sum_suivi_actions/count($directions))}}%</div>
                                    <div class="chart-bottom-heading"><span class="label label-info">{{$direction->nom_direction}}</span>
                ...
                <div class="row-fluid">   
                    <div class="span12">
                            ...
                            <div class="block">
                                <div class="navbar navbar-inner block-header">
                                    <div class="muted pull-left">{{$direction->nom_direction}}</div>
                                    <div class="pull-right"><span class="badge badge-info">{{count($directions)}}</span>
