                        	...
                        	<div class="navbar">
                            	<div class="navbar-inner">
	                                <ul class="breadcrumb">
	                                    ...
	                                    <li>
	                                        <a href="/directions">Les Suivi actions</a> <span class="divider">/</span>	
	                                    </li>
                                            ...
                                            <div class="tab-pane" id="tab1">
                                                  ...
                                                  <fieldset>
                                                    <div class="control-group">
                                                      ...
                                                      <input name="nom_direction" type="text" class="form-control" value="{{$direction->nom_direction}}" placeholder="Direction">
                                                      </div>                      
                                                    </div>
