                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                        <ul class="breadcome-menu">
                                            <li><a href="/admin/dashboard/rapporteur">Tbaleau de Bord</a> <span class="bread-slash">/</span>
                                            </li>
                                            <li><a href="/admin/dashboard/rapporteur">Tous les Actions</a><span class="bread-blod"></span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>  
                                        ...
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                            <div class="review-content-section">
                                                <div id="dropzone1" class="pro-ad">
                                                    ...
                                                    <form action="{{route('action_user.update', $action->id)}}" method="post"  class="dropzone dropzone-custom needsclick add-professors" id="demo1-upload" enctype="multipart/form-data">
                                                    @method('PATCH')
                                                     @csrf
                                                        <div class="row">
                                                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                                ...
                                                                <div class="form-group">
                                                                <label for="">Pourcentage(ne pas mettre(%))</label>
                                                                    <input name="pourcentage" type="text" class="form-control" value="{{$action->pourcentage}}" placeholder="pourcentage">
                                                                </div>  
                                                                <div class="form-group">
                                                                <input name="risque" id="postcode" type="hidden" value="{{$action->risque}}" class="form-control" placeholder="Risque">
                                                                   ...
                                                                   <!--  <select name="risque" class="form-control">
                                                                      <option value="{{$action->risque}}"  selected="" disabled="">Risque</option>
                                                            ...
                                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                               ...
                                                               <!--<div class="form-group">
                                                                    <input name="responsable" type="text" class="form-control" value="{{$action->responsable}}" placeholder="Résponsable">
                                                                </div>-->
                                                                ...
                                                                <input name="responsable" id="postcode" type="hidden" value="{{$action->responsable}}" class="form-control" placeholder="notes">
                                                                   ...
                                                                   <!--  <select name="responsable" class="form-control">
                                                                      <option value="none" selected="" disabled="">Select Responsable</option>
                                                                ...
                                                                <div class="form-group" hidden>
                                                                    <input name="agent_id" id="postcode" type="text" value="{{$action->agent_id}}" class="form-control" placeholder="notes">

                                                                    <!-- <select name="agent_id" class="form-control">
                                                                     <option value="{{$action->agent_id}}"  selected="" disabled="">Select Agent</option>
                                                                      @foreach($agents as $agent)
                                                                ...
                                                                <div class="form-group" hidden>
                                                                <input name="reunion_id" id="postcode" type="text" value="{{$action->reunion_id}}" class="form-control" placeholder="notes">
