    ...
    <h5>
      ...
      <div class="row">
        <div class="col-lg-10">
          ...
          <div class="card">
            <div class="card-body">
                                <h5 class="card-title">Ajouter des clients</h5>
                                <form action="/ajouter_clients" method="post" class="form-horizontal" id="demo1-upload" enctype="multipart/form-data">
                                    {{ csrf_field() }}
                                            <div class="tab-pane" id="tab1">
                                                  ...
                                                  <fieldset>
                                                   ...
                                                   <div class="control-group">
                                                      ...
                                                      <div class="controls">
                                                                    <select name="entreprise_id" style="width:500px;" class="form-control" required>
                                                    ...
                                                    <div class="control-group">
                                                      <label class="control-label" for="focusedInput">Facilitateur (<span class="red">*</span>)</label>
                                                      <div class="controls">
                                                                    <select name="facilitateur_id" style="width:500px;" class="form-control" required>
                                                                      <option value="" selected="" disabled="">Select </option>
                                                                      @foreach($facilitateur as $facilitateurs)
                                                                      <option value="{{$facilitateurs->id}}">{{$facilitateurs->prenom}} {{$facilitateurs->nom}}</option>
                                                                      @endforeach                                    
                                                                    </select>
                                                      </div>
                                                    </div>
                                                    ...
                                                    <div class="control-group">
                                                      <label class="control-label" for="focusedInput">Facilitateur Backup (<span class="red">*</span>)</label>
                                                      <div class="controls">
                                                                    <select name="facilitateur_buckup" style="width:500px;" class="form-control" required>
                                                                      <option value="" selected="" disabled="">Select </option>
                                                                      @foreach($facilitateur as $facilitateurs)
                                                                      <option value="{{$facilitateurs->id}}">{{$facilitateurs->prenom}} {{$facilitateurs->nom}}</option>
                                                                      @endforeach                                    
                                                     ...
                                                     <div class="control-group">
                                                      <label class="control-label" for="focusedInput">Source (<span class="red">*</span>)</label>
                                                      <div class="controls">
                                                                    <select name="source_id" style="width:500px;" class="form-control" required>
                                                                      <option value="" selected="" disabled="">Select </option>
                                                    ...
                                                    <div class="control-group">
                                                      ...
                                                      <div class="controls">
                                                                    <select name="departement_id" style="width:500px;" class="form-control">
