                       ...
                       <table style="width: 100%; margin-top:20px;">
                           <thead>
                               <tr>
                                  ...
                                  <!-- <img src="{{ public_path('images/chart_image.png') }}" style="width: 100%; height: 500px;" alt="Chart Image"> -->
                                      </td>
                               </tr>
                           </thead>
                       </table>
...
// Envoyez l'image au serveur Laravel
   ...
   var imageData = chart.getImageURI();
    ...
    $.ajax({
        type: 'POST',
        url: '/save-chart-image',
        data: { image: imageData },
        success: function(response) {
            console.log(response);

            // Après avoir reçu la réponse du serveur avec le chemin de l'image
            var imagePath = response.imagePath;

            // Ajoutez une balise img avec l'URL de l'image dans le PDF
            var img = document.createElement("img");
            img.src = imagePath;
            document.body.appendChild(img);

            // Appelez la fonction pour générer le PDF
            generatePDF();
        }
    });
}
