                               ...
                               <tr>
                                   ...
                                   <td style="text-align : right;">
                                       <div align="left" class="col-lg-6"  valign="top:5px">
                                            <span class="outlookFallback" title="Download"> <a href="{{route('generate.pdf', $entreprise->id)}}" align="right" type="button" download="byfeeding"><svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" class="bi bi-file-earmark-arrow-down-fill" viewBox="0 0 16 16">
                 ...
                 @php $facilitateur = DB::table('facilitateurs')->where('id', $client->facilitateur_id)->first(); @endphp
                   <div class="container">
                        <table style="width: 100%; margin-top:20px;">
                           <thead>
                               <tr>
                                   <td>TEST Byfeeding</td>
                                   <td></td>
                                   <td style="text-align : right;">Facilitateur : Facilitateur F</td>
                               </tr>
                           </thead>
                       </table>
                       ...
                       <table style="width: 100%; margin-top:20px;">
                           <thead>
                               <tr>
                                   <td>Global 360 Feedback Report -</td>
                               </tr>
                           </thead>
                       </table>
                       ...
                       <table style="width: 100%; margin-top:20px;">
                           ...
                           <thead>
                               <tr>
                                   <td style="border: solid 1px lightgray; text-align : center; height : 150px; margin-left: - 30px; box-shadow: 10px 5px 5px gray;">
                                       Satisfaction de votre equipe
                                        <div class="d-flex align-items-center">
                                            <svg style="margin-left: 100px;" xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill="currentColor" class="bi bi-activity" viewBox="0 0 16 16"><path fill-rule="evenodd" d="M6 2a.5.5 0 0 1 .47.33L10 12.036l1.53-4.208A.5.5 0 0 1 12 7.5h3.5a.5.5 0 0 1 0 1h-3.15l-1.88 5.17a.5.5 0 0 1-.94 0L6 3.964 4.47 8.171A.5.5 0 0 1 4 8.5H.5a.5.5 0 0 1 0-1h3.15l1.88-5.17A.5.5 0 0 1 6 2Z"/></svg>
                                        ...
                                        @php $feedback = DB::table('feedback')->where('source_id', $client->source_id)->where('choix', 'feedback')->count(); 
                                         $feed = DB::table('feedback')->where('source_id', $client->source_id)->where('choix', 'feedback')->get();
                                           ...
                                           $var = array();
                                            ...
                                            $notes = $nb_note == 0 ? 0 :  $total_somme_note / $nb_note;
                                         @endphp
                                   <td style="text-align : center; border: solid 1px lightgray; height 150px; box-shadow: 10px 5px 5px gray;">
                                       Feedbacks reçus
                                       <div class="d-flex align-items-center">
                                             <svg style="margin-left: 100px;" xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill="black" class="bi bi-people" viewBox="0 0 16 16"><path d="M15 14s1 0 1-1-1-4-5-4-5 3-5 4 1 1 1 1h8zm-7.978-1A.261.261 0 0 1 7 12.996c.001-.264.167-1.03.76-1.72C8.312 10.629 9.282 10 11 10c1.717 0 2.687.63 3.24 1.276.593.69.758 1.457.76 1.72l-.008.002a.274.274 0 0 1-.014.002H7.022zM11 7a2 2 0 1 0 0-4 2 2 0 0 0 0 4zm3-2a3 3 0 1 1-6 0 3 3 0 0 1 6 0zM6.936 9.28a5.88 5.88 0 0 0-1.23-.247A7.35 7.35 0 0 0 5 9c-4 0-5 3-5 4 0 .667.333 1 1 1h4.216A2.238 2.238 0 0 1 5 13c0-1.01.377-2.042 1.09-2.904.243-.294.526-.569.846-.816zM4.92 10A5.493 5.493 0 0 0 4 13H1c0-.26.164-1.03.76-1.724.545-.636 1.492-1.256 3.16-1.275zM1.5 5.5a3 3 0 1 1 6 0 3 3 0 0 1-6 0zm3-2a2 2 0 1 0 0 4 2 2 0 0 0 0-4z"/></svg>
                                            
                                            <div class="ps-3" style="color : #1561a2; font-size : 40px">{{$feedback}}</div>
                                          </div>
                                    </td>
                                   <td style="text-align : center; border: solid 1px lightgray; height : 150px; margin-left: 10px; box-shadow: 10px 5px 5px gray;">
                                      <a href="{{route('liste_actionsA.users', $entreprise->id)}}"> <h5 class="card-title" style="color:#1561a2">Actions de suivi enregistrées </h5></a>
                                                    @php
                                                       $actionss = DB::table('suivi_agent_prospects')->where('entreprise', $entreprise->id)->get();
                                                    @endphp
                                                        @php 
                                                        ...
                                                        @endphp
                                                       <a href="{{route('liste_actionsA.users', $entreprise->id)}}">
                                                      <div class="d-flex align-items-center" >
                                                          
                                                        <svg style="margin-left: 100px;" xmlns="http://www.w3.org/2000/svg" width="40" height="40"  fill="currentColor" class="bi bi-list-task" viewBox="0 0 16 16">
                                                          <path fill-rule="evenodd" d="M2 2.5a.5.5 0 0 0-.5.5v1a.5.5 0 0 0 .5.5h1a.5.5 0 0 0 .5-.5V3a.5.5 0 0 0-.5-.5H2zM3 3H2v1h1V3z"/>
                                                          <path d="M5 3.5a.5.5 0 0 1 .5-.5h9a.5.5 0 0 1 0 1h-9a.5.5 0 0 1-.5-.5zM5.5 7a.5.5 0 0 0 0 1h9a.5.5 0 0 0 0-1h-9zm0 4a.5.5 0 0 0 0 1h9a.5.5 0 0 0 0-1h-9z"/>
                                                          <path fill-rule="evenodd" d="M1.5 7a.5.5 0 0 1 .5-.5h1a.5.5 0 0 1 .5.5v1a.5.5 0 0 1-.5.5H2a.5.5 0 0 1-.5-.5V7zM2 7h1v1H2V7zm0 3.5a.5.5 0 0 0-.5.5v1a.5.5 0 0 0 .5.5h1a.5.5 0 0 0 .5-.5v-1a.5.5 0 0 0-.5-.5H2zm1 .5H2v1h1v-1z"/>
                                                        </svg>                    
                                                           <div class="ps-3" style="color : #1561a2; font-size : 40px">  {{count($actionss)}}</div>
                       ...
                       <table style="width: 100%; margin-top:20px;">
                           <thead>
                               <tr>
                                   <td>Graphique des compétences clés à développer dans votre équipe :</td>
                               </tr>
                           </thead>
                       </table>
                       ...
                       <table style="width: 100%; margin-top:20px;">
                           <thead>
                               <tr>
                                   <td> <div id="piechart" style="width: 100%; height: 500px;">&nbsp;</div></td>
                               </tr>
                           </thead>
                       </table>
                        ...
                        <table style="width: 100%; margin-top:20px;">
                           <thead>
                               <tr>
                                   <td>Rapport généré via la plateforme Byfeeding | <a href="https://byfeeding.com/" target="__blank">www.byfeeding.com</a> | By feeding we grow !</td>
                               </tr>
                           </thead>
                       </table>
                   </div>
