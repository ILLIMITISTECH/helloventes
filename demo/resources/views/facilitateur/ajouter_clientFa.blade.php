                                ...
                                <form action="/ajouter_clients" method="post" class="form-horizontal" id="demo1-upload" enctype="multipart/form-data">
                                    {{ csrf_field() }}
                                            <div class="tab-pane" id="tab1">
                                                ...
                                                @php   $facilitateurs = DB::table('facilitateurs')->where('user_id', Auth::user()->id)->first(); @endphp
                                                
                                                  <input name="facilitateur_id" type="hidden" value="{{$facilitateurs->id}}" class="form-control" style="width:500px;" placeholder="Prénom" >
                                                     <div class="control-group">
