        ...
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
                                 ...
                                 <div class="d-md-flex">
                                                <h4 class="card-title col-md-10 mb-md-0 mb-3 align-self-center">Les clients   </h4>
                                            </div> 
                                    ...
                                    <table class="table stylish-table no-wrap">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="border-top-0">Département</th>
                                            ...
                                            <tbody>
                                             ...
                                             @foreach($clients as $client) 
                                                ...
                                                @endif
                                                @php $profil = DB::table('profils')->where('id', $client->profil_id)->first(); @endphp
                                                @if($profil)
                                                <td class="align-middle" >
                                                    <div class="align-middle" >
                                                        {{$profil->libelle}} 
                                               ...
                                               <td class="align-middle" >
                                                   ...
                                                   <span class="d-inline-block" tabindex="0" style="margin-right : 7%;" data-toggle="tooltip" title="Liste des participants">
                                                       <button type="submit" id="PopoverCustomT-1"style="background:#f8f9fa; border:#f8f9fa">
                                                        <a type="submit" href="{{route('voir.liste_utilisateurs_client', $client->entreprise_id)}}" >
                                                             <img src="{{asset('images/parts.png')}}" alt="" width="20px;" height="20px;">
                                                        </a>
                                                        </button>
                                                    </span>
                                                    ...
                                                    <span class="d-inline-block" tabindex="0" style="margin-right : 10%;" data-toggle="tooltip" title="Rapport">
                                                       <button type="submit" id="PopoverCustomT-1"style="background:#f8f9fa; border:#f8f9fa">
                                                        ...
                                                        @csrf
                                                            @method('DELETE')
                                                            <span class="d-inline-block" tabindex="0" style="margin-right : 10%;" data-toggle="tooltip" title="Supprimé">
