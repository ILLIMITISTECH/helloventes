        ...
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
                                 ...
                                 <div class="d-md-flex">
                                                <h4 class="card-title col-md-10 mb-md-0 mb-3 align-self-center">Les entreprises  </h4>
                                            </div> 
                                           
                                    <table class="table stylish-table no-wrap">
                                        <thead>
                                            <tr>
                                                <th class="border-top-0">Nom Entreprise</th>
                                                            ...
                                                            <tr>
                                                                    ...
                                                                    <td class="align-middle" >
                                                                        <div class="align-middle" >
                                                                             <a type="submit" id="PopoverCustomT-1"  href="{{route('rapport_entreprise.globale', $entreprise->id)}}" >
                                                                                {{$entreprise->libelle}}
                                                                            </a>
                                                                         </div>
                                                                  ...
                                                                  <td class="align-middle" >
                                                                      <div class="align-middle" style="display : flex;" >
                                                                        <span class="d-inline-block" tabindex="0" style="margin-right : 10%;" data-toggle="tooltip">
                                                                            <a type="submit" id="PopoverCustomT-1" class="btn btn-primary"  href="{{route('rapport_entreprise.globale', $entreprise->id)}}" >
                                                                                Rapport
                                                                            </a>
                                                                        </span>
                                                                        </div> 
