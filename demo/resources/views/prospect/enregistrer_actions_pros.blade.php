        ...
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
                                ...
                                <form action="/enregistrer_actions_pros" method="post" class="form-horizontal" id="demo1-upload" enctype="multipart/form-data">
                                    {{ csrf_field() }}
                                        ...
                                        <div id="inputFormRow">
                                            <div class="input-group row mb-3">
                                                <div class="col-md-8">
                                                    ...
                                                    <input type="text" name="libelle[]" class="form-control" id="inputEmail4">
                                                </div> 
                                               
                                                <div class="col-md-8">
                                                    <label for="inputEmail4" class="form-label ">Deadline : </label>
                                                    <input type="date" name="deadline[]" placeholder="example@gmail.com" class="form-control" id="inputEmail4">
                                                </div> 
