        ...
        <div class="col-lg-12">
          ...
          <div class="card">
            ...
            <div class="card-body">
                                 ...
                                 <h4 class="card-title col-md-10 mb-md-0 mb-3 align-self-center">Les actions de suivi de {{$entreprise->libelle}}  </h4>
                                @php $actions_array = array(); 
                                    foreach($agents as $agent){
                                        $actions_agent = DB::table('suivi_agent_prospects')->where('agent_id', $agent->id)->get(); 
                                        array_push($actions_array, $actions_agent);  
                                    }
                                @endphp                     
                                    ...
                                    <table class="table stylish-table no-wrap">
                                        <thead>
                                            ...
                                            <tbody>
                                                    ...
                                                    @foreach($agents as $agent)
                                                       @php  $actions = DB::table('suivi_agent_prospects')->where('agent_id', $agent->id)->get(); @endphp
                                                         ...
                                                         <tr>
                                                                    <td class="align-middle" >
                                                                        ...
                                                                        <div class="align-middle" >
                                                                           {{$agent ? $agent->prenom : '-'}} {{$agent ? $agent->nom : '-'}}
                                                                         </div>
                                                                        
                                                                    </td>
                                                                    <td class="align-middle" >
                                                                        @php $competence1 = DB::table('competences')->where('id', $action->competence_dev1)->first();
                                                                             $competence2 = DB::table('competences')->where('id', $action->competence_dev2)->first();
                                                                             $competence3 = DB::table('competences')->where('id', $action->competence_dev3)->first();
                                                                        @endphp
                                                                        <div class="align-middle" >
                                                                                        {{$competence1 ? $competence1->libelle : '--'}} 
                                                                                        <br>
                                                                                        {{$competence2 ? $competence2->libelle : '--'}}
                                                                                         <br>
                                                                                        {{$competence3 ? $competence3->libelle : '--'}}
                                                                         </div>
