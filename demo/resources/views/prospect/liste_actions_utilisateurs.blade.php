        ...
        <div class="col-lg-12">
          ...
          <div class="card">
            ...
            <div class="card-body">
                                 ...
                                 <h4 class="card-title col-md-10 mb-md-0 mb-3 align-self-center">Les actions de suivi de {{$agent->prenom}} {{$agent->nom}}  </h4>
                                           @if($actions->isEmpty() )
                                             <p>Pas d'action</p>
                                            @else
                                    <table class="table stylish-table no-wrap">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="border-top-0">Qui vous souhaitez être dans 5 ans </th>
                                                <th class="border-top-0">Quel poste vous souhaitez être dans 5 ans</th>
                                            </tr>
                                            </thead>
                                            <tbody>
