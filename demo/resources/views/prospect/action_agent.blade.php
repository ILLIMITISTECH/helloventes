      ...
      <div class="row">
        <div class="col-lg-12">
          ...
          <div class="card">
            ...
            <div class="card-body">
                            @php $entreprise = DB::table('entreprises')->where('id', $source->entreprise_id)->first(); @endphp
                                 <h4 class="card-title col-md-10 mb-md-0 mb-3 align-self-center">Toutes les actions de {{$entreprise->libelle}}  </h4>
                                           @if($actions->isEmpty() )
                                             <p>Pas d'action</p>
                                            @else
                                            ...
                                            @if($action->visibilite == 0 or $action->visibilite == null)
                                                            <tr>
                                                                <td class="align-middle" >
                                                                     @php $agent = DB::table('agents')->where('id', $action->agent_id)->first();@endphp
