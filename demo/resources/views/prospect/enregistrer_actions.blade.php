        ...
        <div class="col-lg-10">
          ...
          <div class="card">
            <div class="card-body">
                                ...
                                <form action="/enregistrer_actions" method="post" class="form-horizontal" id="demo1-upload" enctype="multipart/form-data">
                                    {{ csrf_field() }}
                                        <h3 class="card-title">Enregristrer des actions</h3>
                                        ...
                                        <div id="inputFormRow">
                                            <div class="input-group row mb-3">
                                                ...
                                                @php $source = DB::table('source_feedbacks')->where('id', $clf->source_id)->first() ;@endphp

                                                    <label for="inputEmail4" class="form-label ">Source du Feedback <span style="color:red">*</span> :</label>
                                                    <select class="form-select" name="source[]" aria-label="Default select example" required>
                                                ...
                                                <div class="col-md-10">
                                                    <label for="inputEmail4" class="form-label ">Libellé de l'action  <span style="color:red">*</span>:</label>
                                                    <input type="text" name="libelle[]" class="form-control" id="inputEmail4" required>
                                                </div> 
                                               
                                                <div class="col-md-10">
                                                    <label for="inputEmail4" class="form-label ">Deadline  <span style="color:red">*</span>: </label>
                                                    <input type="date" name="deadline[]"  class="form-control" id="inputEmail4" required>
                                                </div> 
                                        ...
                                        <button id="addRow" type="button" class="btn btn-info mt-5" style="background:#1561a2; color:white">Ajouter d'autres actions</button>
                                                ...
                                                <div class="form-actions pull-right" style="margin-top:20px;">
                                                    <button type="submit" class="btn " style="background:#1561a2"><strong style="color:white" >Enregistrer ce plan d'action</strong></button>
                                                </div>
                                                </div>
                                                            </div>
						                          </div></div>
...
jQuery(document).ready(function() {   
 ...
 <script type="text/javascript">
            ...
            html += '  <option selected>Selectionner</option>';
                       ...
                       html += '      <option value="{{$source->id}}" selected>{{$source->nom_source}}</option>';
