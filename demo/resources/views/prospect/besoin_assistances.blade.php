        ...
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
                                ...
                                @php  $agents = DB::table('agents')->where('user_id', Auth::user()->id)->first(); @endphp
                                <h5 class="card-title">Voulez-vous que Byfeeding App vous assiste dans le suivi de vos actions ?</h5>
                                <center">
                                    <form action="{{route('assistances.oui', $agents->id)}}" method="post" class="form-horizontal" id="demo1-upload" enctype="multipart/form-data">
                                        {{ csrf_field() }}
                                     ...
                                     <form action="{{route('assistances.non', $agents->id)}}" method="post" class="form-horizontal" id="demo1-upload" enctype="multipart/form-data" style="margin-left:70px;margin-top:-38px ">
                                        {{ csrf_field() }}
                                            <div class="tab-pane" id="tab1">
                                                  <fieldset>
                                                  <button class="btn btn-primary" type="submit">Non</button>
                                                  </fieldset>
                                            </div>
                                    </form>
                                    </center>
