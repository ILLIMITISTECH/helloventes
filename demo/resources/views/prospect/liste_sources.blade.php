        ...
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
                                 ...
                                 <div class="d-md-flex">
                                                <h4 class="card-title col-md-10 mb-md-0 mb-3 align-self-center">Les sources  </h4>
                                            </div> 
                                                            ...
                                                            <tr>
                                                                  ...
                                                                  <td class="align-middle" >
                                                                      <div class="align-middle" style="display : flex;" >
                                                                        <form action="{{route('activer', $sources->id)}}" method="post">
                                                                          
                                                                           {{csrf_field()}}
                                                                           <button type="submit">Activer</button>
                                                                        </form>
                                                                         <form action="{{route('desactiver', $sources->id)}}" method="post" style="margin-left : 10px;">
