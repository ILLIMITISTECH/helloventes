                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                        <ul class="breadcome-menu">
                                            ...
                                            <li><a href="/reunions">Toutes les Reunions</a><span class="bread-blod"></span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                                                                ...
                                                                <div class="form-group">
                                                                 ...
                                                                 <!--<div class="form-group alert-up-pd">
                                                                  <div class="dz-message needsclick download-custom">
                                                                    ...
                                                                    <h2 class="edudropnone">Drop liste des participants ici or click to upload.</h2>
                                                                    <input name="liste" class="hd-pro-img" type="file">
