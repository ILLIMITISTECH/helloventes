...
<html class="no-js">
                            	...
                            	<div class="navbar-inner">
	                                <ul class="breadcrumb">
	                                    ...
	                                    <li>
	                                     ...
	                                     <li>
	                                        <a href="/reunions/create">Programmer une runion</a> <span class="divider">/</span>	
	                                    </li> 
    ...
    <div class="row-fluid">   
        <div class="span12">
                            ...
                            <div class="block">
                                <div class="navbar navbar-inner block-header">
                                    <div class="muted pull-left">Reunions</div>
                                    <div class="pull-right"><span class="badge badge-info">{{count($reunions)}}</span>
                                ...
                                <div class="block-content collapse in">
                                    ...
                                    <thead>
                                               ...
                                               @foreach($reunions as $reunion)
                                                   <tr>
                                                      <td>{{$reunion->objet}}</td>
                                                      <td>{{strftime("%d/%m/%Y", strtotime($reunion->date))}}</td>
