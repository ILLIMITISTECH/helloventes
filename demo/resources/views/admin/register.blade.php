			...
			<div class="content-error">
				<div class="hpanel">
                    ...
                    <div class="panel-body">
                        <form method="POST" action="{{ route('inscription.register') }}" enctype="multipart/form-data" id="loginForm">
                        {{ csrf_field() }}
                            <div class="row">
                                ...
                                <div class="form-group col-lg-6">
                                    <label>Confiremer Votre mot de passe</label>
