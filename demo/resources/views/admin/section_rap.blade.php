                        ...
                        <div class="block">
                                ...
                                <div class="span12 block-content collapse in" style="display:flex; justify-content:space-between;">
                                    @foreach($agents as $agent)
                                         ...
                                         <b><a href="{{route('user_agent_rap.voir', $agent->id)}}" class="label label-info"  style="border-radius: 15px; border:solid 2px lightblue;">{{$agent->prenom}} {{$agent->nom}}</a></b></p>
                            ...
                            <div class="span12">
                                ...
                                <div class="block">
                                    ...
                                    <h5> @if (session('message'))
                                            ...
                                            @endif</h5>
                                        <div class="muted pull-left"><span class="caption-subject"><b>Mes <span class="badge badge-info"></span> actions en instance</b></span></div>
                                                                      ...
                                                                      <td> 
                                                                       ...
                                                                       <td>                                  
                                                                           <div class="student-dtl" style="display:flex; justify-content: space-evenly;">
                                                                              ...
                                                                              <a href="{{route('action_user_r.editer', $action->id)}}" class="button"> <div class="flip-box">
                                                                          ...
                                                                          <a href="{{route('action_user_rap.editer', $action->id)}}" class="button"><div class="flip-box">
                                                                                            <div class="flip-box-inner">
                                                                                                <div class="flip-box-front">
     ...
     <div class="row-fluid">
                                                                 ...
                                                                 <tr>
                                                                      ...
                                                                      <td> 
                                                                       ...
                                                                       <td>{{$action->raison}}</td>
                                                                        ...
                                                                        <td> 
                                                                       <div class="student-dtl" style="display:flex; justify-content: space-evenly;"> 
                                                                        <a href="{{route('action_rap_reasigner.editer', $action->id)}}" class="button"><div class="flip-box">
                                                                                            <div class="flip-box-inner">
                                                                                                <div class="flip-box-front">
                                                                        ...
                                                                        <a href="{{route('action_rap_asigner.editer', $action->id)}}" class="button"><div class="flip-box">
                                                                                            <div class="flip-box-inner">
                                                                                                <div class="flip-box-front">
                        ...
                        <div class="row-fluid">
                            <div class="span12">
                                ...
                                <div class="block">
                                    <div class="navbar navbar-inner block-header">
                                    <h5> @if (session('messageRapporteur'))
                                                <div class="alert alert-success" role="alert">
                                                    {{ session('messageRapporteur') }}
                                                </div>  
                                            @endif</h5>
                                                               ...
                                                               @foreach($action_bakups as $action)
                                                                 ...
                                                                 <tr>
                                                                      ...
                                                                      <div class="student-dtl" style="display:flex; justify-content: space-evenly;">
                                                                              ...
                                                                              <a href="{{route('action_user_frapporteur.editer', $action->id)}}" class="button"><div class="flip-box">
                                                                                            <div class="flip-box-inner">
                                                                                                <div class="flip-box-front">
                                                                                                <img src="{{asset('images/illimitis/maj1.jpeg')}}" alt="Paris" style="height:25px; width:25px;">
                                                                                                </div>
