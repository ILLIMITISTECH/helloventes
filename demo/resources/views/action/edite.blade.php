                        	...
                        	<div class="navbar">
                            	<div class="navbar-inner">
	                                <ul class="breadcrumb">
	                                    ...
	                                    <li>
	                                        <a href="/actions">Toutes les actions</a> <span class="divider">/</span>	
	                                    </li>
                                ...
                                <div class="span12">
                                    <div id="rootwizard">
                                       ...
                                       <!--  <div id="bar" class="progress progress-striped active">
                                        ...
                                        <form action="{{route('actions.update', $action->id)}}" method="post" class="form-horizontal" id="demo1-upload" enctype="multipart/form-data">
                                        @method('PATCH')
                                                     @csrf
                                            <div class="tab-pane" id="tab1">
                                                  ...
                                                  <fieldset>
                                                    ...
                                                    <div class="control-group">
                                                      ...
                                                      <input name="pourcentage" type="number" class="form-control" value="{{$action->pourcentage}}" placeholder="Durée" id="pourcent" min="0" max="100" step="2">
                                                      </div>                      
                                                    </div>
                                                    <div class="control-group">
                                                    ...
                                                    <div class="control-group">
                                                      <label class="control-label" for="focusedInput">Select Responsable de cette direction</label>
                                                      <div class="controls">
