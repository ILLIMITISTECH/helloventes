                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                        <ul class="breadcome-menu">
                                            ...
                                            <li><a href="/actions">Tous les Actions</a><span class="bread-blod"></span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>  
                                        ...
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                            <div class="review-content-section">
                                                <div id="dropzone1" class="pro-ad">
                                                    ...
                                                    <form action="{{route('actions.update', $action->id)}}" method="post"  class="dropzone dropzone-custom needsclick add-professors" id="demo1-upload" enctype="multipart/form-data">
                                                    @method('PATCH')
                                                     @csrf
                                                        <div class="row">
                                                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                                ...
                                                                <div class="form-group">
                                                                    <input name="deadline" type="date" class="form-control" value="{{$action->deadline}}" placeholder="date de l action">
                                                                </div>
                                                                <div class="form-group" hidden>
                                                                    <input name="visibilite" type="hidden" class="form-control" value="0" placeholder="visibilite">
                                                                </div> 
                                                                <div class="form-group" hidden>
                                                                    <input name="delais" type="hidden" class="form-control" value="jours" placeholder="Durée">
                                                                </div>  
                                                                 <div class="form-group">
                                                                    <input name="pourcentage" type="text" class="form-control" value="{{$action->pourcentage}}" placeholder="Durée">
                                                                </div> 
                                                                <div class="form-group">
                                                            ...
                                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                                ...
                                                                <div class="form-group">
                                                                    <select name="responsable" class="form-control">
                                                                      <option value="none" selected="" disabled="">Select Responsable de cette direction</option>
                                                                ...
                                                                <div class="form-group">
                                                                    <select name="agent_id" class="form-control">
                                                                      <option value="{{$action->agent_id}}"  selected="" disabled="">Select Responsable du projet</option>
