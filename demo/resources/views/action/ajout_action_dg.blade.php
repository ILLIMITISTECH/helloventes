                        	...
                        	<div class="navbar">
                            	<div class="navbar-inner">
	                                <ul class="breadcrumb">
	                                    ...
	                                    <li>
	                                        <a href="/voir_action_dg">Toutes les actions</a> <span class="divider">/</span>	
	                                    </li>
                                    ...
                                    {{ csrf_field() }}
                                            <div class="tab-pane" id="tab1">
                                                  ...
                                                  <fieldset>
                                                    ...
                                                    <!--</div>-->
                                                    <!--<div class="control-group">-->
                                                    <!--  <label class="control-label" for="focusedInput">Sélectionner Responsable de cette direction</label>-->
                                                    <!--  <div class="controls">-->
                                                     
                                                    <!--  <select name="responsable" class="form-control">-->
                                                    <!--                  <option value="none" selected="" disabled="">Sélectionner Responsable de cette direction</option>-->
