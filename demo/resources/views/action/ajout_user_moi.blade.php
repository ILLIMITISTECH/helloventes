                                            ...
                                            <div class="tab-pane" id="tab1">
                                                  ...
                                                  <fieldset>
                                                    <div class="control-group">
                                                      ...
                                                      <input name="libelle" type="text" class="form-control" placeholder="Donnez le libellé de votre action" required="required">
                                                      </div>                      
                                                    </div>
                                                    <div class="control-group">
                                                      ...
                                                      <input name="deadline" type="date" class="form-control" placeholder="Donnez la date limite de votre action" required="required">   
                                                                                                                     </div>                    
                                                    </div>
                                                    <div class="control-group">
                                                      ...
                                                      <input name="delais" type="hidden" class="form-control" value="jours" placeholder="Donnez la durée de votre action">
                                                      </div>                      
                                                    </div>
                                                    <div class="control-group">
                                                    ...
                                                    <!--<div class="control-group">
                                                      <label class="control-label" for="focusedInput">Select Responsable de votre direction</label>
                                                      <div class="controls">
                                                     
                                                      <select name="responsable" class="form-control">
                                                                      <option value="none" selected="" disabled="">Select Responsable de votre direction</option>
                                                    ...
                                                    <div class="control-group" hidden>
                                                      ...
                                                      @foreach($res_agents as $agent)
                                                                      @foreach($asignes as $agente)
                                                                      @if($agente->direction_id == $agent->direction_id)
                                                      <input name="responsable" id="postcode" type="text" value="{{$agent->prenom}}" class="form-control" placeholder="notes">
                                                       @endif
                                                                      @endforeach 
                                                                      @endforeach 
                                                    ...
                                                    <div class="control-group" hidden>
                                                      <label class="control-label" for="focusedInput">Responsable du Projet</label>
                                                      <div class="controls">
