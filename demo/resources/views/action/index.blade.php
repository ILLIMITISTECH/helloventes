                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                        <ul class="breadcome-menu">
                                            ...
                                            <li><a href="/actions/create">Ajouter actions</a><span class="bread-blod"></span>
                                            </li>
                                        </ul>
                                    </div>
                                      <td>
                                                    <form action="/search" method="get" style="margin-top:5px;">
                                                    <select name="search" style="width:500px;" required>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
                        <div class="student-inner-std res-mg-b-30">
                           <!-- <div class="student-img">
                                <img src="{{url('images',$action->photo)}}" style="height:200px;" alt="" />
                            </div> -->
                            <div class="student-dtl">
                               
                                <h3>Responsable: {{$action->prenom}} {{$action->nom}}</h3>
                                 <h2>Backup: {{$action->bakup}}</h2>
                                <p class="dp">Action: {{$action->libelle}}</p>
                                <p class="dp-ag"><b></b>Deadline: {{strftime("%d/%m/%Y", strtotime($action->deadline))}}</p>
                                <p class="dp-ag"><b></b>Note: {{$action->note}}</p>
                                <p class="dp-ag"><b></b>Durée: {{$action->delais}}</p>
                                <p class="dp-ag"><b></b>Risque: {{$action->risque}}</p>
