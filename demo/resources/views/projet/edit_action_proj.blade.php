                ...
                <div class="app-main__outer">
                    <div class="app-main__inner">
                     <div class="main-card mb-3 card">
                            <div class="card-body">
                                <form action="{{route('action_proj.update', $action->id)}}" method="post"  class="dropzone dropzone-custom needsclick add-professors" id="demo1-upload" enctype="multipart/form-data">
                                                    @method('PATCH')
                                                     @csrf
                                            <div class="tab-pane" id="tab1">
                                             ...
                                             <fieldset>
                                                    ...
                                                    <div class="control-group">
                                                     ...
                                                     <div class="control-group">
                                                      <div class="controls">
                                                      <input name="projet_id" type="hidden" class="form-control" value="{{$action->projet_id}}" placeholder="visibilite">
                                                      </div>
                                                    </div>
                                                    <div class="control-group">
                                                      <div class="controls">
                                                     ...
                                                     <div class="control-group">
                                                      ...
                                                      <div class="controls">
                                                         <select name="agent_id" class="form-control">
                                                          <option value="{{$action->agent_id}}">Sélectionner</option>
