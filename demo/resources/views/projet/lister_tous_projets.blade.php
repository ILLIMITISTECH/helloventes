                                            ...
                                            @if($action->visibilite == 0)
                                                            ...
                                                            <tr class="actions">
                                                                ...
                                                                <input type="hidden" value="{{csrf_token()}}" name="_token"/>
                                                                   ...
                                                                   @php $agentbackup = DB::table('agents')->where('id', $action->responsable)->first(); @endphp
                                                                    @if($agentbackup)
                                                                   ...
                                                                   @if($action->priorite == 'Elevé(E)')
                                                                            <td class="align-middle"><i class='fas fa-dot-circle' style='font-size: 20px;color: #FF0000'></i></td>
                                                                            @elseif($action->priorite == 'Moins(M)')
                                                                            <td class="align-middle"><i class='fas fa-dot-circle' style='font-size:20px;color:#eed202'></i></td>
                                                                            @else($action->priorite == 'Faible(F)')
                                                                            <td class="align-middle"><i class='fas fa-dot-circle' style='font-size:20px;color:#00800'></i></td>
                                                                            @endif
