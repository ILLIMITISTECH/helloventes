                        	...
                        	<div class="navbar">
                            	<div class="navbar-inner">
	                                <ul class="breadcrumb">
	                                    ...
	                                    <li>
	                                        <a href="/decissions">Toutes les decissions</a> <span class="divider">/</span>	
	                                    </li>
                                ...
                                <div class="span12">
                                    <div id="rootwizard">
                                       ...
                                       <!--  <div id="bar" class="progress progress-striped active">
                                        ...
                                        <form action="{{route('decissions.update', $decission->id)}}" method="post" class="form-horizontal" id="demo1-upload" enctype="multipart/form-data">
                                        @method('PATCH')
                                                     @csrf
                                            <div class="tab-pane" id="tab1">
                                                  ...
                                                  <fieldset>
                                                    <div class="control-group">
                                                      <label class="control-label" for="focusedInput">Decission</label>
                                                      <div class="controls">
                                                     
                                                      <input name="libelle" type="text" value="{{$decission->libelle}}" class="form-control" placeholder="Decission">
                                                      </div>                      
                                                    </div>
                                                    <div class="control-group">
                                                      <label class="control-label" for="focusedInput">Delais</label>
                                                      <div class="controls">
                                                     
                                                      <input name="delais" type="text" value="{{$decission->delais}}" class="form-control" placeholder="Délais">
                                                      </div>                      
                                                    </div>
                                                    <div class="control-group">
                                                      <label class="control-label" for="focusedInput">Select Agent</label>
                                                      <div class="controls">
                                                      
                                                      <select name="agent_id" class="form-control">
                                                                      <option value="{{$decission->agent_id}}" selected="" disabled="">Select Agent</option>
                                                    ...
                                                    <div class="control-group">
                                                      <label class="control-label" for="focusedInput">Select Reunion</label>
                                                      <div class="controls">
                                                      
                                                      <select name="reunion_id" class="form-control">
                                                                      <option value="{{$decission->reunion_id}}" selected="" disabled="">Select Reunion</option>
