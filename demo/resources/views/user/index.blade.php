                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                        <ul class="breadcome-menu">
                                            ...
                                            <li><a href="/users/create">Ajouter Utilisateurs</a><span class="bread-blod"></span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
                        <div class="student-inner-std res-mg-b-30">
                            <div class="student-img">
                                <img src="{{url('images',$user->photo)}}" style="height:200px;" alt="" />
                            </div>
                            <div class="student-dtl">
                                <h2>{{$user->prenom}} {{$user->nom}}</h2>
                                <p class="dp">Adresse Email: {{$user->email}}</p>
                                <p class="dp-ag"><b>Role:</b> {{$user->nom_role}}</p>
                                <form action="{{ route('users.destroy',$user->id) }}" method="POST">
                                  <a class="btn btn-success" href="{{ route('users.edit',$user->id) }}">Modifier</a>
                                    @csrf
                                    @method('DELETE')
