                                ...
                                <div class="span12">
                                    <div id="rootwizard">
                                       ...
                                       <!--  <div id="bar" class="progress progress-striped active">
                                        ...
                                        <form action="{{route('suivi_indicateurs.store')}}" method="post" class="form-horizontal" id="demo1-upload" enctype="multipart/form-data">
                                    {{ csrf_field() }}
                                                  ...
                                                  <fieldset>
                                                    ...
                                                    <div class="control-group">
                                                      ...
                                                      <select name="indicateur_id" class="form-control">
                                                                      <option value="none" selected="" disabled="">Select Indicateur</option>
