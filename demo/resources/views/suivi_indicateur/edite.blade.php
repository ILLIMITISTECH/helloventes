                        	...
                        	<div class="navbar">
                            	<div class="navbar-inner">
	                                <ul class="breadcrumb">
	                                    ...
	                                    <li>
	                                        <a href="/suivi_indicateurs">Suivi indicateurs</a> <span class="divider">/</span>	
	                                    </li>
                                ...
                                <div class="span12">
                                    <div id="rootwizard">
                                       ...
                                       <!--  <div id="bar" class="progress progress-striped active">
                                        ...
                                        <form action="{{route('suivi_indicateurs.update', $suivi_indicateur->id)}}" method="post" class="form-horizontal" id="demo1-upload" enctype="multipart/form-data">
                                        @method('PATCH')
                                                     @csrf
                                            <div class="tab-pane" id="tab1">
                                                  ...
                                                  <fieldset>
                                                    <div class="control-group">
                                                      ...
                                                      <input name="date" type="date" value="{{$suivi_indicateur->date}}" class="form-control" placeholder="date">
                                                      </div>                      
                                                    </div>
                                                    <div class="control-group">
                                                      <label class="control-label" for="focusedInput">Pourcentage</label>
                                                      <div class="controls">
                                                     
                                                      <input name="pourcentage" type="text" value="{{$suivi_indicateur->pourcentage}}" class="form-control" placeholder="Pourcentage ">
                                                      </div>                      
                                                    </div>
                                                    <div class="control-group">
                                                      ...
                                                      <input name="note" type="text" value="{{$suivi_indicateur->note}}" class="form-control" placeholder="Note">

                                                      </div>                      
                                                    </div>
                                                    <div class="control-group">
                                                      <label class="control-label" for="focusedInput">Direction</label>
                                                      <div class="controls">
                                                      
                                                      <select name="indicateur_id" class="form-control">
                                                                      <option value="{{$suivi_indicateur->indicateur_id}}" selected="" disabled="">Select Indicateur</option>
