                                    ...
                                    <div class="col-lg-12 col-md-6 col-sm-6 col-xs-12">
                                        <div class="breadcome-heading">
                                           <table id="datatable-buttons" class="table table-striped table-bordered" style="margin-top:50px;"> 
                                                ...
                                                <p><b>{{$agent->prenom}} {{$agent->nom}}</b>: <b style="color:green;">{{intval($sum_suivi_actions/count($agents))}}%</b></p>

                                                @if(intval($sum_suivi_actions/count($agents)) >= "100")
                                                ...
                                                @elseif(intval($sum_suivi_actions/count($agents)) >= "90")
                                                <div class="progress m-b-0">
                                                ...
                                                @elseif(intval($sum_suivi_actions/count($agents)) >= "80")
                                                <div class="progress m-b-0">
                                                ...
                                                @elseif(intval($sum_suivi_actions/count($agents)) >= "70")
                                                <div class="progress m-b-0">
                                                ...
                                                @elseif(intval($sum_suivi_actions/count($agents)) >= "60")
                                                <div class="progress m-b-0">
                                                ...
                                                @elseif(intval($sum_suivi_actions/count($agents)) >= "40")
                                                <div class="progress m-b-0">
                                                ...
                                                @elseif(intval($sum_suivi_actions/count($agents)) >= "30")
                                                <div class="progress m-b-0">
                                                ...
                                                @elseif(intval($sum_suivi_actions/count($agents)) >= "20")
                                                <div class="progress m-b-0">
                                                ...
                                                @elseif(intval($sum_suivi_actions/count($agents)) >= "10")
                                                <div class="progress m-b-0">
                                                ...
                                                @elseif(intval($sum_suivi_actions/count($agents)) >= "5")
                                                <div class="progress m-b-0">
                                                ...
                                                @elseif(intval($sum_suivi_actions/count($agents)) >= "00")
                                                <div class="progress m-b-0">
                                ...
                                <div class="row">
                                    <div class="col-lg-12 col-md-6 col-sm-6 col-xs-12">
                                        ...
                                        @endif</h5>
                                            ...
                                            <span class="caption-subject"><b>Les actions pour lesquelles {{$agent->prenom}} {{$agent->nom}} est responsable</b></span>
                                        </div>
                            ...
                            <div class="portlet-title">
                                <div class="row">
                                    <div class="col-lg-12 col-md-6 col-sm-6 col-xs-12">
                                        ...
                                        @endif</h5>
                                            <span class="caption-subject"><b>Les actions pour lesquelles {{$agent->prenom}} {{$agent->nom}} est Backup</b></span>
                                        </div>
                                        <div style="margin-top:50px;"> 
