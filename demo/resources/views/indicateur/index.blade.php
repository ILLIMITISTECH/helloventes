                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                        <ul class="breadcome-menu">
                                            ...
                                            <li><a href="/indicateurs/create">Ajouter indicateurs</a><span class="bread-blod"></span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
                        <div class="student-inner-std res-mg-b-30">
                            ...
                            <div class="student-dtl">
                                <h2>Indicateur: {{$indicateur->libelle}}</h2>
                                <p class="dp">Cible: {{$indicateur->cible}}</p>
                                <p class="dp-ag"><b>Date:</b> {{$indicateur->date_cible}}</p>
                                <form action="{{ route('indicateurs.destroy',$indicateur->id) }}" method="POST">
                                  <a class="btn btn-success" href="{{ route('indicateurs.edit',$indicateur->id) }}">Modifier</a>
                                    @csrf
                                    @method('DELETE')
