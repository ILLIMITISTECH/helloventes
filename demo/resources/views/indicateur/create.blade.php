                                ...
                                <div class="span12">
                                    <div id="rootwizard">
                                       ...
                                       <!--  <div id="bar" class="progress progress-striped active">
                                        ...
                                        <form action="{{route('indicateurs.store')}}" method="post" class="form-horizontal" id="demo1-upload" enctype="multipart/form-data">
                                    {{ csrf_field() }}
                                            <div class="tab-pane" id="tab1">
                                                  ...
                                                  <fieldset>
                                                    <div class="control-group">
                                                      ...
                                                      <input name="libelle" type="text" class="form-control" placeholder="Indicateur">
                                                      </div>                      
                                                    </div>
                                                    <div class="control-group">
                                                      ...
                                                      <input name="cible" type="text" class="form-control" placeholder="Nom du cible">
                                                    ...
                                                    <div class="control-group">
                                                      <label class="control-label" for="focusedInput">Date cible</label>
                                                      <div class="controls">
                                                      
                                                      <input name="date_cible" id="postcode" type="date" class="form-control" placeholder="Date du cible">

                                                                                                                     </div>                    
                                                    </div>
                                                    <div class="control-group">
                                                      <label class="control-label" for="focusedInput">Date du suivi</label>
                                                      <div class="controls">
                                                      
                                                      <input name="date" id="postcode" type="date" class="form-control" placeholder="Date du cible">
                                                    ...
                                                    <div class="control-group">
                                                      ...
                                                      <input name="note" type="text" class="form-control" placeholder="Notes...">
