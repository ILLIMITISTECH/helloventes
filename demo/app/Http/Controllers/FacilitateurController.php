   ...
   public function voir_rapport_client($id)
     ...
     public function voir_detail_client($id)
    {
        ...
        //return view('facilitateur.detail_client',compact('agents', 'feedback','entreprise','competence_1','competence_2','competence_3','competence_4','competence_5','competence_12','competence_6','competence_7','competence_8','competence_9','competence_10','competence_11'));
           return view('facilitateur.detail_client_check',compact('agents', 'feedback','entreprise','competence_1','competence_2','competence_3','competence_4','competence_5','competence_12','competence_6','competence_7','competence_8','competence_9','competence_10','competence_11'));
  ...
  public function saveImage(Request $request)
{
    ...
    // Utilisez la méthode put de Storage pour stocker l'image dans le dossier public
    Storage::disk('public')->put($imageName, $imageData);

    // Récupérez le chemin complet vers l'image
 ...
 $imagePath = $request->input('imagePath');
          // Générez le PDF de manière asynchrone
    $pdf = PDF::loadView('facilitateur.detail_client_pdf', compact('agents', 'feedback', 'entreprise', 'competence_1', 'competence_2',
        'competence_3', 'competence_4', 'competence_5', 'competence_12', 'competence_6', 'competence_7', 'competence_8',
        'competence_9', 'competence_10', 'competence_11'))
        ->setOptions(['images' => true, 'imagePath' => public_path()])
        ->setOptions(['defaultFont' => 'sans-serif'])
        ->setOptions(['enable-javascript', true])
        ->setOptions(['javascript-delay', 1000])
        ->setOptions(['no-stop-slow-scripts', true])
        ->setOptions(['enable-smart-shrinking', true]);

    // Envoyez une requête au serveur pour générer le PDF après que l'image du graphique a été créée
    $pdf->save(public_path('rapport-byfeeding.pdf'));

    return response()->download(public_path('rapport-byfeeding.pdf'));
            ...
            //$pdf = PDF::loadView('facilitateur.detail_client_pdf')->setOptions(['defaultFont' => 'sans-serif']);
           
               // return view('facilitateur.detail_client_pdf',compact('agents', 'feedback','entreprise','competence_1','competence_2','competence_3','competence_4','competence_5','competence_12','competence_6','competence_7','competence_8','competence_9','competence_10','competence_11'));
