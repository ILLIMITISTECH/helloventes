...
class ProspectionController extends Controller
{
       ...
       public function rapport_commercial($id)
    {
       ...
       public function rapport_individuel()
    {
        $mois = date('m');
        $commerciaux = DB::table('commerciaus')->orderBy('prenom')->get();
        ...
        return view('suiviSortieTerrain.rapport_individuel', compact( 'commerciau', 'performances'));
    }
       ...
       public function rapport_team()
    {
        ...
        $annee = date('m');
        $commerciaux = DB::table('commerciaus')->orderBy('prenom')->get();
        $performances = DB::table('performance_globales')->whereYear('created_at', $annee)->whereMonth('created_at', $mois)->get();
      ...
      public function rapport_teamFiltre(Request $request)
    {
       ...
       public function rapport_teamYear()
    {
       
        $mois = date('m');
        $annee = date('Y');
        $commerciaux = DB::table('commerciaus')->orderBy('prenom')->get();
        $performances = DB::table('stock_mensuelles_globales')->whereYear('created_at', $annee)->get();
       // $performances = DB::table('stock_mensuelles')->whereYear('created_at', $annee)->groupBy('created_at')->get();
        
        //dd($performances);
       
        return view('suiviSortieTerrain.rapport_teamYear', compact('commerciaux', 'performances'));
    }
    
      public function rapport_teamYearFiltre(Request $request)
    {
        $mois = date('m');
        $annee = date('Y');
        $searchMois = $request->get('searchMois');
       ...
       public function rapport_teamYearme()
    {
        ...
        $commerciaux = DB::table('commerciaus')->orderBy('prenom')->get();
        $commerciau = Commerciau::where('user_id', Auth::user()->id)->first();
        $performances = DB::table('stock_mensuelles')->where('commercial_id', $commerciau->id)->whereYear('created_at', $annee)->get();
        //$performances = DB::table('performance_globales')->whereYear('created_at', $annee)->whereMonth('created_at', $mois)->get();
        return view('suiviSortieTerrain.rapport_teamYearme', compact('commerciaux', 'performances', 'performances', 'commerciau'));
    }
    
       public function rapport_teamOpportunite()
    {
       
       $opportunitesParCommercial = Opportunite::select('commercial_id', DB::raw('COUNT(*) as nombre_opportunites'))
        ->groupBy('commercial_id')
        ->orderBy('nombre_opportunites', 'desc')
        ->get();
        
        $opportunitesParCommercialSum = DB::table('opportunites')
        //->groupBy('commercial_id')
        //->orderBy('nombre_opportunites', 'desc')
        ->count();
        
        return view('suiviSortieTerrain.rapport_teamOpportunite', compact('opportunitesParCommercial', 'opportunitesParCommercialSum'));
    }
    
      public function rapport_teamYearFiltreme(Request $request)
    {
        $mois = date('m');
        $annee = date('Y');
        $searchMois = $request->get('searchMois');
        $commerciaux = DB::table('commerciaus')->orderBy('prenom')->get();
        $commerciau = Commerciau::where('user_id', Auth::user()->id)->first();
        $performances = DB::table('performances')->where('commercial_id', $commerciau->id)->whereYear('created_at', $annee)->whereMonth('created_at','like', '%'.$searchMois.'%')->get();

        //$performances = DB::table('performance_globales')
       // ->whereYear('created_at', $annee)
       // ->whereMonth('created_at','like', '%'.$searchMois.'%')
       // ->get();
        return view('suiviSortieTerrain.rapport_teamYearme', compact('commerciaux', 'performances', 'commerciau'));
    }
      ...
      public function rapport_teamBF()
    {
        ...
        $Y = date('Y');
        $commerciaux = DB::table('commerciaus')->orderBy('prenom')->get();
        $performances = DB::table('performance_bf_globales')->whereYear('created_at', $Y)->whereMonth('created_at', $mois)->get();
        return view('suiviSortieTerrain.rapport_teamBF', compact('commerciaux', 'performances'));
    }
    
       public function rapport_teamCI()
    {
        // $performances = array();
        // $commerciaux = DB::table('commerciaus')->orderBy('prenom')->get();
        // foreach($commerciaux as $commerciau){
        ...
        $Y = date('Y');
        $commerciaux = DB::table('commerciaus')->orderBy('prenom')->get();
        $performances = DB::table('performance_ci_globales')->whereYear('created_at', $Y)->whereMonth('created_at', $mois)->get();
        return view('suiviSortieTerrain.rapport_teamCI', compact('commerciaux', 'performances'));
    }
      ...
      public function rapport_teamSN()
    {
        ...
        $Y = date('Y');
        $commerciaux = DB::table('commerciaus')->orderBy('prenom')->get();
        $performances = DB::table('performance_sn_globales')->whereYear('created_at', $Y)->whereMonth('created_at', $mois)->get();
      ...
      public function rapport_teamBFFiltre(Request $request)
    {
        ...
        $searchMois = $request->get('searchMois');
        $commerciaux = DB::table('commerciaus')->orderBy('prenom')->get();
        $performances = DB::table('performance_bf_globales')
        ->whereYear('created_at', $Y)
        ->whereMonth('created_at','like', '%'.$searchMois.'%')
        ->get();
        return view('suiviSortieTerrain.rapport_teamBF', compact('commerciaux', 'performances'));
      ...
      public function rapport_teamCIFiltre(Request $request)
    {
        $mois = date('m');
        $Y = date('Y');
        $searchMois = $request->get('searchMois');
        $commerciaux = DB::table('commerciaus')->orderBy('prenom')->get();
        $performances = DB::table('performance_ci_globales')
        ->whereYear('created_at', $Y)
        ->whereMonth('created_at','like', '%'.$searchMois.'%')
        ->get();
        return view('suiviSortieTerrain.rapport_teamCI', compact('commerciaux', 'performances'));
   ...
   public function cloturer_mon_planning(Request $request, $id)
      ...
      public function planningsMois()
    {
        ...
        foreach (range(0, 6) as $day) {
            ...
            ->get();
                ...
                foreach($planningfg as $planningf){
                        array_push($planningb, $planningf);
                        }
        ...
        return view('suiviSortieTerrain.planningsMois', compact('planning','planning_avenir'));
    }
     ...
     public function planningsFiltre(Request $request)
    {
          ...
          $PayscommercialFiltre =  $request->get('PayscommercialFiltre');       
                   $week = [];
         $saturday = strtotime('monday this week');
        foreach (range(0, 6) as $day) {
                    $week[] = date("Y-m-d", (($day * 86400) + $saturday));
            ...
            //->where('pays_id','like', '%'.$PayscommercialFiltre.'%')
            //->whereIn('commercial_id',[$commercialFiltre])
            ->when(request()->has('commercialFiltre'), function($q){
            $q->where('commercial_id', request('commercialFiltre'));
            })
            ->when(request()->has('PayscommercialFiltre'), function($q){
                $q->where('pays_id', request('PayscommercialFiltre'));
            })
            ->orderby('date', 'desc')
            ->get();
     ...
     public function planningsFiltreMois(Request $request)
    {
                    $semaineM7 = (date('d') -7);
                    $action_semaineP7 = (date('d') +7);
                    $action_mois = date('m');
   ...
   public function ajout_prospection()
    {
        ...
        $commercial = DB::table('commerciaus')->orderBy('prenom')->get();
        $pays = DB::table('pays')->whereIn('id', ['1', '5', '13'])->orderBy('libelle')->get();
       
        return view('suiviSortieTerrain.ajouter_visite', compact('entreprise','opportunite','produit','commercial', 'pays'));

    }
    
    
    public function getOpportunitesByProspect(Prospect $prospect)
    {
...
{
    $categoryId = $request->input('prospect_id');
    $subcategories = Opportunite::where('prospect_id', $categoryId)->get();
    ...
    public function store_prospection(Request $request)
    {
                ...
                $prospection->pays_id = $request->get('pays_id');
                ...
                $action->pays_id = $prospection->pays_id;
    ...
    public function prospect_stra()
    {
        ...
        $prospects = DB::table('prospects')->where('strategique', 1)->orderBy('created_at', 'desc')->get();
        ...
        $prospects_pole = DB::table('prospects')->select('prospects.*', 'commerciaus.id as ID', 'commerciaus.domaine_id')
            ...
            ->orderBy('prospects.created_at', 'desc')->get();
    ...
    {
        $commercial = Commerciau::where('user_id', Auth::user()->id)->first();
        $entreprise = DB::table('prospects')->where('commercial_id', $commercial->id)->orderby('strategique', 'desc')->get();
        return view('suiviSortieTerrain.lister_entreprise', compact('entreprise'));
    }
    
    public function marcher_lister_entreprise()
    {
        $commercial = Commerciau::where('user_id', Auth::user()->id)->first();
        $entreprise = DB::table('prospects')->where('commercial_id', $commercial->id)->orderby('strategique', 'desc')->get();
        return view('suiviSortieTerrain.marche_lister_entreprise', compact('entreprise'));
    }
    ...
    // app/Http/Controllers/ProductController.php
        public function liveSearch(Request $request)
        {
            ...
            $products = Prospect::where('nom_entreprise', 'LIKE', "%$query%")
                               ->limit(10)
                               ->get();
    ...
    { 
        //prospect_maTeam
        $entreprise = DB::table('prospects')->orderBy('strategique', 'desc')->get();
   ...
   public function create_entreprise()
    ...
    $query = $request->input('query');
    $suggestions = Prospect::where('nom_entreprise', 'LIKE', "%$query%")->limit(10)->get();
    ...
    public function opportunite_prospect_store(Request $request, $id)
    {
        ...
        if($request->file('notes')){
           ...
           $file_name = $notes->getClientOriginalName();
           $notes->move(public_path().'/notes/', $file_name);
        }
                ...
                $opportunite->notes  = (isset($file_name)) ? $file_name : $opportunite->notes;
