...
Route::get('/create_spontane', 'OpportuniteController@create_spontane');
Route::post('/opportunites/spontane-store', 'OpportuniteController@spontane_store')->name('spontane_store');
Route::get('/spontane_lister', 'OpportuniteController@spontane_lister');
