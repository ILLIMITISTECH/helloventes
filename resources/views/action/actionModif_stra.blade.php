       ...
       <a data-toggle="tooltip" title="Retour" style="width:90px; margin-left:30px"  type="button" id="PopoverCustomT-1" class="nm" href="javascript:history.go(-1)" >
                ...
                <div class="container px-6 mx-auto grid">
                    ...
                    <div class="px-4 py-3 mb-8 bg-white rounded-lg shadow-md dark:bg-gray-800">
                        <!-- Invalid input -->
                        <form action="{{route('update_action_stra', $actionComercial->id)}}" enctype="multipart/form-data" method="post" class="form-horizontal" id="demo1-upload" >
                            {{ csrf_field() }}
                           ...
                           <label class="block text-sm">
                            <span class="text-gray-700 dark:text-gray-400">
                                Opportunité
                                                  ...
                                                  @php $oppo = DB::table('opportunites')->where('id', $actionComercial->opportunite_id)->first(); @endphp
                        <select id="country" name="opportunite_id"
                            ...
                            <option value="{{$actionComercial->opportunite_id}}" >{{$oppo->libelle}}</option>
                        </select>
                        ...
                        <label class="block text-sm">
                            ...
                            <input name="libelle" type="text" value="{{$actionComercial->libelle}}"
                                class="block w-full mt-1 text-sm border-gray-600 dark:text-gray-300 dark:bg-gray-700 focus:border-red-400 focus:outline-none focus:shadow-outline-red form-input"
                        ...
                        <label class="block text-sm">
                            ...
                            <input type="date" name="deadline" value="{{$actionComercial->deadline}}"
                                class="block w-full mt-1 text-sm border-gray-600 dark:text-gray-300 dark:bg-gray-700 focus:border-red-400 focus:outline-none focus:shadow-outline-red form-input"
                ...
                <div class="col-md-12">
                    ...
                    <div class="form-check">
                      <input class="form-check-input" type="radio" name="priorite" @if($actionComercial->priorite === "1") checked @endif value="1" >
                      <label class="form-check-label dark:text-gray-400" for="exampleRadios1">
                      Oui
                      </label>
                   </div>
                   <div class="form-check">
                      <input class="form-check-input" type="radio" name="priorite" @if($actionComercial->priorite === "0") checked @endif value="0" >
                      ...
                      Non
                           ...
                           <div class="form-control">
                                    ...
                                    @php     $commer = DB::table('commerciaus')->where('id', $actionComercial->commercial_id)->first(); @endphp
