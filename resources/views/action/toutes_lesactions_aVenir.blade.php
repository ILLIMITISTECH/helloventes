  ...
  @php $commercial = DB::table('commerciaus')->where('user_id', Auth::user()->id)->first(); @endphp
                ...
                @endphp
                            ...
                            <div  class="col-md-3" style = "margin-top:-20px" align="right"> 
                                 <form action="{{route('toutes_actionsFiltre_aVenir')}}" method="get">
                                    ...
                                    <select name="serachPays" style="width:220px;height:40px; margin-left:10px;"  id="origine">
                                        ...
                                        ->whereYear('action_commerciales.deadline', '>=', $annee)->whereMonth('action_commerciales.deadline','>=', $mois)->whereDay('action_commerciales.deadline','>=', $semaineM7)                                       ->where('cloture', 0)
