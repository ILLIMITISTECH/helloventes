...
<main class="h-full pb-16 overflow-y-auto" >
  ...
  @php $commercial = DB::table('commerciaus')->where('user_id', Auth::user()->id)->first(); @endphp
                 @php
                         $actionss = DB::table('action_commerciales')->where('superieur_id', $commercial->id)->whereDay('deadline', '<=', $action_semaineP7)->WhereDay('deadline', '>=', $semaineM7)->whereMonth('deadline', $action_mois)->whereYear('deadline', $annee)->where('cloture', 1)->get();
                @endphp
                
                                                                                        @php 
                                        $prospectsf = DB::table('action_commerciales')->where('superieur_id', $commercial->id)->where('cloture', 1)->whereDay('deadline', '<=', $action_semaineP7)->WhereDay('deadline', '>=', $semaineM7)->whereMonth('deadline', $action_mois)->whereYear('deadline', $annee)->pluck('opportunite_id')->toArray(); 
                            ...
                            <div  class="col-md-3" style = "margin-top:-20px"  > 
                                 <form action="{{route('toutes_actionsFiltre_fait_res')}}" method="get">
                                     <select name="serachCom" style="width:220px;height:40px"  id="statut" style="margin-right:10px; display:flex;">
                                        ...
                                        $entreprisess = DB::table('action_commerciales')->where('superieur_id', $commercial->id)->whereDay('deadline', '<=', $action_semaineP7)->WhereDay('deadline', '>=', $semaineM7)->whereMonth('deadline', $action_mois)->whereYear('deadline', $annee)->where('cloture', 1)->pluck('commercial_id')->toArray();
                ...
                @if( ($action_semaineP7 >= date('d', strtotime($actionCommercialss->deadline))) && ($semaineM7 <= date('d', strtotime($actionCommercialss->deadline))) && ($action_mois == date('m', strtotime($actionCommercialss->deadline))) && ($annee == date('Y', strtotime($actionCommercialss->deadline))) )
                  ...
                  <tr class="text-gray-700 dark:text-gray-400">
                    ...
                    <td class="px-4 py-3 text-xs" data-toggle="tooltip" title="{{$actionCommercialss->libelle}}">
                      <span class="px-3 py-1 text-sm ">
                          <h4>{{ \Illuminate\Support\Str::limit($actionCommercialss->libelle, 25, $end='...') }}</h4>
                        </span>
                    </td>
                    ...
                    <td class="px-4 py-3 text-xs" data-toggle="tooltip" title="{{$Prospect->nom_entreprise}}">
                        <b style="color:#9045e2">
                            {{ \Illuminate\Support\Str::limit(strtoupper($Prospect->nom_entreprise), 15, $end='...') }}
                            </b>
                    </td>
                            ...
                            <div  class="col-md-3" style = "margin-top:-20px"  > 
                                 <form action="{{route('toutes_actionsFiltre_fait_res')}}" method="get">
                                     <select name="serachCom" style="width:220px;height:40px"  id="statut" style="margin-right:10px; display:flex;">
                                        ...
                                        @php 
                                        $commerciauxs = DB::table('commerciaus')->pluck('id')->toArray();
                                        $entreprisess = DB::table('action_commerciales')->where('superieur_id', $commercial->id)->whereMonth('deadline', $action_mois)->whereYear('deadline', $annee)->where('cloture', 1)->pluck('commercial_id')->toArray();
              ...
              <table class="w-full whitespace-no-wrap">
                ...
                <tbody class="bg-white divide-y dark:divide-gray-700 dark:bg-gray-800">
                    ...
                    $mois = date('m');
                      $annee = date('Y'); 
                     @endphp
                @if($actionCommercialss_pole->cloture == 1)
                @if( ($action_semaineP7 >= date('d', strtotime($actionCommercialss_pole->deadline))) && ($semaineM7 <= date('d', strtotime($actionCommercialss_pole->deadline))) && ($action_mois == date('m', strtotime($actionCommercialss_pole->deadline))) && ($annee == date('Y', strtotime($actionCommercialss_pole->deadline))) )
                  ...
                  <tr class="text-gray-700 dark:text-gray-400">
                    ...
                    <td class="px-4 py-3 text-xs" data-toggle="tooltip" title="{{$actionCommercialss_pole->libelle}}">
                      <span class="px-3 py-1 text-sm ">
                          <h4>{{ \Illuminate\Support\Str::limit($actionCommercialss_pole->libelle, 25, $end='...') }}</h4>
                        </span>
                    </td>
            ...
            <div class="w-full overflow-x-auto">
              <table class="w-full whitespace-no-wrap">
                ...
                <tbody class="bg-white divide-y dark:divide-gray-700 dark:bg-gray-800">
                     ...
                     @endphp
                     @if($actionCommercial_pole->cloture == 1)
