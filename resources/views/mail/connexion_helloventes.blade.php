      ...
      <div style=" border: 1px solid #dadce0;   border-radius: 8px;   margin-bottom: 8px;">
       ...
       <img src="{{asset('Koyalis/hellovente3.png')}}" alt="homepage" class="dark-logo" style="max-width: 90%;"><br><br>
        ...
        <div style="  font-size: 20px;   font-family: &#39;Google Sans&#39;,Roboto,Arial,sans-serif;   font-weight: 500;   line-height: 28px;   padding: 0 8px 20px; color:black;">
            La plateforme Koyalis ayant été remplacée par Hello Ventes, voici désormais le nouveau lien sur lequel vous pouvez vous connecter : <b>tamtam.helloventes.com</b>.<br>
        <div><br>
      
       <div style="  font-size: 20px;   font-family: &#39;Google Sans&#39;,Roboto,Arial,sans-serif;   font-weight: 500;   line-height: 28px;   padding: 0 8px 20px; color:black;">
          Vos credentials ne changent pas et vos données restent sécurisées.
          <p> Si vous rencontrez des difficultés merci de vous adresser à la @tech nous restons à l'ecoute. </p>
          </b>
         <br>
