                                ...
                                <div class="block-content collapse in">
                                   ...
                                   <div class="navbar navbar-inner block-header">
                                    ...
                                    @foreach($agents as $agent)
                                         ...
                                         <b><a href="{{route('responsable_agent.voir', $agent->id)}}" class="label label-info"  style="border-radius: 15px; border:solid 2px lightblue;">{{$agent->prenom}} {{$agent->nom}}</a></b></p>
                                    ...
                                    <!-- <div class="span6">
                                        <div class="chart" data-percent="{{intval($sum_directions/count($action_directions))}}">{{intval($sum_directions/count($action_directions))}}%</div>
                                        <div class="chart-bottom-heading"><span class="label label-info">Performances de ma direction</span>
                            ...
                            <div class="span12">
                                ...
                                <div class="block">
                                    ...
                                    <h5> @if (session('message'))
                                            ...
                                            @endif</h5>
                                        <div class="muted pull-left"><span class="caption-subject"><b>Mes actions en instance</b></span></div>
                                                                      ...
                                                                      <td> 
                                                                       ...
                                                                       <td>                                  
                                                                           <div class="student-dtl" style="display:flex; justify-content: space-evenly;">
                                                                              <!--<a href="{{route('action_responsable.editer', $action->id)}}"><button type="submit" id="action" class="button">Save Ant Maj</button></a>-->
                                                                              <a href="{{route('action_responsable.editer', $action->id)}}" class="button"><div class="flip-box">
                                                                              ...
                                                                              <a href="{{route('action_responsable_a.editer', $action->id)}}" class="button"><div class="flip-box">
                                                                                            <div class="flip-box-inner">
                                                                                                <div class="flip-box-front">
        ...
        <div class="modal-body">
                            ...
                            <div id="selectDiv{{$action->id}}">
                                ...
                                <div class="check">       
                                 ...
                                 <center>   <input id="loginVisibilite{{$action->id}}" type="radio" name="visibilite" value="2"><b style="font-size:15px; margin-left:10px; color:green;">OUI</b>
...
<div class="form-group" hidden>
                    ...
                    <button type="button" data-toggle="modal" data-target="#centralModalSm">
                          ...
                          @endif 
                                                                              ...
                                                                              <!--<button><a href="{{route('history_responsable.voir', $action->id)}}" class="button">History</a></button>-->
                                                                      ...
                                                                      <!-- <td>
                                                                            @if($action->visibilite==0)
                                                                                    ...
                                                                                    <div style="color:brown;">Passer chez DG</div>
                            ...
                            <div class="span12">
                                ...
                                <div class="block">
                                    ...
                                    <h5> @if (session('message'))
                                            ...
                                            @endif</h5>
                                        <div class="muted pull-left"><span class="caption-subject"><b>Actions escaladées de ma Direction</b></span></div>
                                        <div class="pull-right">
                                                                 ...
                                                                 <tr>
                                                                      ...
                                                                      <td> 
                                                                       ...
                                                                       <td>{{$action->raison}}</td>
                                                                        ...
                                                                        <td> 
                                                                       <div class="student-dtl" style="display:flex; justify-content: space-evenly;"> 
                                                                         <a href="{{route('action_responsable_reasigner.editer', $action->id)}}" class="button"><div class="flip-box">
                                                                                            <div class="flip-box-inner">
                                                                                                <div class="flip-box-front">
                                                                        ...
                                                                        <a href="{{route('action_responsable_asigner.editer', $action->id)}}" class="button"><div class="flip-box">
                                                                                            <div class="flip-box-inner">
                                                                                                <div class="flip-box-front">
                            ...
                            <div class="span12">
                                ...
                                <div class="block">
                                    ...
                                    <h5> @if (session('messageResponsable'))
                                            ...
                                            @endif</h5>
                                        <div class="muted pull-left"><span class="caption-subject"><b>Les <span class="badge badge-info"></span> actions pour lesquelles je suis Backup</b></span></div>
                                        <div class="pull-right">
                                                               ...
                                                               @foreach($action_bakups as $action)
                                                                 ...
                                                                 <tr>
                                                                      ...
                                                                      <td>                                  
                                                                           <div class="student-dtl" style="display:flex; justify-content: space-evenly;">
                                                                              <!--<a href="{{route('action_responsable.editer', $action->id)}}"><button type="submit" id="action" class="button">Save Ant Maj</button></a>-->
                                                                              <a href="{{route('action_user_fresponsable.editer', $action->id)}}" class="button"><div class="flip-box">
                                                                                            <div class="flip-box-inner">
                                                                                                <div class="flip-box-front">
                                                                                                <img src="{{asset('images/illimitis/maj1.jpeg')}}" alt="Paris" style="height:25px; width:25px;">
                                                                                                </div>
                            ...
                            <div class="span12">
                                ...
                                <div class="block">
                                    ...
                                    <h5> @if (session('message'))
                                            ...
                                            @endif</h5>
                                        <div class="muted pull-left"><span class="caption-subject"><b>Les <span class="badge badge-info"></span> actions de ma Direction</b></span></div>
                                        <div class="pull-right">
 ...
 <script type="text/javascript">
    $(function () {
        $("#dialog").dialog({
            modal: true,
            autoOpen: false,
            title: "Ëtes-vous sûre de vouloir clôturer cette action",
            width: 300,
            height: 150
