                                ...
                                <div class="row">
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                        <div class="caption pro-sl-hd">
                                            <span class="caption-subject"><b>Annonces</b></span>
                                        </div>
                                    </div>
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                        ...
                        <div class="product-sales-chart">
                            <div class="portlet-title">
                                <div class="row">
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                        <div class="caption pro-sl-hd">
                                            <span class="caption-subject"><b>Projets</b></span>
                                        </div>
                                    </div>
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                          ...
                                          <span class="text-success">{{$suivi->pourcentage}}</span>
                                            ...
                                            <td>
                                              ...
                                              <div class="student-dtl">
                                                    ...
                                                    <!--<p class="dp-ag"><b>Date d'anniversaire:</b> {{$suivi->date_naiss}}</p>-->
                                                </div>
                                            </td>
                                          <td>{{$suivi->date}}</td>
                                      </tr>
