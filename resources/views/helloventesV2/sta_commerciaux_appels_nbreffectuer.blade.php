        ...
        <div class="container px-6 mx-auto grid">
          <h2 class="my-6 text-2xl font-semibold text-gray-700 dark:text-gray-200">
            Les prospects déjà appelé de <b>{{$commercial->prenom}} {{$commercial->nom}}
                          ...
                          @php $appels_effectuer = DB::table('prospect_a_appellers')->where('commercial_id', $commercial->id)->where('statut', 1)->whereYear('created_at', $annee)->whereMonth('created_at', $mois)->orderby('nom_entreprise')->get(); @endphp
                ...
                @foreach($appels_effectuer as $entreprises) 
                  <tr class="text-gray-700 dark:text-gray-400">
                     ...
                     <td class="px-4 py-3 text-sm" data-toggle="tooltip" title="{{$entreprises->nom_entreprise}}">
                         {{ \Illuminate\Support\Str::limit(($entreprises->nom_entreprise) ? $entreprises->nom_entreprise : 'Non renseigné', 25, $end='...') }}
                    </td>
                     ...
                     <td class="px-4 py-3 text-sm">
                      {{($entreprises->email_entreprise) ? $entreprises->email_entreprise : ''}} / {{($entreprises->tel_fixe) ? $entreprises->tel_fixe : ''}}
                    </td>
