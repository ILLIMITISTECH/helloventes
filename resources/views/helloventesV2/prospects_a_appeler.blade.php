       ...
       <a data-toggle="tooltip" title="Retour" style="width:90px; margin-left:30px"  type="button" id="PopoverCustomT-1" class="nm" href="javascript:history.go(-1)" >
        ...
        <div class="container px-6 mx-auto grid">
          <h2 class="my-6 text-2xl font-semibold text-gray-700 dark:text-gray-200">
            Les prospects à appeler
          </h2>
          
                <div style = "margin-left: 400px; margin-top:-50px" > 
                                 <form action="{{route('search_pros_numero')}}" method="get" style="margsearchfin-top:5px; display:flex;">
                                    ...
                                    <select name="search" style="width:220px;height:40px"  id="statut" style="margin-right:10px; display:flex;">
                                      ...
                                      @php
                                        ...
                                        @foreach($entreprisess as $entreprisesss)
              ...
              <table class="w-full whitespace-no-wrap">
                ...
                @foreach($entreprise as $entreprises) 
                  <tr class="text-gray-700 dark:text-gray-400">
                    ...
                    <!--</td>-->
                     <td class="px-4 py-3 text-sm">
                      {{($entreprises->tel_contact) ? $entreprises->tel_contact : ''}}<br>{{($entreprises->nom_contact) ? $entreprises->nom_contact : ''}}
                    </td>
                    
                    <td class="px-4 py-3 text-sm">
                      {{($entreprises->solution_a_vendre) ? $entreprises->solution_a_vendre : ''}}
                    </td>
