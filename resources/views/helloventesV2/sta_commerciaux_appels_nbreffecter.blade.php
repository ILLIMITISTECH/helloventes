       ...
       <a data-toggle="tooltip" title="Retour" style="width:90px; margin-left:30px"  type="button" id="PopoverCustomT-1" class="nm" href="javascript:history.go(-1)" >
        ...
        <div class="container px-6 mx-auto grid">
          <h2 class="my-6 text-2xl font-semibold text-gray-700 dark:text-gray-200">
            Les prospects à appeler de <b>{{$commercial->prenom}} {{$commercial->nom}}
          </h2>
          
                
                   
 @php         $appels_a_effectuer = DB::table('prospect_a_appellers')->where('commercial_id', $commercial->id)->where('statut', null)->whereYear('created_at', $annee)->whereMonth('created_at', $mois)->orderby('nom_entreprise')->get();
 @endphp
                             <br>
             <h6> 
              @if (session('message'))
        ...
        <div class="w-full overflow-x-auto">    
              <table class="w-full whitespace-no-wrap">
                ...
                @foreach($appels_a_effectuer as $entreprises) 
                  <tr class="text-gray-700 dark:text-gray-400">
                    ...
                    <td class="px-4 py-3 text-sm" data-toggle="tooltip" title="{{$entreprises->nom_entreprise}}">
                     ...
                     <td class="px-4 py-3 text-sm">
                      {{($entreprises->nom_contact) ? $entreprises->nom_contact : ''}} 
                    </td>
                     <td class="px-4 py-3 text-sm">
                      {{($entreprises->tel_contact) ? $entreprises->tel_contact : ''}}
                    </td>
                    ...
                    <div style="display:flex ">
                        ...
                        <a href="{{ route('fiche_prospect',$entreprises->id) }}">
