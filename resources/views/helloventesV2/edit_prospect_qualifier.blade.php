       ...
       <a data-toggle="tooltip" title="Retour" style="width:90px; margin-left:30px"  type="button" id="PopoverCustomT-1" class="nm" href="javascript:history.go(-1)" >
                ...
                <div class="container px-6 mx-auto grid">
                    ...
                    <div class="px-4 py-3 mb-8 bg-white rounded-lg shadow-md dark:bg-gray-800">
                        <!-- Invalid input -->
                        <form action="{{route('prospect_qualifier.update', $entreprise->id)}}" method="post" class="dropzone dropzone-custom needsclick add-professors" id="demo1-upload" enctype="multipart/form-data">
                                                     @csrf
                 ...
                 <div class="form-group" >
                            <div class="form-control">
                                   ...
                                   <select name="etat_qualifier"  style="width:400px;"   class="block w-full mt-1 text-sm border-gray-600 dark:text-gray-300 dark:bg-gray-700 focus:border-red-400 focus:outline-none focus:shadow-outline-red form-input" style="width:400px;">
                                      @if($suivi_q->etat_qualifier)
                                      <option value="{{$suivi_q->etat_qualifier}}">{{$suivi_q->etat_qualifier}}</option>
                                       @foreach($suivi_qualifier as $suivi_qualifiers)
                                      <option value="{{$suivi_qualifiers->libelle}}">{{$suivi_qualifiers->libelle}}</option>
                                      @endforeach
                                      @else
                                      <option value="" disabled selected>Selectionner le next step </option>
                                      @foreach($suivi_qualifier as $suivi_qualifiers)
                                      <option value="{{$suivi_qualifiers->libelle}}">{{$suivi_qualifiers->libelle}}</option>
                                      @endforeach
                                      @endif
                        ...
                        <label class="block text-sm">
                         ...
                         <label class="block text-sm">
                            ...
                            <input name="tel_contact" type="tetx" style="width:400px;" value="{{$entreprise->tel_contact}}"
                                class="block w-full mt-1 text-sm border-gray-600 dark:text-gray-300 dark:bg-gray-700 focus:border-red-400 focus:outline-none focus:shadow-outline-red form-input"
                                placeholder="+2......" />
                        </label>
                        ...
                        <label class="block text-sm">
                            ...
                            <input name="autre_besoins" type="text" style="width:400px;" value="{{$entreprise->autre_besoins}}"
                                class="block w-full mt-1 text-sm border-gray-600 dark:text-gray-300 dark:bg-gray-700 focus:border-red-400 focus:outline-none focus:shadow-outline-red form-input"
                                placeholder="Libellé de l'action" />
                        </label>
                      ...
                      <div class="form-group" style="display:flex;">
                                    <div class="form-control">
                                              <label class="block text-sm" style="width:400px;">
                                                ...
                                                <input  name="personne_a_contacter" type="text" value="{{$suivi_q->personne_a_contacter}}"
                            ...
                            <div class="form-control">
                                      <label class="block text-sm" style="margin-left:50px;width:400px;">
                                        ...
                                        <input  name="contact_personne" type="text" value="{{$suivi_q->contact_personne}}"
                                            class="block w-full mt-1 text-sm border-gray-600 dark:text-gray-300 dark:bg-gray-700 focus:border-green-400 focus:outline-none focus:shadow-outline-green form-input"
                            ...
                            <div class="form-control">
                                      <label class="block text-sm" style="width:400px;">
                                        ...
                                        <input  name="email_personne" type="email" value="{{$suivi_q->email_personne}}"
                                            class="block w-full mt-1 text-sm border-gray-600 dark:text-gray-300 dark:bg-gray-700 focus:border-green-400 focus:outline-none focus:shadow-outline-green form-input"
                                          style="width:400; " />
                                    </label>
                            </div> <br>
                            <div class="form-control">
                                      <label class="block text-sm" style="margin-left:50px;width:400px;">
                                        <span class="text-gray-700 dark:text-gray-400">
                                          Détailler les centres d'intérêts
                                        </span> 
                                        <input  name="centre_dinteret" type="text" value="{{$suivi_q->centre_dinteret}}"
                                            class="block w-full mt-1 text-sm border-gray-600 dark:text-gray-300 dark:bg-gray-700 focus:border-green-400 focus:outline-none focus:shadow-outline-green form-input"
                                            placeholder="Détailler les centres d'intérêts" style="width:400; " />
                                    </label>
                            </div> 
                 </div> 
                    </div>
