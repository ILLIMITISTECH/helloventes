        ...
        <div class="w-full overflow-x-auto">    
              <table class="w-full whitespace-no-wrap">
                ...
                <tr class="text-gray-700 dark:text-gray-400">
                    ...
                    @if($pros)
                    <td class="px-4 py-3 text-sm">
                      {{ \Illuminate\Support\Str::limit(($pros->nom_entreprise) ? $pros->nom_entreprise : 'Non renseigné', 30, $end='...') }}
                    </td>
                    @else
                    ...
                    <td class="px-4 py-3 text-sm">
                      {{date('Y-m-d', strtotime($entreprises->date_rendezvous))}} 
                    </td>
                    ...
                    @else
                    <td style="color:orange" class="px-4 py-3 text-sm">En cours..</td>
                    @endif
