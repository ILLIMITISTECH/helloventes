       ...
       <a data-toggle="tooltip" title="Retour" style="width:90px; margin-left:30px"  type="button" id="PopoverCustomT-1" class="nm" href="javascript:history.go(-1)" >
                ...
                <div class="container px-6 mx-auto grid">
                    <h2 class="my-6 text-2xl font-semibold text-gray-700 dark:text-gray-200">
                        Résultats de l'appel / Mise à jour du prospect
                    </h2>
                    ...
                    <div class="px-4 py-3 mb-8 bg-white rounded-lg shadow-md dark:bg-gray-800">
                        <!-- Invalid input -->
                        <form action="{{route('prospect_a_appeler.update', $entreprise->id)}}" method="post" class="dropzone dropzone-custom needsclick add-professors" id="demo1-upload" enctype="multipart/form-data">
                                                     @csrf
                 ...
                 <div class="form-group" >
                    ...
                    <div class="form-group" style="display:flex;">
                        ...
                        <label class="block text-sm">
                            ...
                            <input name="site_web" type="text" style="margin-left:50px;width:400px;" value="{{$entreprise->site_web}}"
                                class="block w-full mt-1 text-sm border-gray-600 dark:text-gray-300 dark:bg-gray-700 focus:border-red-400 focus:outline-none focus:shadow-outline-red form-input"
                                placeholder="Besoins prioritaires" />
                        </label>
                    ...
                    <br>
                        ...
                        <label class="block text-sm">
                            ...
                            <input name="secteur_activite" type="text" style="width:400px;" value="{{$entreprise->secteur_activite}}"
                                class="block w-full mt-1 text-sm border-gray-600 dark:text-gray-300 dark:bg-gray-700 focus:border-red-400 focus:outline-none focus:shadow-outline-red form-input"
                                placeholder="Autres besoins" />
                        </label>
                        <!--<label class="block text-sm">-->
