        ...
        <div class="container px-6 mx-auto grid">
          <h2 class="my-6 text-2xl font-semibold text-gray-700 dark:text-gray-200">
            Les prospects qualifiés de <b>{{$commercial->prenom}} {{$commercial->nom}}
                          ...
                          @php $appelsaqualifier = DB::table('suivi_prospects')->where('type', 1)->where('commercial_id', $commercial->id)->whereYear('created_at', $annee)->whereMonth('created_at', $mois)->get(); @endphp
