       ...
       <a data-toggle="tooltip" title="Retour" style="width:90px; margin-left:30px"  type="button" id="PopoverCustomT-1" class="nm" href="javascript:history.go(-1)" >
                ...
                <div class="container px-6 mx-auto grid">
                    ...
                    <div class="px-4 py-3 mb-8 bg-white rounded-lg shadow-md dark:bg-gray-800">
                        <!-- Invalid input -->
                        <form action="/ajouter_bdd_store" method="post" class="dropzone dropzone-custom needsclick add-professors" id="demo1-upload" enctype="multipart/form-data">
                                                     @csrf
                 ...
                 <div class="form-group" >
                    ...
                    <div class="form-group" style="display:flex;">
                        <label class="block text-sm">
                            ...
                            <input name="nom_entreprise" type="text" style="width:400px;" 
                    ...
                    <div class="form-group" style="display:flex;">  
                        <label class="block text-sm">
                            ...
                            <input name="secteur" type="text" style="width:400px;" 
                                class="block w-full mt-1 text-sm border-gray-600 dark:text-gray-300 dark:bg-gray-700 focus:border-red-400 focus:outline-none focus:shadow-outline-red form-input"
                                />
                        </label>
                        ...
                        <label class="block text-sm">
                            ...
                            <input name="ville" type="text" style="width:400px;margin-left:50px;" 
                                class="block w-full mt-1 text-sm border-gray-600 dark:text-gray-300 dark:bg-gray-700 focus:border-red-400 focus:outline-none focus:shadow-outline-red form-input"
                                 />
                        </label>	
                    </div>
                    ...
                    <div class="form-group" style="display:flex;">  
                        <label class="block text-sm">
                            ...
                            <input name="adresse" type="text" style="width:400px;"
                                class="block w-full mt-1 text-sm border-gray-600 dark:text-gray-300 dark:bg-gray-700 focus:border-red-400 focus:outline-none focus:shadow-outline-red form-input"
                                />
                        </label>
                        ...
                        <label class="block text-sm">
                            ...
                            <input name="phone" type="text" style="width:400px;margin-left:50px;"
                                class="block w-full mt-1 text-sm border-gray-600 dark:text-gray-300 dark:bg-gray-700 focus:border-red-400 focus:outline-none focus:shadow-outline-red form-input"
                                 />
                        </label>	
                    </div>
                    ...
                    <div class="form-group" style="display:flex;">  
                        <label class="block text-sm">
                            ...
                            <input name="email_entreprise" type="text" style="width:400px;" 
                                class="block w-full mt-1 text-sm border-gray-600 dark:text-gray-300 dark:bg-gray-700 focus:border-red-400 focus:outline-none focus:shadow-outline-red form-input"
                                />
                        </label>
                        ...
                        <label class="block text-sm">
                            ...
                            <input name="site_web" type="text" style="width:400px;margin-left:50px;" 
                                class="block w-full mt-1 text-sm border-gray-600 dark:text-gray-300 dark:bg-gray-700 focus:border-red-400 focus:outline-none focus:shadow-outline-red form-input"
                                 />
                        </label>	
                    </div>
                    ...
                    <div class="form-group" style="display:flex;">  
                        ...
                        <select id="country" name="commercial_id" style=" width:400px;" 
                            class="block w-full mt-1 text-sm border-gray-600 dark:text-gray-300 dark:bg-gray-700 focus:border-red-400 focus:outline-none focus:shadow-outline-red form-input">
                            <option value="" selected>Selectionner le responsable</option>
                        ...
                        <label class="block text-sm">
                            ...
                            <input name="taille_prospect" type="text" style="width:400px;margin-left:50px;"
                                class="block w-full mt-1 text-sm border-gray-600 dark:text-gray-300 dark:bg-gray-700 focus:border-red-400 focus:outline-none focus:shadow-outline-red form-input"
                                 />
                        </label>	
                    </div>
                    ...
                    <div class="form-group" style="display:flex;">  
                        <label class="block text-sm">
                            ...
                            <input name="type_prospect" type="text" style="width:400px;"
                                class="block w-full mt-1 text-sm border-gray-600 dark:text-gray-300 dark:bg-gray-700 focus:border-red-400 focus:outline-none focus:shadow-outline-red form-input"
                                />
                        </label>
                        ...
                        <select id="country" name="commercial2" style="margin-left:50px; width:400px;" 
                            class="block w-full mt-1 text-sm border-gray-600 dark:text-gray-300 dark:bg-gray-700 focus:border-red-400 focus:outline-none focus:shadow-outline-red form-input">
                            <option value="" selected>Selectionner le commercial backup</option>
                            @foreach($commercial as $commercials)
                                <option value="{{$commercials->email}}">{{$commercials->prenom}} {{$commercials->nom}}</option>
                            @endforeach
                        </select>
                            </div>	
                    <!--</div>-->
                    ...
                    <div class="form-group" style="display:flex;">  
                        <label class="block text-sm">
                            ...
                            <input name="nom_contact1" type="text" style="width:400px;" 
                                class="block w-full mt-1 text-sm border-gray-600 dark:text-gray-300 dark:bg-gray-700 focus:border-red-400 focus:outline-none focus:shadow-outline-red form-input"
                                />
                        </label>
                        ...
                        <label class="block text-sm">
                            ...
                            <input name="prenom_contact1" type="text" style="width:400px;margin-left:50px;" 
                                class="block w-full mt-1 text-sm border-gray-600 dark:text-gray-300 dark:bg-gray-700 focus:border-red-400 focus:outline-none focus:shadow-outline-red form-input"
                                 />
                        </label>	
                    </div>
                    ...
                    <div class="form-group" style="display:flex;">  
                        <label class="block text-sm">
                            ...
                            <input name="email_contact1" type="text" style="width:400px;" 
                                class="block w-full mt-1 text-sm border-gray-600 dark:text-gray-300 dark:bg-gray-700 focus:border-red-400 focus:outline-none focus:shadow-outline-red form-input"
                                />
                        </label>
                        ...
                        <label class="block text-sm">
                            ...
                            <input name="fonction_contact1" type="text" style="width:400px;margin-left:50px;" 
                                class="block w-full mt-1 text-sm border-gray-600 dark:text-gray-300 dark:bg-gray-700 focus:border-red-400 focus:outline-none focus:shadow-outline-red form-input"
                                 />
                        </label>	
                    </div>
                    ...
                    <div class="form-group" style="display:flex;">  
                        <label class="block text-sm">
                            ...
                            <input name="mobile_contact1" type="text" style="width:400px;" 
                                class="block w-full mt-1 text-sm border-gray-600 dark:text-gray-300 dark:bg-gray-700 focus:border-red-400 focus:outline-none focus:shadow-outline-red form-input"
                                />
                        </label>
                    ...
                    <div class="form-group" style="display:flex;">  
                        <label class="block text-sm">
                            ...
                            <input name="whatshap_contact1" type="text" style="width:400px;" 
                                class="block w-full mt-1 text-sm border-gray-600 dark:text-gray-300 dark:bg-gray-700 focus:border-red-400 focus:outline-none focus:shadow-outline-red form-input"
                                />
                        </label>
                    ...
                    <div class="form-group" style="display:flex;">  
                        <label class="block text-sm">
                            ...
                            <input name="nom_contact2" type="text" style="width:400px;"  
                                class="block w-full mt-1 text-sm border-gray-600 dark:text-gray-300 dark:bg-gray-700 focus:border-red-400 focus:outline-none focus:shadow-outline-red form-input"
                                />
                        </label>
                        ...
                        <label class="block text-sm">
                            ...
                            <input name="prenom_contact2" type="text" style="width:400px;margin-left:50px;"  
                                class="block w-full mt-1 text-sm border-gray-600 dark:text-gray-300 dark:bg-gray-700 focus:border-red-400 focus:outline-none focus:shadow-outline-red form-input"
                                 />
                        </label>	
                    </div>
                    ...
                    <div class="form-group" style="display:flex;">  
                        <label class="block text-sm">
                            ...
                            <input name="email_contact2" type="text" style="width:400px;"  
                                class="block w-full mt-1 text-sm border-gray-600 dark:text-gray-300 dark:bg-gray-700 focus:border-red-400 focus:outline-none focus:shadow-outline-red form-input"
                                />
                        </label>
                        ...
                        <label class="block text-sm">
                            ...
                            <input name="fonction_contact2" type="text" style="width:400px;margin-left:50px;"  
                                class="block w-full mt-1 text-sm border-gray-600 dark:text-gray-300 dark:bg-gray-700 focus:border-red-400 focus:outline-none focus:shadow-outline-red form-input"
                                 />
                        </label>	
                    </div>
                    ...
                    <div class="form-group" style="display:flex;">  
                        <label class="block text-sm">
                            ...
                            <input name="mobile_contact2" type="text" style="width:400px;"  
                                class="block w-full mt-1 text-sm border-gray-600 dark:text-gray-300 dark:bg-gray-700 focus:border-red-400 focus:outline-none focus:shadow-outline-red form-input"
                                />
                        </label>
                    ...
                    <div class="form-group" style="display:flex;">  
                        <label class="block text-sm">
                            ...
                            <input name="whatshap_contact2" type="text" style="width:400px;"
                                class="block w-full mt-1 text-sm border-gray-600 dark:text-gray-300 dark:bg-gray-700 focus:border-red-400 focus:outline-none focus:shadow-outline-red form-input"
                                />
                        </label>
