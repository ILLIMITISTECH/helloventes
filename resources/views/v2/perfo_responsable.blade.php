                                           ...
                                           <div class="widget-content-outer">
                                               <div class="widget-content-wrapper">
                                                  @if(intval($sum) > 70)
                                                   ...
                                                   <div class="widget-content-right w-100">
                                                       <div class="progress-bar-xs progress">
                                                           <div class="progress-bar bg-danger" role="progressbar" aria-valuenow="{{intval($sum)}}" aria-valuemin="0" aria-valuemax="100" style="width: {{$sum}}%;"></div>
                                                       </div>
                                                   </div>
                                                   @endif
                                               </div>
                                               <div class="widget-content-left fsize-1">
                                                   <div class="perfo-label">Ma Performance</div>
                                               </div>
                                           </div>
                                       </div>
                                   </div>
                                   ...
                                   <div class="card-shadow-success mb-3 widget-chart widget-chart2 text-left card">
                                       <div class="perfo-box">
                                           <div class="widget-content-outer">
                                               ...
                                               <div class="widget-content-left fsize-1">
                                                   <div class="perfo-label">Performance de ma direction</div>
                                               </div>
                                           </div>
                                       </div>
                                   </div>
