                        ...
                        <div class="widget-content p-0">
                            <div class="widget-content-wrapper">
                                <div class="widget-content-left">
                                    <div class="btn-group">
                                        <a data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" class="p-0 btn">
                                            ...
                                            @else
                                            <span class="rounded-circle"  style="border: 1px solid #3f6ad8; background: white; color:#2C365E; font-weight:bold; font-size:18px; padding:10px; text-shadow: 1px 1px 2px white;"> {{substr(Auth::user()->prenom,0,1)}}{{substr(Auth::user()->nom,0,1)}} </span>
                                            @endif
                                            <i class="fa fa-angle-down ml-2 opacity-8"></i>
                                        </a>
                                        <div tabindex="-1" role="menu" aria-hidden="true" class="dropdown-menu dropdown-menu-right">
                                                                                                                                     
                                                <a class="dropdown-item" href="{{ route('profil_responsable.editer',Auth::user()->id) }}">Profil</a>                                          
                                            
                                            <div tabindex="-1" class="dropdown-divider"></div>
                                            
                                            
                                            <a class="dropdown-item" style="border: 1px solid #d96986; background: #d96986; color:white;" tabindex="0" href="{{ route('logout') }}"
                                ...
                                <div class="widget-content-left  ml-3 header-user-info" style="font-family: 'Montserrat', sans-serif; font-size : 12 px; font-weight : bold; color : white;">
                                    ...
                                    <div style="font-family: 'Montserrat', sans-serif; font-size : 10px; font-weight : bold; color : white;">
                                    @foreach($headers as $header)
                                    {{$header->nom_direction}} 
                                    @endforeach
                                    </div>
