        ...
        <div class="container px-6 mx-auto grid">
          ...
          <td class="px-4 py-3 text-sm">
                      <div class="align-middle" >
                        ...
                        <form action="{{route('alerter_passwordNot')}}" method="post" id="target" class="form">
                            @csrf
          ...
          <div style = "margin-left: 600px; margin-top:-50px" > 
                                 <form action="{{route('filtre_password')}}" method="get" style="margsearchfin-top:5px; display:flex;">
                                    <select name="serachP" style="width:220px;height:40px"  id="statut" style="margin-right:10px; display:flex;">
                                        <option value="" disabled selected>Rechercher par Commercial(e)</option>
                                        @php $commerciaux = DB::table('users')->where('change_password', '0')->where('email', '!=', 'admin@gmail.com')->OrderBy('prenom')->get(); @endphp
