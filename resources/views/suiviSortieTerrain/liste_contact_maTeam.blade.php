...
<br>
          ...
          <h2 class="my-6 text-2xl font-semibold text-gray-700 dark:text-gray-200">
            Les contacts de ce mois
                ...
                @php
                    $mois = date('m');
                    $annee = date('Y');
                    $contact_mois = DB::table('contacts')->where('commercial_id', $commercial->id)->whereYear('created_at', $annee)->whereMonth('created_at', $mois)->get();
                @endphp
          <div class="w-full overflow-hidden rounded-lg shadow-xs" >
  ...
  <!---------------------------------------------------------------------------------------------------------------------->
   ...
   <div id="sansmail">
                <div class="container px-6 mx-auto grid" >
                    @php  $nbre_contact_Smail = DB::table('contacts')->where('commercial_id', $commercial->id)
          ...
          <h2 class="my-6 text-2xl font-semibold text-gray-700 dark:text-gray-200">
            ...
            <!--<div style="margin-left:500px; background-color:#0093a2">-->
             ...
             @php    $contact_Smail = DB::table('contacts')->where('commercial_id', $commercial->id)
