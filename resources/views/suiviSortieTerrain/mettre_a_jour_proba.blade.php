       ...
       <a data-toggle="tooltip" title="Retour" style="width:90px; margin-left:30px"  type="button" id="PopoverCustomT-1" class="nm" href="javascript:history.go(-1)" >
                ...
                <div class="container px-6 mx-auto grid">
                    <h2 class="my-6 text-2xl font-semibold text-gray-700 dark:text-gray-200">
                        Mettre à jour la probabilité de opportunité "{{$opportunite->libelle}}"
                    </h2>
         ...
         @if (session('message'))
              ...
              @endif
                    ...
                    <div class="px-4 py-3 mb-8 bg-white rounded-lg shadow-md dark:bg-gray-800">
                        <!-- Invalid input -->
                     <form action="{{route('mettre_a_jour_proba.update', $opportunite->id)}}" method="post" class="dropzone dropzone-custom needsclick add-professors" id="demo1-upload" enctype="multipart/form-data">
                        ...
                        <label class="block text-sm">
                            <span class="text-gray-700 dark:text-gray-400">
                                Sélectionner la probabilité de l'opportunuité
                            </span>
                        </label>
                        <select id="country" name="probabilite"
                            ...
                            <option value="{{$opportunite->probabilite}}">{{$opportunite->probabilite}}</option>
                            <option value=" "> Sélectionner la probabilité</option>
