...
<main class="h-full pb-16 overflow-y-auto" >
     ...
     <a href="/liste_hot_deals"><button class="px-3 py-1 text-sm font-medium leading-5 text-white transition-colors duration-150 bg-purple-600 border border-transparent rounded-md active:bg-purple-600 hover:bg-purple-700 focus:outline-none focus:shadow-outline-purple" style="margin-left:10px;" > Liste des hot deals de ce trimestre</button></a>

          </h2>
                    <div style = "margin-left: 600px; margin-top:-50px" > 
                                 <form action="{{route('filtre_tous_hot_deals')}}" method="get" style="margin-top:30px; display:flex;">
                                    ...
                                    <select name="serachPays" style="font-size:17px;width:220px;height:40px; margin-left:10px;"  id="origine">
                                        ...
                                        ->where('archiver', 0)->where('probabilite', '>', 70)->pluck('commerciaus.pays_id')->toArray();
