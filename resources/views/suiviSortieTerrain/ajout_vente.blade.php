         ...
         @if (session('message'))
              ...
              @endif
                    ...
                    <div class="px-4 py-3 mb-8 bg-white rounded-lg shadow-md dark:bg-gray-800">
                        <!-- Invalid input -->
                     <form action="{{route('update_archiver', $opportunite->id)}}" method="post" class="dropzone dropzone-custom needsclick add-professors" id="demo1-upload" enctype="multipart/form-data">
                                                     @csrf
                   <input name="commercial_id" type="hidden" value={{$opportunite->commercial_id}}
                    ...
                    <div class="form-check">
                      <input class="form-check-input" type="radio" name="archiver" value="2" id="gagner" required>
                    ...
                    <div class="form-check">
                      <input class="form-check-input" type="radio" name="archiver" value="4" id="abandon" >
                      <label class="form-check-label" for="exampleRadios2">
                ...
                <div class="row" id="selectProjet">
                    <h5 class="card-title">Selectionner le domaine vendu (<span style=" color:red;">*</span>)</h5>
                    <div class="input-group row col-lg-12" style=" display:flex;">
                        <div class="col-lg-2">
                        <label class="block text-sm">
                          @php  $domaine = DB::table('domaines')->orderby('libelle')->get(); @endphp
                    ...
                    <div class="input-group row col-lg-12" style=" display:flex;">
                        ...
                        <label class="block text-sm">
                            ...
                            <input name="montant" type="number" id="dom"
                                class="block numberint w-full mt-1 text-sm border-gray-600 dark:text-gray-300 dark:bg-gray-700 focus:border-red-400 focus:outline-none focus:shadow-outline-red form-input"
                    ...
                    <h5 class="card-title">Le montant de départ : {{number_format($opportunite->objectif_de_vente)}} Fcfa</h5>
                    <div class="input-group row col-lg-12" style=" display:flex;">
                        <div class="col-lg-2">
                        <label class="block text-sm">
                 ...
                 <div class="row" id="archiverRaison">
                    ...
                    <h5 class="card-title">Raison de la perte (<span style=" color:red;">*</span>)</h5>
                    <div class="input-group row col-lg-12" style=" display:flex;">
                        <div class="col-lg-2">
                        <label class="block text-sm">
                    ...
                    <div class="row" id="raisonAbandon">
                     
                    <h5 class="card-title">Raison de l'abandon (<span style=" color:red;">*</span>)</h5>
                    <div class="input-group row col-lg-12" style=" display:flex;">
                        <div class="col-lg-2">
                        <label class="block text-sm">
                          
                            <input name="raison_abandonner" type="text" 
                                class="block w-full mt-1 text-sm border-gray-600 dark:text-gray-300 dark:bg-gray-700 focus:border-red-400 focus:outline-none focus:shadow-outline-red form-input"
                                placeholder="Saisir la raison" /></label>
                        </div>
                    </div>
...
jQuery(document).ready(function() {   
 ...
 <script>
  ...
  <script src="{{asset('Koyalis/public/assets/js/charts-pie.js')}}" defer></script>
	...
	<script>
   const radioButtons = document.querySelectorAll('input[id="gagner"]');
   if(radioButtons.checked){
     document.getElementById("dom").required = true;
   }
</script>
