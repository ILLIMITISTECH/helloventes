             ...
             <h6> 
              ...
              @endif
                    ...
                    <div class="px-4 py-3 mb-8 bg-white rounded-lg shadow-md dark:bg-gray-800">
                        <!-- Invalid input -->
                        <form action="/ajout_objectifs_res" method="post" class="dropzone dropzone-custom needsclick add-professors" id="demo1-upload" enctype="multipart/form-data">
                                                     @csrf
                       ...
                       <option value="" selected>Sélectionner la commission</option>
                        ...
                        <label class="block text-sm">
                            <span class="text-gray-700 dark:text-gray-400">
                                Nombre de visites terrain (<span style=" color:red;">*</span>)
                            </span>
