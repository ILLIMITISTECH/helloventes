         ...
         <div>
              ...
              <h2 class="my-6 text-2xl font-semibold text-gray-700 dark:text-gray-200">
                ...
                <div style = "margin-left: 400px; margin-top:-50px" > 
                                 <form action="{{route('search_statut_appelO_tous')}}" method="get" style="margsearchfin-top:5px; display:flex;">
                                    <select name="serachCom" style="font-size:17px;width:220px;height:40px"  id="statut" style="margin-right:10px; display:flex;">
                                        ...
                                        $entreprisess = DB::table('opportunites')->where('archiver', 0 )->whereIn('origine_id', [1,2] )->pluck('commercial_id')->toArray();
                                    ...
                                    <select name="serachPays" style="font-size:17px;width:220px;height:40px; margin-left:10px;"  id="origine">
                                        ...
                                        ->where('opportunites.archiver', 0 )->whereIn('opportunites.origine_id', [1,2] )->pluck('commerciaus.pays_id')->toArray();
             ...
             <div style = "margin-left: 630px;" >
                                 <form action="{{route('search_statut_appelO')}}" method="get" style="margsearchfin-top:5px; display:flex;">
                                     
                                       
                                           
                                    <select name="search" style="font-size:17px;width:220px;height:40px"  id="statut" style="margin-right:10px; display:flex;">
          ...
          <div class="container">
            ...
            <div class="container">
              <table >
                ...
                @endphp
                @if($opportunites->origine_id == 1 || $opportunites->origine_id == 2 )
