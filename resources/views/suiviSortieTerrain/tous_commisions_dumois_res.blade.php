          ...
          <h2 class="my-6 text-2xl font-semibold text-gray-700 dark:text-gray-200">
           ...
           <div  class="col-md-3" style = "margin-top:-20px" align="right" >
                              @php
                                             ...
                                             $datnow = date('m');
                                        @endphp
                                 <form action="{{route('tous_commisions_dumois_resFiltre')}}" method="get" >
          ...
          <div class="w-full overflow-hidden rounded-lg shadow-xs">
            ...
            <div class="w-full overflow-x-auto">
             <table class="w-full whitespace-no-wrap">
                ...
                <tbody class="bg-white divide-y dark:divide-gray-700 dark:bg-gray-800">
                    @foreach($commission_mois_pole as $commission_m_pole)
                    @php $op = DB::table('opportunites')->where('id', $commission_m_pole->opportunite_id)->first(); 
                    $com = DB::table('commerciaus')->where('id', $commission_m_pole->commercial_id)->first(); 
                        $vente = DB::table('ventes')->where('opportunite_id', $commission_m_pole->opportunite_id)->first();
                        if($com){
                        $photo = DB::table('users')->where('id', $com->user_id)->first();
                        }
                    @endphp
...
-
                    ...
                    <td class="px-4 py-3 text-xs">
                      <span class="px-3 py-1 text-sm ">
                        {{(number_format($commission_m_pole->commission)) ? number_format($commission_m_pole->commission) : '0'}} Fcfa
                      </span>
                    </td>
