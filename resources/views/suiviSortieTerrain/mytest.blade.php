        ...
        <div class="container px-6 mx-auto grid">
          <h2 class="my-6 text-2xl font-semibold text-gray-700 dark:text-gray-200" style="font-size:18px;">
            Les opportunités 
                   ...
                   <div class="row" style="display-flex"> <a href="/opportunite_archiver_maTeam_res">
              ...
              <table >
                ...
                <tbody class="bg-white divide-y dark:divide-gray-700 dark:bg-gray-800">
                    @foreach($opportunite as $opportunites)
                        @php $prospect = DB::table('prospects')->where('id', $opportunites->prospect_id)->first(); 
                            $origine = DB::table('origines')->where('id', $opportunites->origine_id)->first(); 
                             $come = DB::table('commerciaus')->where('superieur_id', $commercial->id)->where('id', $opportunites->commercial_id)->first();
                        @endphp
            ...
            <div class="container">
              <table >
                ...
                <tbody class="bg-white divide-y dark:divide-gray-700 dark:bg-gray-800">
                    @foreach($opportunite as $opportunites)
                @php $prospect = DB::table('prospects')->where('id', $opportunites->prospect_id)->first(); 
                 $comer = DB::table('commerciaus')->where('superieur_id', $commercial->id)->where('id', $opportunites->commercial_id)->first();
                    $origine = DB::table('origines')->where('id', $opportunites->origine_id)->first(); 
                @endphp
