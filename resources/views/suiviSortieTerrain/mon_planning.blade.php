              ...
              <table class="w-full whitespace-no-wrap">
                ...
                @if($pros)
                  <tr class="text-gray-700 dark:text-gray-400">
                   ...
                   <!--   {{ ($plannings->libelle) ? $plannings->libelle : 'non renseign¨¦'}}-->
                   <!-- </td>-->
                    @if($pros)
                    ...
                    @if($pros)
                    <td class="px-4 py-3 text-sm">
                      {{($pros->phone) ? $pros->phone : ''}} <br> {{($pros->email_entreprise) ? $pros->email_entreprise : ''}}
                    </td>
                    @else
                    <td class="px-4 py-3 text-sm">
                    ...
                    <div style="display:flex ">
                        ...
                        <span style="margin-left:3px; height:28px;" 
                            ...
                            tabindex="0" style="margin-right : 10%;" data-toggle="tooltip" title="Cloturer ce planning">
                            <a type="submit" id="PopoverCustomT-1" class="btn btn-primary"
                                href="{{route('cloturer_mon_planning_edit', $plannings->id )}}">
