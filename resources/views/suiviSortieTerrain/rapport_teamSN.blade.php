...
<br>
        ...
        <div class="container px-6 mx-auto grid">
            ...
            Rapport <b style="color:#9045e2">global</b> de performance commerciale : Team SN
          </h2>
           ...
           @endif
            <div  class="col-md-3" style = "margin-top:-20px" align="right" >
                              @php
                                             ...
                                             $year_mensuelles = DB::table('performance_sn_globales')->whereMonth('created_at', $les_moisf)->pluck('created_at')->toArray();
