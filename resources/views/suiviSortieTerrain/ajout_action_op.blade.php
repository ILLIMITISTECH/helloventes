        ...
        @if (session('message'))
              ...
              @endif
                    ...
                    <div class="px-4 py-3 mb-8 bg-white rounded-lg shadow-md dark:bg-gray-800">
                        <!-- Invalid input -->
                         <form action="{{route('opportunite_prospectStore')}}" enctype="multipart/form-data" method="post" class="form-horizontal" id="demo1-upload" >
                    {{ csrf_field() }}
...
@endphp
                 ...
                 <br>
                    <div class="form-control">
                      ...
                      <br>
                <div class="col-md-12">
                    <label for="inputState" class="form-label required">L'action est-elle prioritaire ? <b style="color:red;">*</b></label>
                    <div class="form-check">
                      <input class="form-check-input" type="radio" name="priorite" value="1" >
                      <label class="form-check-label" for="exampleRadios1">
                      Oui
                      </label>
                   </div>
                   <div class="form-check">
                      <input class="form-check-input" type="radio" name="priorite" value="0" checked>
