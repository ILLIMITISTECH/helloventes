     ...
     <h6> 
             ...
             <br><br>
                            ...
                            <div style = "margin-left: 380px; margin-top:-50px" > 
                                 <form action="{{route('search_statut')}}" method="get" style="margsearchfin-top:5px; display:flex;">
                                    ...
                                    <select name="searchDo" style="width:100px;height:40px; margin-left:10px;"  id="domaine">
                                        <option value="" disabled selected>Par Domaine</option>
                                      
                                        @php $domaines = DB::table('domaines')->OrderBy('libelle')->get(); @endphp
           ...
           <div class="container" id="tout">
            ...
            <div class="container">
                 <div class="row">
                            <div class="col-12 col-s-12">
              <table id="example2" class="table-auto border-collapse w-full">
                <thead>
                  <tr
                ...
                @php $prospect = DB::table('prospects')->where('id', $opportunites->prospect_id)->first(); 
                    ...
                    $infoActions = DB::table('action_commerciales')->where('opportunite_id', $opportunites->id)->where('cloture', 0)->orderBy('deadline', 'desc')->get(); 
            ...
            Opportunités probabilité : 70 - 100 %
             ...
             <div class="container">
              ...
              @if($opportunite->isEmpty()) 
					 ...
					 @else
            <div class="container">
              <table id="example1" class="table-auto border-collapse w-full">
                <thead>
                  <tr
                    class="text-xs font-semibold tracking-wide text-left text-gray-500 uppercase border-b dark:border-gray-700 bg-gray-50 dark:text-gray-400 dark:bg-gray-800">
            ...
            Opportunités probabilité : 50 - 70 %
             ...
             <div class="container" >
              ...
              @if($opportunite->isEmpty()) 
					 ...
					 @else
            <div class="container">
              <table id="example" class="table-auto border-collapse w-full">
                <thead>
                  <tr
                    class="text-xs font-semibold tracking-wide text-left text-gray-500 uppercase border-b dark:border-gray-700 bg-gray-50 dark:text-gray-400 dark:bg-gray-800">
                    <!--<th class="px-4 py-3">Origine</th>-->
