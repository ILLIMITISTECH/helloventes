        ...
        <h6> 
              ...
              @endif
                    ...
                    <div class="px-4 py-3 mb-8 bg-white rounded-lg shadow-md dark:bg-gray-800">
                        <!-- Invalid input -->
                         <form action="{{route('opportunite_prospect.store',$prospect->id)}}" enctype="multipart/form-data" method="post" class="form-horizontal" id="demo1-upload" >
                    {{ csrf_field() }}
                ...
                $date_deadline = date('Y-m-d', $strotime_deadline);
                            ...
                            <div class="form-control">
                                    ...
                                    <select id="country" name="statut" required style="margin-left:50px; width:400px;"
                            ...
                            <div class="form-control">
                                      <label class="block text-sm" style="margin-left:50px;width:400;">
                                        ...
                                        <input  name="objectif_de_vente" type="number" required
                                            class="block w-full mt-1 numberint text-sm border-gray-600 dark:text-gray-300 dark:bg-gray-700 focus:border-green-400 focus:outline-none focus:shadow-outline-green form-input"
                                            placeholder="Ex: 500000" style="width:400px; " min="500000" id="inp" />
                                    </label>
                            </div> <br>
                        </div>
                            ...
                            <div class="form-control">
                                      <label class="block text-sm" style="margin-left:50px;width:400;">
                                        ...
                                        <textarea class="block w-full mt-1 text-sm border-gray-600 dark:text-gray-300 dark:bg-gray-700 focus:border-red-400 focus:outline-none focus:shadow-outline-red form-input"
                                             name="notes" id="w3review" name="w3review" rows="2" cols="50" style="width:400px; border:solid 1px black;"></textarea>
                      ...
                      <br>
                <div class="col-md-12">
                    <label for="inputState" class="form-label required">Maintenez-vous les points focaux de cette entreprises ?<b style="color:red;">*</b></label>
                ...
                <div class="row" id="selectProjet">
                          <h5 class="card-title">Contact principal (<span style=" color:red;">*</span>)</h5>
                    <div class="input-group row col-lg-12" style=" display:flex;">
                        <div class="col-lg-2">
                            <label for="inputEmail4" style="font-size:14px; width:400px" class="form-label ">Prénom </label> (<span style=" color:red;">*</span>)
                        ...
                        <div class="col-md-2">
                            <label for="inputEmail4" style="font-size:14px;" class="form-label ">Nom </label>(<span style=" color:red;">*</span>)
                      ...
                      html += '  <label class="block mt-4 text-sm">';
                       html += '     <span class="text-gray-700 dark:text-gray-400">';
                         ...
                         html += '   <input  name="probabilites[]" type="number"';
                            html += '    class="block w-full numberint mt-1 text-sm border-gray-600 dark:text-gray-300 dark:bg-gray-700 focus:border-green-400 focus:outline-none focus:shadow-outline-green form-input"';
