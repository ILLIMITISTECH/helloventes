        ...
        <h6> 
              ...
              @endif
                    ...
                    <div class="px-4 py-3 mb-8 bg-white rounded-lg shadow-md dark:bg-gray-800">
                        <!-- Invalid input -->
                         <form action="/ajouter_contacts" enctype="multipart/form-data" method="post" class="form-horizontal" id="demo1-upload" >
                    {{ csrf_field() }}
                    @php $respon = DB::table('commerciaus')->where('user_id', Auth::user()->id)->first();
                    $op_tout = DB::table('opportunites')->where('superieur_id', $respon->id)->orderBy('id', 'desc')->get();
                         $prospect_tout = DB::table('prospects')->where('superieur_id', $respon->id)->orderBy('id', 'desc')->get();   @endphp
                            ...
                            <div class="form-control">
                                   ...
                                   <select name="prospect_id" style="width:400px;"  class="block w-full mt-1 text-sm border-gray-600 dark:text-gray-300 dark:bg-gray-700 focus:border-red-400 focus:outline-none focus:shadow-outline-red form-input" style="width:400px;">
                                      <option value="" >Selectionner le prospect</option>
                                      @foreach($prospect_tout as $pros_tout)
                                      <option value="{{$pros_tout->id}}">{{$pros_tout->nom_entreprise}}</option>
                                      @endforeach
                                    </select>
                                     @else
                                   <select name="prospect_id" style="width:400px;"  class="block w-full mt-1 text-sm border-gray-600 dark:text-gray-300 dark:bg-gray-700 focus:border-red-400 focus:outline-none focus:shadow-outline-red form-input" style="width:400px;">
                                      ...
                                      <option value="{{$pros->id}}">{{$pros->nom_entreprise}}</option>
                                      @endforeach
                                    </select>
                                    @endif
                            </div>
                            <div class="form-control" style="margin-left:50px;width:400px;">
                                    ...
                                    @if(Auth::user()->nom_role == 'responsable')
                                    <select name="opportunite_id" style="width:400px;"  class="block w-full mt-1 text-sm border-gray-600 dark:text-gray-300 dark:bg-gray-700 focus:border-red-400 focus:outline-none focus:shadow-outline-red form-input" style="width:400px;">
                                      <option value="" >Selectionner l'opportunité</option>
                                      @foreach($op_tout as $opp_tout)
                                      <option value="{{$opp_tout->id}}">{{$opp_tout->libelle}}</option>
                                      @endforeach
                                    </select>
                                    @else
                                    <select name="opportunite_id" style="width:400px;"  class="block w-full mt-1 text-sm border-gray-600 dark:text-gray-300 dark:bg-gray-700 focus:border-red-400 focus:outline-none focus:shadow-outline-red form-input" style="width:400px;">
                                      <option value="" >Selectionner l'opportunité</option>
                                      @foreach($op as $opp)
                                      <option value="{{$opp->id}}">{{$opp->libelle}}</option>
                                      @endforeach
                                    </select>
                                    @endif
                            </div>
                            ...
                            <div class="form-control">
                                    <label class="block text-sm">
                                        ...
                                        <input name="prenom" type="text" required
                                            ...
                                            placeholder="prenom.." style="width:400px;" />
                                    </label>
                            </div>
                             <div class="form-control">
                                      <label class="block text-sm" style="margin-left:50px;width:400px;">
                                        ...
                                        <input  name="nom" type="text" required
                                            ...
                                            placeholder="nom.." style="width:400; " />
                                    </label>
                            </div> <br>
                        ...
                        <div class="form-control">
                                    <label class="block text-sm">
                                        ...
                                        <input name="responsabilite" type="text" 
                                            class="block w-full mt-1 text-sm border-gray-600 dark:text-gray-300 dark:bg-gray-700 focus:border-red-400 focus:outline-none focus:shadow-outline-red form-input"
                                            placeholder="Fonction" style="width:400px;" />
                                    </label>
                            </div>
