       ...
       <a data-toggle="tooltip" title="Retour" style="width:90px; margin-left:30px"  type="button" id="PopoverCustomT-1" class="nm" href="javascript:history.go(-1)" >
        ...
        <div class="container px-6 mx-auto grid">
          <h2 class="my-6 text-2xl font-semibold text-gray-700 dark:text-gray-200">
            ...
            <!--Les ventes du dernier trimestre : SN-->
            
              @foreach($les_ventes_mois_tri_dernier as $ventes)
            ...
            Les ventes du dernier trimestre   
            <span style="margin-left: 20px;" class="px-2 py-1 font-semibold leading-tight text-green-700 bg-green-100 rounded-full dark:bg-green-700 dark:text-green-100">
                {{(number_format($total3)) ? number_format($total3) : '0'}} Fcfa j
            </span>
             @endif 
          ...
          <div  class="col-md-3" style = "margin-top:-20px" align="right" >
                                 ...
                                 <form action="{{route('les_ventes_mois_tri_dernierFiltre')}}" method="get" >
          ...
          <div class="w-full overflow-hidden rounded-lg shadow-xs">
            ...
            <div class="w-full overflow-x-auto">
                @if(count($les_ventes_mois_tri_dernier) == 0)
            ...
            @if(  (date("m", strtotime($ventes->created_at)) >= 01) && (date("m", strtotime($ventes->created_at)) <= 03) )
                 ...
                 <tr class="text-gray-700 dark:text-gray-400">
                        ...
                        <div class="relative hidden w-8 h-8 mr-3 rounded-full md:block">
                          ...
                          <div>
                            <button type="button" class="btn btn-primary btn-lg btn-block font-semibold"><a href="">
                                <h4>{{$ventes->prenom}} <br> {{$ventes->nom}}</h4>
                            </button>
                          </div>
                        </div>
                    </td>
                    ...
                    <td class="px-4 py-3" >
                      ...
                      <span class="px-3 py-1 text-sm " title="{{($ventes->nom_entreprise) ? $ventes->nom_entreprise : '--'}} ">
                                <h4 style="text-align : center">{{ \Illuminate\Support\Str::limit($ventes->nom_entreprise, 30, $end='...') }}</h4>
                         </span>
                    </td>
