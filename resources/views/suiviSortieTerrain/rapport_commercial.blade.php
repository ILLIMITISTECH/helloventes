...
<br>
        ...
        <div class="container px-6 mx-auto grid">
            ...
            Rapport <b style="color:#9045e2">individuel</b> de performance commerciale
          </h2>
           <div  class="col-md-3" style = "margin-top:-20px" align="right" >
            @php
                                             ...
                                             $year_mensuelles = DB::table('performances')->whereMonth('created_at', $les_moisf)->pluck('created_at')->toArray();
                              ...
                              $month_not_here = array("01","02","03","04","05","06","7","8","9","10","11","12");
                                            ...
                                            $result_month_not_heres = array_diff($month_not_here, $result_mois);
                                             ...
                                             $datnow = date('m');
                                        @endphp
                                 <form action="{{route('rapport_commercialFiltre')}}" method="get" >
                                      ...
                                      <select name="searchMois" style="width:220px;height:40px"  style="margin-right:10px; display:flex;">
                                        ...
                                        <option value="" disabled selected>Rechercher par mois</option>
                                          ...
                                          @php  $obje_mensuelle = DB::table('performances')->whereMonth('created_at', $result_moi)->first(); @endphp
              ...
              <table class="w-full whitespace-no-wrap" style="border: solid 1px black;">
                <thead>
                  <tr
                    ...
                    <th class="px-4 py-3" style="border: solid 1px black;">Pourcentage de réalisations</th>
                  </tr>
                </thead>
