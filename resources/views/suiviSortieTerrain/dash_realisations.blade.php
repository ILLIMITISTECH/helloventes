          ...
          <div class="grid gap-6 mb-8 md:grid-cols-2 xl:grid-cols-4">
             ...
             @php $commercial = DB::table('commerciaus')->where('user_id', Auth::user()->id)->first(); @endphp
                <!-- start perfo -->
                 ...
                 <!--------------------------------------------------------------------------------------------------------------------->
                 @if(Auth::user()->nom_role == "directeur" || Auth::user()->nom_role == "commerciaux")
                 <div class="grid gap-6 mb-8 md:grid-cols-2 xl:grid-cols-4">
                ...
                <!-- start perfo -->
                    ...
                    <!--<a href="/commerciaux_maTeamIndividuel_res" data-toggle="tooltip" title="Rapport individuel de performance commerciale">-->
                    <!--<div class="flex items-center p-4 bg-white rounded-lg shadow-xs dark:bg-gray-800">-->
                    ...
                    <a href="/objectif_ventes_res" data-toggle="tooltip" title="Objectifs et réalisations">
                    <div class="flex items-center p-4 bg-white rounded-lg shadow-xs dark:bg-gray-800">
                    ...
                    <a href="/toutes_actions_fait_res"   >
                    <div class="flex items-center p-4 bg-white rounded-lg shadow-xs dark:bg-gray-800">
                    ...
                    <a href="/toutes_actions_aVenir_res"   >
                    <div class="flex items-center p-4 bg-white rounded-lg shadow-xs dark:bg-gray-800">
