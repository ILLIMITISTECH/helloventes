       ...
       <a data-toggle="tooltip" title="Retour" style="width:90px; margin-left:30px"  type="button" id="PopoverCustomT-1" class="nm" href="javascript:history.go(-1)" >
                ...
                <div class="container px-6 mx-auto grid">
                    ...
                    <div class="px-4 py-3 mb-8 bg-white rounded-lg shadow-md dark:bg-gray-800">
                        <!-- Invalid input -->
                        <form action="{{route('mon_planning.update', $planning->id)}}" method="post" class="dropzone dropzone-custom needsclick add-professors" id="demo1-upload" enctype="multipart/form-data">
                                                     @csrf
                        ...
                        @php $pros = DB::table('prospects')->where('id', $planning->prospect_id)->first(); @endphp
                        ...
                        @if($pros)    <option value="{{$planning->prospect_id}}" >{{$pros->nom_entreprise}}</option>
                        @else <option value="" selected>Sélectionner le prospect</option>
                        @endif
                ...
                <label class="block text-sm">
                            ...
                            <input name="date" type="date"  value="{{$planning->date}}"
                                class="block w-full mt-1 text-sm border-gray-600 dark:text-gray-300 dark:bg-gray-700 focus:border-red-400 focus:outline-none focus:shadow-outline-red form-input"
                                 />
                        </label>
                        ...
                        <label class="block text-sm">
                            ...
                            <input name="heure_debut" type="time"  value="{{$planning->heure_debut}}"
                                class="block w-full mt-1 text-sm border-gray-600 dark:text-gray-300 dark:bg-gray-700 focus:border-red-400 focus:outline-none focus:shadow-outline-red form-input"
                                 />
                        </label>
