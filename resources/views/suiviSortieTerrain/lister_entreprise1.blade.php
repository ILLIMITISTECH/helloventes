    ...
    <div id="main-wrapper" data-layout="vertical" data-navbarbg="skin6" data-sidebartype="full"
       ...
       <div class="select-box" style="margin-left : 0px; margin-top :0px;">
                                        ...
                                        <!--       <option value="1" id="cours">Actions en cours</option>-->
                                               <!--<option value="3" id="cours">Actions cloturées </option> -->
                    ...
                    <div class="col-sm-12">
                        <div class="card">
                                    ...
                                    <table class="table stylish-table no-wrap">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="border-top-0">Secteur d'activité</th>
                                                <th class="border-top-0">ZOne</th>
                                                <th class="border-top-0">Numéro de téléphone</th>
                            ...
                            <tr>
                                ...
                                <td > {{$entreprises->secteur_activite}}</td>
                                <td > {{$entreprises->zone}}</td>
