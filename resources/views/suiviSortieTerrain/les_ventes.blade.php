        ...
        <div class="container px-6 mx-auto grid">
          <h2 class="my-6 text-2xl font-semibold text-gray-700 dark:text-gray-200">
              @php $moiss = date('m'); 
                $annee = date('Y'); 
              @endphp
            @php  $vente_sum = DB::table('ventes')->whereYear('created_at', $annee)->sum('montant'); @endphp
            @php  $obje_sum = DB::table('objectif_commissions')->whereYear('created_at', $annee)->sum('Objectif_mois'); @endphp
            Les ventes de l'année : Objectifs : {{number_format($obje_sum)}}
            <br>
            <!--<div style="display-flex">
             ...
             <div style="margin-left:450px;">
                    <span 
                        ...
                        {{number_format(($les_vente_sum)) ? number_format($les_vente_sum) : '0'}} Fcfa
                      </span></div>
          </h2>
          ...
          <div  class="col-md-3" style = "margin-top:-20px" align="right" >
                               @php
                                             ...
                                             $year_mensuelles = DB::table('ventes')->whereYear('created_at', $this_year)->whereMonth('created_at', $les_moisf)->pluck('created_at')->toArray();
                                 ...
                                 <form action="{{route('les_ventesFiltre')}}" method="get" >
                                    ...
                                    <select name="searchPays" style="width:220px;height:40px"  style="margin-right:10px; display:flex;">
                                        ...
                                        $pays = DB::table('pays')->whereIn('id', [1, 5, 13])->get();
                                    ...
                                    <select name="searchCommerciau" style="width:220px;height:40px"  style="margin-right:10px; display:flex;">
                                        ...
                                        $entreprisess = DB::table('ventes')->whereYear('created_at', $annee)->pluck('commercial_id')->toArray();
