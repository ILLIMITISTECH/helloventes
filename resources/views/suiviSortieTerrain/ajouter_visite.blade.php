      ...
      @include('v2.header_dg')
            <main class="h-full pb-16 overflow-y-auto">
                ...
                <div class="container px-6 mx-auto grid">
                    ...
                    <div class="raison" align="right"><b>Vous n'avez pas de sortie terrain cette semaine ?</b>
                    <a href="/create_raison" style="width:100px;"
              ...
              @endif
                    ...
                    {{ csrf_field() }}
                        ...
                        <div class="form-group" style="display:flex;">
                            ...
                            <select id="prospect" name="prospect_id" required
                        ...
                        <div class="form-group" style="display:flex;">
                            ...
                            <div class="form-control">
                                ...
                                <select id="opportunite" name="opportunite_id" 
                                    class="block w-full mt-1 text-sm border-gray-600 dark:text-gray-300 dark:bg-gray-700 focus:border-red-400 focus:outline-none focus:shadow-outline-red form-input form-control" style="width:400px; ">
                            ...
                            <div class="form-control" style="margin-left:50px;">
                                ...
                                <select id="category" name="pays_id" required
                                    class="block w-full mt-1 text-sm border-gray-600 dark:text-gray-300 dark:bg-gray-700 focus:border-red-400 focus:outline-none focus:shadow-outline-red form-input form-control" style="width:400px;">
...
<script>
    $('#category').on('change', function() {
        ...
        $.get('/get-subcategories', { prospect_id: categoryId }, function(data) {
            $('#subcategory').empty();
            $.each(data, function(index, subcategory) {
                $('#subcategory').append($('<option>', {
                    value: subcategory.id,
                    text: subcategory.libelle
                }));
            });
        });
    });
...
<script>
    $('#prospect').change(function() {
        ...
        $.get('/ajax/opportunites/' + prospect, function(data) {
            $('#opportunite').empty();
            $.each(data, function(key, value) {
                $('#opportunite').append('<option value="' + value.id + '">' + value.libelle + '</option>');
            });
        });
    });
</script>
