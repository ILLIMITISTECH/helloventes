...
<br>
        ...
        <div class="container px-6 mx-auto grid">
            ...
            Rapport <b style="color:#9045e2">mensuel</b> de performance commerciale : Team BF
          </h2>
           @php $chtoday = date('m'); $rap_check = DB::table('performance_bf_globales')->whereMonth('created_at', $chtoday)->orderBy('id', 'DESC')->first(); @endphp
            @if($rap_check)
           @php DB::table('performance_bf_globales')->whereMonth('created_at', $chtoday)
            ...
            <br><br>
                      <div  class="col-md-3" style = "margin-top:-20px" align="right" >
                             @php
                                             ...
                                             $year_mensuelles = DB::table('performance_bf_globales')->whereYear('created_at', $this_year)->whereMonth('created_at', $les_moisf)->pluck('created_at')->toArray();
                                         ...
                                         $month_not_here = array("01","02","03","04","05","06","7","8","9","10","11","12");
                                            ...
                                            $result_month_not_heres = array_diff($month_not_here, $result_mois);
                                             $datnow = date('m');
                                        @endphp
                                 <form action="{{route('rapport_teamBFFiltre')}}" method="get" >
                                      ...
                                      <select name="searchMois" style="width:220px;height:40px"  style="margin-right:10px; display:flex;">
                                        ...
                                        <option value="" disabled selected>Rechercher par mois</option>
                                          ...
                                          @php  $obje_mensuelle = DB::table('performance_bf_globales')->whereMonth('created_at', $result_moi)->first(); @endphp
