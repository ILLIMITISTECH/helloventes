          ...
          <h2 class="my-6 text-2xl font-semibold text-gray-700 dark:text-gray-200">
            Liste des commerciaux
                         ...
                         <div  class="col-md-3" style = "margin-top:-20px" align="right" >
                                 <form action="{{route('tous_search_commerciau')}}" method="get" >
                                    <select name="searchCommerciau" style="width:220px;height:40px"  style="margin-right:10px; display:flex;">
                                        ...
                                        @php $come = DB::table('commerciaus')->OrderBy('prenom')->get();  @endphp
                                        @foreach($come as $comme)
                                        <option value="{{$comme->id}}">{{$comme->prenom}} {{$comme->nom}}</option>
                                        @endforeach
