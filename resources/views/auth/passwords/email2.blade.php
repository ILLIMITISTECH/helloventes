                                    ...
                                    <div class=" mt-20">   
                                        <form method="POST" action="{{ route('password.email') }}">
                                            {{ csrf_field() }}
                                               ...
                                               <input id="email" type="{!! session('status') ? 'hidden' : 'email'; !!}" class="form-control @error('email') is-invalid @enderror" name="email" value="{{ old('email') }}" placeholder="example@gmail.com" required autocomplete="email" autofocus>
                                            ...
                                            <button class="main-btn" @if (session('status')) hidden='hidden' @endif>{{ __('Envoyer le lien de réinitialisation du mot de passe') }}</button>
                                        </form>
