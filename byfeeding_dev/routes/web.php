...
Route::get('/validate_form', 'AgentController@validate_form');
Route::get('/create_form', 'AgentController@create_form');
Route::post('/store_form', 'AgentController@store_form')->name('store_form');
