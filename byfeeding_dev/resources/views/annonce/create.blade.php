                        	...
                        	<div class="navbar">
                            	<div class="navbar-inner">
	                                <ul class="breadcrumb">
	                                    ...
	                                    <li>
	                                        <a href="/annonces">Les Annonces</a> <span class="divider">/</span>	
	                                    </li>
                            ...
                            <div class="block-content collapse in">
                                <div class="span12">
                                    <div id="rootwizard">
                                      ...
                                      <center>  <form action="{{route('annonces.store')}}" method="post" class="form-horizontal" id="demo1-upload" enctype="multipart/form-data">
                                    {{ csrf_field() }}
