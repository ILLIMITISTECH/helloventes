                                                        ...
                                                        <div class="row">
                                                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                                <div class="form-group">
                                                                    <input name="titre" type="text" value="{{$annonce->titre}}" class="form-control" placeholder="Annonce">
                                                                </div>
                                                            ...
                                                            <!--<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                                <div class="form-group">
                                                                    <textarea name="description" id="" value="{{$annonce->description}}" cols="30" rows="10" placeholder="Description"></textarea>                                                               
                                                                </div>
