                                ...
                                <div class="row">  
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                        <ul class="breadcome-menu">
                                            ...
                                            <li><a href="/annonces/create">Ajouter Annonces</a><span class="bread-blod"></span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
                        <div class="student-inner-std res-mg-b-30">
                            <!--<div class="student-img">
                                <img src="{{url('images',$annonce->photo)}}" style="height:200px;" alt="" />
                            </div>-->
                            <div class="student-dtl">
                                <h2>{{$annonce->titre}}</h2>
                                <!--<p class="dp">{{$annonce->description}}</p>-->
