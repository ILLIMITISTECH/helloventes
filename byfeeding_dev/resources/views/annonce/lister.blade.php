...
<html class="no-js">
                        	...
                        	<div class="navbar">
                            	<div class="navbar-inner">
	                                <ul class="breadcrumb">
	                                    ...
	                                    <li>
	                                        <a href="/annonces/create">Passer une Annonce</a> <span class="divider">/</span>	
	                                    </li>
    ...
    <div class="row-fluid">   
        <div class="span12">
                            ...
                            <div class="block">
                                <div class="navbar navbar-inner block-header">
                                    <div class="muted pull-left">Annonces</div>
                                    <div class="pull-right"><span class="badge badge-info">{{count($annonces)}}</span>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                   <form action="{{ route('annonces.destroy',$annonce->id) }}" method="POST">
                                                    <a class="btn btn-success" href="{{ route('annonces.edit',$annonce->id) }}">Modifier</a>
                                                        @csrf
                                                        @method('DELETE')
