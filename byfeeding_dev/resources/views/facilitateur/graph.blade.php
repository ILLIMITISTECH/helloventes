          ...
          <div class="card">
            ...
            <div class="card-body">
                 ...
                 @php $client = DB::table('client_facilitateurs')->where('entreprise_id', $entreprise->id)->first(); @endphp
				        ...
				        @else
				      <img width="100" height="60"  src="{{ url('images/', $entreprise->logo) }}" alt="">
				       @endif
                ...
                <div class="row"  valign="top:10px">
                    ...
                    <span style="font-family: 'MarkOffcPro-Book', arial; color: #1561a2;; font-size: 38px; line-height: 24px; margin-left:10px;  margin-top:20px;">
                     ...
                     <div align="right" class="col-lg-6"  valign="top:10px">
                            <span style="font-family: 'MarkOffcPro-Book', arial; color: #1561a2;; font-size: 30px; line-height: 24px; margin-right:10px;  margin-top:20px;">
                        <span class="outlookFallback"> Facilitateur :  <span  style="font-size:30px;" >{{Auth::user()->prenom}} {{Auth::user()->nom}}</span> </span>  
                    </span>  
                     </div>
						    </div>
						    <br><br>
                ...
                <div class="card-body">
                  ...
                  <div class="d-flex align-items-center">
                    ...
                    <div class="ps-3" style="color : #1561a2; font-size : 40px">{{count($action)}}</div>
                      ...
                      <canvas id="pieChart" style="width:1px; height:2px;" ></canvas>
...
//pie
  ...
  var myPieChart = new Chart(ctxP, {
    type: 'pie',
    data: {
      labels: ["Leadership", "Management", "Confiance en soi", "Délégation", "Écoute active", "Gestion de conflits", "Techniques de Vente et négociation", "Prise de parole en public", "Travail en équipe", "Intelligence émotionnelle", "Focus et productivité", "Orientation resultat"],
      datasets: [{
        data: [
            {{$competence_1}},{{$competence_2}},{{$competence_3}},{{$competence_4}},{{$competence_5}},{{$competence_6}},{{$competence_7}},{{$competence_8}},{{$competence_9}},{{$competence_10}},{{$competence_11}},{{$competence_12}}
             ],
        backgroundColor: ["#F7464A", "#46BFBD", "#FDB45C", "#949FB1", "#4D5360", "#FF69B4", "#8B0000", "#FFA500", "#FFFF00", "#BDB76B", "#9932CC", "#32CD32"],
        hoverBackgroundColor: ["#F7464A", "#46BFBD", "#FDB45C", "#949FB1", "#4D5360", "#FF69B4", "#8B0000", "#FFA500", "#FFFF00", "#BDB76B", "#9932CC", "#32CD32"]
      }]
    },
    options: {
      responsive: true
