    ...
    <h5>
      ...
      <div class="row">
        <div class="col-lg-10">
          ...
          <div class="card">
            <div class="card-body">
                                <h5 class="card-title">Ajouter des agents</h5>
                                <form action="/ajouter_agents" method="post" class="form-horizontal" id="demo1-upload" enctype="multipart/form-data">
                                    {{ csrf_field() }}
                                            <div class="tab-pane" id="tab1">

                                                  <fieldset>
                                                    <div class="control-group">
                                                      <label class="control-label" for="focusedInput">Prénom : (<span class="red">*</span>)</label>
                                                      <div class="controls">
                                                      <input name="prenom" type="text" class="form-control" style="width:500px;" placeholder="Prénom" required>
                                                      </div>                      
                                                    </div>
                                                    <div class="control-group">
                                                      <label class="control-label" for="focusedInput">Nom : (<span class="red">*</span>)</label>
                                                      <div class="controls">
                                                      <input name="nom" type="text" class="form-control" style="width:500px;" placeholder="Nom" required>
                                                      </div>                      
                                                    </div>
                                                    <div class="control-group">
                                                      <label class="control-label" for="focusedInput">Email : (<span class="red">*</span>)</label>
                                                      <div class="controls">
                                                      <input name="email" type="email" class="form-control" style="width:500px;" placeholder="Exemple@" required>
                                                      </div>
                                                    </div>
                                                    <div class="control-group">
                                                      <label class="control-label" for="focusedInput">Email personnel</label>
                                                      <div class="controls">
                                                      <input name="email_perso" type="email" class="form-control" style="width:500px;" placeholder="Exemple@">
                                                      </div>
                                                    </div>
                                                    <div class="control-group">
                                                      <label class="control-label" for="focusedInput">Sélecionner l'entreprise : (<span class="red">*</span>)</label>
                                                      <div class="controls">
                                                                    <select name="entreprise" style="width:500px;" class="form-control" required>
                                                    ...
                                                    <div class="control-group">
                                                      ...
                                                      <div class="controls">
                                                      <input name="fonction" type="text" class="form-control" style="width:500px;">
                                                      </div>                      
                                                    </div>
                                                    <div class="control-group">
                                                      <label class="control-label" for="focusedInput">Département</label>
                                                      <div class="controls">
                                                      <input name="departement" type="text" class="form-control" style="width:500px;" >
                                                      </div>                      
                                                    </div>
                                                    <div class="control-group">
                                                      <label class="control-label" for="focusedInput">Groupe</label>
                                                      <div class="controls">
                                                      <input name="groupe" type="text" class="form-control" style="width:500px;" >
                                                      </div>                      
                                                    </div>
                                                    <div class="control-group">
                                                      <label class="control-label" for="focusedInput">Numéro de Téléphone</label>
                                                      <div class="controls">
                                                      <input name="tel" type="text" class="form-control" style="width:500px;" >
                                                      </div>                      
                                                    </div>
                                                    <div class="control-group">
                                                      <label class="control-label" for="focusedInput">Numéro whatsapp</label>
                                                      <div class="controls">
                                                      <input name="whatshap" type="text" class="form-control" style="width:500px;" >
                                                      </div>                      
                                                    </div>
                                                    ...
                                                    <div class="control-group">
                                                      <label class="control-label" for="focusedInput">Sélecionner la Direction</label>
                                                      <div class="controls">
                                                    ...
                                                    <div class="control-group">
                                                      <label class="control-label" for="focusedInput">Sélecionner le pays</label>
                                                      <div class="controls">
