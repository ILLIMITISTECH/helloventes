    ...
    <h5>
      ...
      <div class="row">
        <div class="col-lg-12">
            <center>
             <div class="d-md-flex">
                <h1 class="card-title col-md-10 mb-md-0 mb-3 align-self-center">Détails  {{$facilitateur->prenom}} {{$facilitateur->nom}}</h1>
            </div> </center>
                        @php
                            $client = DB::table('client_facilitateurs')->where('facilitateur_id', $facilitateur->id )->get();
                            $nombre_client = DB::table('client_facilitateurs')->where('facilitateur_id', $facilitateur->id )->count();
                            $count_agent = array();
                            $i= 0;
                            $f= 0;
                        ...
                        @foreach($client as $clients)
                            @php $nombre_agent = DB::table('agents')->where('entreprise', $clients->entreprise_id )->get();    @endphp
                                @foreach($nombre_agent as $nombre_agents)
                                
                                    @php $i ++ ; @endphp
                              
                                @endforeach

                        @php $feedback = DB::table('feedback')->where('source_id', $clients->source_id )->get();   @endphp
             ...
             <div class="row">
            <div class="col-xxl-4 col-xl-4" style= " height:50px;">
              ...
              <div class="card info-card customers-card">
                ...
                <div class="card-body">
                  <h5 class="card-title" style="color:#1561a2">Nombre total de clients </h5>
                  ...
                  <div class="d-flex align-items-center">
                    ...
                    <div class="ps-3" style="color : #1561a2; font-size : 40px">{{$nombre_client}}</div>
                  </div>
              ...
              <div class="card info-card customers-card">
                ...
                <div class="card-body">
                  ...
                  <div class="d-flex align-items-center">
                    ...
                    <div class="ps-3" style="color : #1561a2; font-size : 40px">{{$i}}</div>
                  </div>
              ...
              <div class="card info-card customers-card">
                ...
                <div class="card-body">
                  ...
                  <div class="d-flex align-items-center">
                    ...
                    <div class="ps-3" style="color : #1561a2; font-size : 40px">{{$f}}</div>
                  </div>
          ...
          <div class="card" style="margin-top:150px">
            ...
            <div class="card-body">
                        ...
                        @endphp
                                 ...
                                 <div class="d-md-flex">
                                                <h4 class="card-title col-md-10 mb-md-0 mb-3 align-self-center">Les clients et participants</h4>
                                            </div> 
                                            ...
                                            <table class="table">
                                              ...
                                              <tbody>
                                                   @php    $client = DB::table('client_facilitateurs')->where('facilitateur_id', $facilitateur->id )->get(); @endphp
                                                                                                
                                                    @foreach($client as $clients)                                            
                                                <tr>
                                                     @php
                                                        $entreprise = DB::table('entreprises')->where('id', $clients->entreprise_id )->first();
                                                        $agent = DB::table('agents')->where('entreprise', $clients->entreprise_id )->get();
                                                    @endphp
                                                                                                
                                                  <td><b>{{$entreprise->libelle}}</b></td>
                                                  
                                               
                                                
                                                @foreach($agent as $agents)
                                              @php  $pays = DB::table('pays')->where('id', $agents->pays_id )->first();  @endphp
                                                    <tr>
                                                        <td></td>
