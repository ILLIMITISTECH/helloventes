        ...
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
                                 ...
                                 <div class="d-md-flex">
                                                <h4 class="card-title col-md-10 mb-md-0 mb-3 align-self-center">La liste des sources   </h4>
                                            </div> 
                                    ...
                                    <table class="table stylish-table no-wrap">
                                        <thead>
                                            ...
                                            @php $sources = DB::table('source_feedbacks')->where('entreprise_id', $client->entreprise_id)->orderBy('id', 'desc')->get();
                                                 $entreprise = DB::table('entreprises')->where('id', $client->entreprise_id)->first();
                                            @endphp
                                            @foreach($sources as $source) 
                                                ...
                                                <td class="align-middle" >
                                                    ...
                                                    <span class="d-inline-block" tabindex="0" style="margin-right : 10%;" data-toggle="tooltip" >
                                                         <form action="{{route('activer.source', $source->id)}}" method="post">
                                                              {{csrf_field()}}
                                                    ...
                                                    @else
                                                    <span class="d-inline-block" tabindex="0" style="margin-right : 10%;" data-toggle="tooltip" title="Activer">
                                                         <form action="{{route('activer.source', $source->id)}}" method="post">
                                                              {{csrf_field()}}
                                                              <input name="phase" value="1" hidden>
                                                    ...
                                                    @if($source->statut == 0)
                                                    <span class="d-inline-block" tabindex="0" style="margin-right : 10%;" data-toggle="tooltip" >
                                                       <form action="{{route('desactiver.source', $source->id)}}" method="post">
                                                              {{csrf_field()}}
                                                    ...
                                                    @else
                                                    <span class="d-inline-block" tabindex="0" style="margin-right : 10%;" data-toggle="tooltip" title="Désactiver">
                                                       <form action="{{route('desactiver.source', $source->id)}}" method="post">
                                                              {{csrf_field()}}
                                                              <input name="phase" value="2" hidden>
                                                        <button type="submit" id="PopoverCustomT-1" style="background:#f8f9fa;border:#f8f9fa" >
