    ...
    <h5>
      ...
      <div class="row">
        <div class="col-lg-10">
          ...
          <div class="card">
            <div class="card-body">
                                <h5 class="card-title">Ajouter des entreprises</h5>
                                <form action="/ajouter_entreprise" method="post" class="form-horizontal" id="demo1-upload" enctype="multipart/form-data">
                                    {{ csrf_field() }}
                                            <div class="tab-pane" id="tab1">

                                                  <fieldset>
                                                    <div class="control-group">
                                                      <label class="control-label" for="focusedInput">Nom de l'entreprise (<span class="red">*</span>)</label>
                                                      <div class="controls">
                                                      <input name="libelle" type="text" class="form-control" style="width:500px;"required >
                                                      </div>                      
                                                    </div>
                                                    ...
                                                    <div class="control-group">
                                                      ...
                                                      <div class="controls">
                                                      <input name="logo" type="file" class="form-control" style="width:500px;" >
                                                      </div>
                                                    </div>
                                                  
                                                    <div class="control-group">
                                                      <label class="control-label" for="focusedInput">Sélecionner le facilitateur (<span class="red">*</span>)</label>
                                                      <div class="controls">
