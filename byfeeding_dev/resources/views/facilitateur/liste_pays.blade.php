        ...
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
                                 ...
                                 <div class="d-md-flex">
                                                <h4 class="card-title col-md-10 mb-md-0 mb-3 align-self-center">Liste des pays   </h4>
                                            </div> 
                                    ...
                                    <table class="table stylish-table no-wrap">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="border-top-0">Totaux</th>
                                            ...
                                            @foreach($pays as $pay) 
                                            @php  $pays_nom = DB::table('pays')->where('id', $pay->pays_id)->first(); @endphp
                                            @php  $pays_count = DB::table('agents')->where('pays_id', $pays_nom->id)->select('pays_id')->groupBy('pays_id')->where('pays_id', '!=', null)->count(); @endphp  
