                                    ...
                                    <table class="table stylish-table no-wrap">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="border-top-0">Profil</th>
                                            ...
                                            @foreach($facilitateurs as $facilitateur) 
                                             ...
                                             @php $clients = DB::table('client_facilitateurs')->where('facilitateur_id', $facilitateur->id)->get(); @endphp
                                             @foreach($clients as $client) 
                                               ...
                                               <td class="align-middle" >
                                                    <div class="align-middle" >
                                                        <form action="{{ route('clientFacilitateur.destroy',$client->id) }}" method="POST">
                                                        <span class="d-inline-block" tabindex="0" style="margin-right : 10%;" data-toggle="tooltip">
                                                            <a type="submit" id="PopoverCustomT-1" class="btn btn-primary"  href="{{route('voir_detail_client.facilitateur', $client->entreprise_id)}}" >
                                                                Voir
                                                            </a>
                                                        </span>
                                                        @csrf
