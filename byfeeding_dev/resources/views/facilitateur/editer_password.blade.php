           ...
           <div class="pagetitle">
            ...
            <div class="container-fluid">
                        <div class="main-card mb-3 card">
                            <div class="card-body">
                                <form action="{{route('profil_facilitateur.update', $user->id)}}" method="post"  class="dropzone dropzone-custom needsclick add-professors" id="demo1-upload" enctype="multipart/form-data">
                                                    @method('PATCH')
                                                     @csrf
