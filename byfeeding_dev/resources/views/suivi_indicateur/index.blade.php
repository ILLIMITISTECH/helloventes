                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                        <ul class="breadcome-menu">
                                            ...
                                            <li><a href="/suivi_indicateurs/create">Ajouter Suivi indicateurs</a><span class="bread-blod"></span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
                        <div class="student-inner-std res-mg-b-30">
                            ...
                            <div class="student-dtl">
                                <h2>{{$suivi_indicateur->libelle}}</h2>
                                <p class="dp">Cible: {{$suivi_indicateur->cible}}</p>
                                <p class="dp">Date Cible: {{$suivi_indicateur->date_cible}}</p>
                                <p class="dp-ag"><b>Date du suivi:</b> {{$suivi_indicateur->date}}</p>
                                <p class="dp-ag"><b>Pourcentage:</b> {{$suivi_indicateur->pourcentage}}</p>
                                <p class="dp-ag"><b>Note:</b> {{$suivi_indicateur->note}}</p>
