                        	...
                        	<div class="navbar">
                            	<div class="navbar-inner">
	                                <ul class="breadcrumb">
	                                    ...
	                                    <li>
	                                        <a href="/indicateurs/create">Ajouter des indicateurs</a> <span class="divider">/</span>	
	                                    </li>
                                        <li>
        ...
        <div class="span12">
                            ...
                            <div class="block">
                                <div class="navbar navbar-inner block-header">
                                    ...
                                    <div class="pull-right"><span class="badge badge-info">{{count($indicateurs)}}</span>
