    ...
    <div style="  background: white;   box-sizing: border-box;   color: black;      font-family: Roboto,Arial,sans-serif;   margin: 0 auto;   min-width: 320px;   max-width: 458px;   text-align: center; ">
      <div style="  border: 1px solid #dadce0;   border-radius: 8px;   margin-bottom: 8px;">
       ...
       <img src="https://feedback.collaboratis.com/v2/assets/images/feedback.png" alt="homepage" class="dark-logo" style="max-width: 100%;"><br><br>
          ...
          <div style="font-size: 16px;   font-weight: 500;   font-family: &#39;Google Sans&#39;,Roboto,Arial,sans-serif;   letter-spacing: 0.1px;   line-height: 24px;   padding: 4px 0 38px; color:black;"><p>La session de feedback de votre client : <b>{{$client}}</b>  est maintenant configurée.</p>
Vous pouvez d’ores et déjà vous connecter pour créer les comptes des participants, importer leur liste ; et/ou leur envoyer le message de démarrage des feedbacks. 
<br><br>

Merci de signaler toute difficulté en nous joignant au (221) 78 017 60 76 / (221) 77 263 74 90 ou par email à l’adresse byfeeding@illimitis.com 
           
          
            <b style="color:#0000ff;">Merci pour la confiance, et excellente session !</b></div>
