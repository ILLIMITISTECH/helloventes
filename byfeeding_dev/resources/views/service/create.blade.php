                                ...
                                <div class="span12">
                                    <div id="rootwizard">
                                       ...
                                       <!--  <div id="bar" class="progress progress-striped active">
                                        ...
                                        <form action="{{route('services.store')}}" method="post" class="form-horizontal" id="demo1-upload" enctype="multipart/form-data">
                                    {{ csrf_field() }}
                                            <div class="tab-pane" id="tab1">
                                                  ...
                                                  <fieldset>
                                                    <div class="control-group">
                                                      ...
                                                      <input name="nom_service" type="text" class="form-control" placeholder="Service">
                                                      </div>                      
                                                    </div>
                                                    <div class="control-group">
