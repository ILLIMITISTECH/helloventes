            ...
            <div class="container-fluid">
                ...
                <h6> 
                                                      ...
                                                      @endif
                                                               ...
                                                               <form action="{{route('create.projet_action')}}" method="post" class="form-horizontal" id="demo1-upload" enctype="multipart/form-data">
                                    {{ csrf_field() }}
                                                      ...
                                                      <!--<h3 class="card-title">Sélectionner le Backup <b style="color:red;">*</b></</h3>-->
                                                            ...
                                                            <div class="row" id="formulaire">
                                                                <div class="card col-lg-12 mt-4 mb-10">
                                                                    <div class="card-body">
                                                                        <h5 class="card-title">Ajouter l'action avec un Projet</h5>
                                                                        <div id="inputFormRow">
                                                                            <div class="input-group row mb-3">
                                                                             ...
                                                                             <div class="input-group row mb-3">
                                                                              ...
                                                                              <input name="libelle_action" type="text" class="form-control" placeholder="l'action" required>
                                                                                                  
                                                                            </div>
                                                                            <div class="input-group row mb-3">
                                                                                <label class="control-label" for="focusedInput">Sélectionner le Responsable<b style="color:red;">*</b></label>                                                                                  
                                                                                <select name="agent_id" class="form-control" required>
                                                                                  <option value="none" selected="" disabled="">Sélectionner le Responsable</option>
                                                                             ...
                                                                             <div class="input-group row mb-3">
                                                                              ...
                                                                              <input name="deadlines" type="date" class="form-control" placeholder="date de l'action" required>   
...
<script src="{!! asset('assets/js/script.js') !!}"></script>
 ...
 <!--               html += ' <select name="projet_id" class="form-control">';-->
 <!--                 html += ' <option value="none" selected="" disabled="">Sélectionner le Projet</option>';-->
 <!--                  html += ' @foreach($projets as $projet)';-->
 <!--               html += '   <option value="{{$projet->id}}">{{$projet->libelle}}</option>';-->
 <!--                  html += ' @endforeach';                                    -->
 <!--              html += '  </select>';-->
 <!--              html += '  </div>';-->
 ...
 <!--                 html += ' <option value="none" selected="" disabled="">Sélectionner le Responsable</option>';-->
 ...
 <!--                html += '<div class="input-group row mb-3">';-->
 <!--               html += ' <select name="backup" class="form-control">';-->
