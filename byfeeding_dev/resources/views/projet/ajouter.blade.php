            ...
            <div class="page-breadcrumb">
                <div class="row align-items-center">
                    <div class="col-md-6 col-8 align-self-center">
                        <h3 class="page-title mb-0 p-0">Ajouter un projet</h3>
                    </div>
                                    ...
                                    {{ csrf_field() }}
                                            <div class="tab-pane" id="tab1">
                                                  ...
                                                  <fieldset>
                                                    ...
                                                    <div class="control-group">
                                                      <label class="control-label" for="focusedInput">Sélectionner le Backup du Projet<b style="color:red;">*</b></label>
                                                      <div class="controls">
                                                      ...
                                                      <!--<h3 class="card-title">Sélectionner le Backup <b style="color:red;">*</b></</h3>-->
                                                            ...
                                                            <div class="row" id="formulaire">
                                                                <div class="card col-lg-12 mt-4 mb-10">
                                                                    <div class="card-body">
                                                                        <h5 class="card-title">Ajouter les participants </h5>
                                                                        <div id="inputFormRow">
