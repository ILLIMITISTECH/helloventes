                ...
                <div class="app-main__outer">
                    <div class="app-main__inner">
                     <div class="main-card mb-3 card">
                            <div class="card-body">
                                <form action="{{route('action_projet_dash.update', $action->id)}}" method="post"  class="dropzone dropzone-custom needsclick add-professors" id="demo1-upload" enctype="multipart/form-data">
                                                    @method('PATCH')
                                                     @csrf
                                             ...
                                             <fieldset>
                                                    ...
                                                    <div class="control-group">
                                                      ...
                                                      <input name="note" id="postcode" type="text" value="{{$action->note}}" class="form-control" placeholder="notes">
                                                        ...
                                                        <div class="control-group">
                                                      <div class="controls">
                                                      <input name="projet_id" id="postcode" type="hidden" value="{{$action->projet_id}}" class="form-control" placeholder="notes">
                                                      </div>
                                                    </div>
                                                    <div class="control-group">
                                                      <div class="controls">
