                      ...
                      <div class="block">
                            ...
                            <div class="block-content collapse in">
                                ...
                                <div class="chart" data-percent="{{intval($sum_actions/count($actions))}}">{{intval($sum_actions/count($actions))}}%</div>
                                    <div class="chart-bottom-heading"><span class="label label-info">Performance de ma Team</span>
        ...
        <div class="span12">
                            ...
                            <div class="block">
                                <div class="navbar navbar-inner block-header">
                                    <div class="muted pull-left">Les taches clôturées de ma Team</div>
                                          ...
                                          <td>
                                             ...
                                             @if($action_direction->risque == 'Elevé(E)')
                                                                    ...
                                                                    <span class="text-success"><div class="chart" style="width:50px;" data-percent="{{$action_direction->pourcentage}}">{{$action_direction->pourcentage}}%</div></span>
                                                                        ...
                                                                        <td><div class="form-group" hidden>    
                                                                            
                                                                            <label style="color:black;">Votre Email</label>
                                                                        <input type="email" style="border: solid 1px gray;" class="form-control" value="{{$action_direction->email}}" name="email" id="email" placeholder="Votre Email" data-rule="email" data-msg="Please enter a valid email" />
        ...
        <div class="modal-body">
                            ...
                            <div id="selectDiv{{$action_direction->id}}">
                                ...
                                <div class="check"  style="display:flex;">       
                                 ...
                                 <center>   <input id="loginVisibilite{{$action_direction->id}}" type="radio" name="visibilite" value="3"><b style="font-size:15px; margin-left:10px; color:green;">Valider</b>
                          ...
                          @endif 
                                    ...
                                    @endforeach
                                                                       <div class="form-group" hidden>
                                                                            ...
                                                                            <input class="form-control" style="border: solid 1px gray;" name="message" rows="5" value="{{Auth::user()->prenom}} {{Auth::user()->nom}} vient de valider une action pour lequel vous l'avez clôturée" data-rule="required" data-msg="Please write something for us" placeholder="Votre Message">
                                                                            <div class="validation"></div>
                                                                            </div>
                                                                      </form>
                                                </tbody>
