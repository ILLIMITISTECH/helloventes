                                ...
                                <div class="span12">
                                    <div id="rootwizard">
                                       ...
                                       <!--  <div id="bar" class="progress progress-striped active">
                                        ...
                                        <center><form action="{{route('action_user_a.update', $action->id)}}" method="post"  class="dropzone dropzone-custom needsclick add-professors" id="demo1-upload" enctype="multipart/form-data">
                                                    @method('PATCH')
                                                     @csrf
