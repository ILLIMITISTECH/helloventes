                                                     ...
                                                     @csrf
                                                        <div class="row">
                                                                ...
                                                                <label for="">Deadline</label>
                                                                    <input name="deadline" type="text" class="form-control" value="{{$action->deadline}}" placeholder="date de l action">
                                                                </div>
                                                                <div class="form-group" hidden>
                                                                ...
                                                                <div class="form-group" hidden>
                                                                 ...
                                                                 <div class="form-group" hidden>
                                                                <label for="">Résponsable</label>
                                                                    <input name="responsable" type="hidden" class="form-control" value="{{$action->responsable}}" placeholder="Résponsable">
                                                                </div> 
                                                             ...
                                                             <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                                ...
                                                                <!-- <div class="form-group">
                                                                    <select name="agent_id" class="form-control">
                                                                      <option value="{{$action->agent_id}}"  selected="" disabled="">Select Résponsable</option>
                                                                      @foreach($agents as $agent)
                                                                      <option value="{{$agent->id}}">{{$agent->prenom}} {{$agent->nom}}</option>
                                                                      @endforeach                                    
                                                                    </select>
