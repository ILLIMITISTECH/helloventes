            ...
            @include('admin.side_bar_utilisateur')
                ...
                <div class="row-fluid">   
                    <div class="span12">
                            ...
                            <div class="block">
                                <div class="navbar navbar-inner block-header">
                                    <div class="muted pull-left">Mes <span class="badge badge-info">{{count($action_respons)}}</span> actions en instance</div>
                    ...
                    <div class="span12">
                            ...
                            <div class="block">
                                <div class="navbar navbar-inner block-header">
                                    <div class="muted pull-left">Les <span class="badge badge-info">{{count($action_respons)}}</span> actions pour lesquelles je suis Backup</div>
                                    <div class="pull-right">
