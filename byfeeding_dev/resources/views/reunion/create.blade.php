                            ...
                            <div class="block-content collapse in">
                                <div class="span12">
                                    <div id="rootwizard">
                                     ...
                                     <center>   <form action="{{route('reunions.store')}}" method="post" class="form-horizontal" id="demo1-upload" enctype="multipart/form-data">
                                    {{ csrf_field() }}
                                            ...
                                            <fieldset>
                                                    ...
                                                    <input name="objet" type="text" class="form-control" placeholder="Objet de la reunion">
                                                    </div>                      
                                                    </div>
                                                    <div class="control-group">
                                                    ...
                                                    <input name="date" type="text" value="{{date('Y/m/d')}}" class="form-control" placeholder="Date de la reunion">
                                                        </div>                    
                                                    </div>
                                                    <div class="control-group">
                                                    <label class="control-label" for="focusedInput">Nombre de participants</label>
                                                    <div class="controls">
                                                    <input name="nombre_partici" type="text" class="form-control" placeholder="Nombre de participants">
                                                    </div>
                                                    </div>
                                                    <div class="control-group">
                                                    <label class="control-label" for="focusedInput">Heure de debut</label>
                                                    <div class="controls">
                                                    <input name="heure_debut" id="postcode" type="text" class="form-control" placeholder="Heure de debut">
                                                    </div>
                                                    </div>
                                                    <div class="control-group">
                                                    <label class="control-label" for="focusedInput">Heure de fin</label>
                                                    <div class="controls">
                                                    <input name="heure_fin" id="finish" type="text" class="form-control" placeholder="Heure de fin">
                                                    </div>
                                                    </div>
                                                </fieldset>
