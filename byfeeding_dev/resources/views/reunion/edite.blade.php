                        	...
                        	<div class="navbar">
                            	<div class="navbar-inner">
	                                <ul class="breadcrumb">
	                                    ...
	                                    <li>
	                                        <a href="/reunions">Toutes les reunions</a> <span class="divider">/</span>	
	                                    </li>
                            ...
                            <div class="block-content collapse in">
                                <div class="span12">
                                    <div id="rootwizard">
                                     ...
                                     <center>   <form action="{{route('reunions.update', $reunion->id)}}" method="post" class="dropzone dropzone-custom needsclick add-professors" id="demo1-upload" enctype="multipart/form-data">
                                                    @method('PATCH')
                                                     @csrf
                                            ...
                                            <fieldset>
                                                    ...
                                                    <label class="control-label" for="focusedInput">Objet</label>
                                                    <div class="controls">
                                                    
                                                    <input name="objet" type="text" value="{{$reunion->objet}}" class="form-control" placeholder="Objet de la reunion">
                                                    </div>                      
                                                    </div>
                                                    <div class="control-group">
                                                    <label class="control-label" for="focusedInput">Date de la reunion</label>
                                                    <div class="controls">
                                                    
                                                    <input name="date" type="date" value="{{$reunion->date}}" class="form-control" placeholder="Date de la reunion">
                                                        </div>                    
                                                    </div>
                                                    <div class="control-group">
                                                    <label class="control-label" for="focusedInput">Nombre de participants</label>
                                                    <div class="controls">
                                                    <input name="nombre_partici" type="text" value="{{$reunion->nombre_partici}}"  class="form-control" placeholder="Nombre de participants">
                                                    </div>
                                                    </div>
                                                    <div class="control-group">
                                                    <label class="control-label" for="focusedInput">Heure de debut</label>
                                                    <div class="controls">
                                                    <input name="heure_debut" id="postcode" value="{{$reunion->heure_debut}}" type="text" class="form-control" placeholder="Heure de debut">
                                                    </div>
                                                    </div>
                                                    <div class="control-group">
                                                    <label class="control-label" for="focusedInput">Heure de fin</label>
                                                    <div class="controls">
                                                    <input name="heure_fin" id="finish" type="text" value="{{$reunion->heure_fin}}" class="form-control" placeholder="Heure de fin">
                                                    </div>
                                                    </div>
                                                </fieldset>
