                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                        <ul class="breadcome-menu">
                                            ...
                                            <li><a href="/reunions/create">Programmer une Reunion</a><span class="bread-blod"></span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
                        <div class="student-inner-std res-mg-b-30">
                            <div class="student-img">
                                <img src="/images/illimitis/logo.svg" style="height:200px;" alt="" />
                            </div>
                            <div class="student-dtl">
                                <h2>{{strftime("%d/%m/%Y", strtotime($reunion->date))}} {{$reunion->nom}}</h2>
                                <p class="dp">Objet: {{$reunion->objet}}</p>
                                <p class="dp">Nombre de participants: {{$reunion->nombre_partici}}</p>
                                <p class="dp-ag"><b>Heure de début:</b> {{$reunion->heure_debut}}</p>
                                <p class="dp-ag"><b>Heure de fin:</b> {{$reunion->heure_fin}}</p>
                                <!--<p class="dp-ag"><a href="{{url('images',$reunion->liste) }}" class="panel-title" title="PDF"><u>Télécharger la liste des participants</u></a></p>-->
                                <form action="{{ route('reunions.destroy',$reunion->id) }}" method="POST">
                                  <a class="btn btn-success" href="{{ route('reunions.edit',$reunion->id) }}">Modifier</a>
                                    @csrf
                                    @method('DELETE')
