    ...
    <h5>
      ...
      <!--<h1 style =" color:#4154f1">Donner un feedback</h1>-->
        @php   $as = DB::table('agents')->where('user_id', Auth::user()->id)->first(); 
            ...
            $gss = DB::table('agents')->where('entreprise', $as->entreprise)->where('id', '!=', $as->id)->orderBy('prenom', 'ASC')->pluck('id')->toArray();
                 ...
                 @if ($a->entreprise == 12)
                  ...
                  <div class="col-sm-12">
                    <select class="form-select" name="agents_id_choisi" aria-label="Default select example">
                      ...
                      @php $a = DB::table('agents')->where('user_id', Auth::user()->id)->first(); @endphp
                      @php $fedds = DB::table('feedback')->where('agent_id', $a->id)->get() @endphp
                  ...
                  <div class="col-sm-12">
                    ...
                    <select class="form-select" name="agents_id_choisi" aria-label="Default select example">
                      <option selected>Selectionner</option>
                       ...
                       @foreach($resultss as $agents)  
                      @php $agent = DB::table('agents')->where('id', $agents)->first(); @endphp
                ...
                <div class="row mb-3">
                 ...
                 <fieldset class="row mb-3">
                  ...
                  <br><br>
                    ...
                    <label for="penser3" class="form-label">A combien estimez-vous la satisfaction de ce collégue à travailler avec vous ? (utilisez la barre ci-dessous pour noter de 1 à 10) <div class="btn btn-primary">Note: <span id="penser"></span></div></label>
                  <div class="col-sm-10">
