    ...
    <h5>
      ...
      <div class="row">
        <div class="col-lg-10">
          ...
          <div class="card">
            <div class="card-body">
                                <h5 class="card-title">ByFeeding peut faciliter le suivi de vos engagements </h5>
                                Si vous souhaitez un suivi automatisé de votre plan d'actions (rappels, notifications, motivations...) ou un suivi individualisé par votre facilitateur, merci de nous aider à mieux vous connaître et à mieux connaître vos besoins en remplissant ce formulaire
                              <br> <br>
                                <form action="/suivi/byfeeding" method="post" class="form-horizontal" id="demo1-upload" enctype="multipart/form-data">
                                    {{ csrf_field() }}
                                            <div class="tab-pane" id="tab1">
                                                  ...
                                                  <fieldset>
                                                    ...
                                                    <div class="control-group" hidden>
                                                      <label class="control-label" for="focusedInput">Votre email personnel</label>
                                                      <div class="controls">
                                                      <input name="email" type="hidden"  value="{{Auth::user()->email}}" class="form-control"  placeholder="Exemple@">
                                                      </div>
                                                    </div>
                                                    <div class="control-group">
                                                      <label class="control-label" for="focusedInput">Votre téléphone mobile <b style="color:red;">*</b></label>
                                                      <div class="controls">
                                                      <input name="tel" type="text" class="form-control"  required>
                                                      </div>                      
                                                    </div>
                                                    <div class="control-group">
                                                      <label class="control-label" for="focusedInput">Votre téléphone whatsapp</label>
                                                      <div class="controls">
                                                      <input name="whatshap" type="text" class="form-control"  >
                                                      </div>                      
                                                    </div>
                                                     <div class="col-md-10">
                                                    <label for="inputEmail4" class="form-label ">Votre date de naissance  : </label>
                                                    <input type="date" name="date_naiss"  class="form-control" id="inputEmail4" >
                                                </div> 
                                               
                                                    <div class="control-group">
                                                      <label class="control-label" for="focusedInput">Votre nombre total d’années d’expériences professionnelles <b style="color:red;">*</b></label>
                                                      <div class="controls">
                                                      <input name="nombre_annee_pro" type="text" class="form-control"  required>
                                                      </div>                      
                                                    </div>
                                                    <div class="col-sm-10">
                                                    ...
                                                    <div class="col-md-12 mt-4" >
                                                        <label for="inputEmail4" class="form-label required">Avez-vous un profil LinkedIn ? </label>
                                                        <div class="form-check">
                                                          <input class="form-check-input" type="radio" name="profil_LinkedIn" id="parti" value="1" >
                                                          <label class="form-check-label" for="gridRadios1" id="show">
                                                           Oui
                                                          </label>
                                                        </div>
                                                        <div class="form-check">
                                                          <input class="form-check-input" type="radio" name="profil_LinkedIn" id="partis" value="0" checked>
                                                          <label class="form-check-label" for="gridRadios2" id="hide">
                                                            Non
                                                          </label>
                                                        </div>
                                                     </div>
                                                     <div class="control-group" id="formulaire">
                                                      <label class="control-label" for="focusedInput">Coller le lien de votre LinkedIn</label>
                                                      <div class="controls">
                                                      <input name="lien_LinkedIn" type="text" class="form-control"  >
                                                      </div>                      
                                                    </div>
