            ...
            @include('admin.side_bar_responsable')
                ...
                <div class="row-fluid">   
                    <div class="span12">
                            ...
                            <div class="block">
                                <div class="navbar navbar-inner block-header">
                                    <div class="muted pull-left">Les actions pour lesquelles {{$agent->prenom}} {{$agent->nom}} est responsable</div>
                                    <div class="pull-right"><span class="badge badge-info">{{count($action_respons)}}</span>
                    ...
                    <div class="span12">
                            ...
                            <div class="block">
                                <div class="navbar navbar-inner block-header">
                                    <div class="muted pull-left">Les actions pour lesquelles {{$agent->prenom}} {{$agent->nom}} est Backup</div>
                                    <div class="pull-right"><span class="badge badge-info">{{count($action_respons)}}</span>
