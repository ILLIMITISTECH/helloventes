                        	...
                        	<div class="navbar">
                            	<div class="navbar-inner">
	                                <ul class="breadcrumb">
	                                    ...
	                                    <li>
	                                        <a href="/suivi_actions/create">Ajouter Suivi Action</a> <span class="divider">/</span>	
	                                    </li>
        ...
        <div class="span12">
                            ...
                            <div class="block">
                                <div class="navbar navbar-inner block-header">
                                    ...
                                    <div class="pull-right"><span class="badge badge-info">{{count($suivi_actions)}}</span>
                                ...
                                <div class="block-content collapse in">
                                    <table class="table table-striped">
                                        ...
                                        @foreach($suivi_actions as $suivi_action)
                                            <tr>
                                                <td>{{$suivi_action->prenom}} {{$suivi_action->nom}}</td>
                                                <td>{{$suivi_action->libelle}}</td>
                                                <td>{{$suivi_action->deadline}}</td>
                                                <td>{{$suivi_action->pourcentage}}</td>
                                                <td>{{$suivi_action->note}}</td>
                                                <td>
