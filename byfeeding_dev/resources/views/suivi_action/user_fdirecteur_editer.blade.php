                            ...
                            <div class="block-content collapse in">
                                <div class="span12">
                                    <div id="rootwizard">
                                        ...
                                        <center><form action="{{route('action_user_fdirecteur.update', $action->id)}}" method="post"  class="dropzone dropzone-custom needsclick add-professors" id="demo1-upload" enctype="multipart/form-data">
                                                    @method('PATCH')
                                                     @csrf
