                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                        <ul class="breadcome-menu">
                                            <li><a href="/admin/dashboard/user">Tbaleau de Bord</a> <span class="bread-slash">/</span>
                                            </li>
                                            <li><a href="/admin/dashboard/user">Tous les Actions</a><span class="bread-blod"></span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>  
                                        ...
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                            <div class="review-content-section">
                                                <div id="dropzone1" class="pro-ad">
                                                    ...
                                                    <form action="{{route('suivi_actions.update', $suivi_action->id)}}" method="post"  class="dropzone dropzone-custom needsclick add-professors" id="demo1-upload" enctype="multipart/form-data">
                                                    @method('PATCH')
                                                     @csrf
                                                     <div class="row">
                                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                                <div class="form-group">
                                                                    <input name="deadline" type="date" class="form-control" value="{{$suivi_action->deadline}}" placeholder="Date de suivi">
                                                                </div>
                                                                <div class="form-group">
                                                                    <label for="">Pourcenatge(pas(%) mais juste le chiffre)</label>
                                                                    <input name="pourcentage" type="text" class="form-control" value="{{$suivi_action->pourcentage}}" placeholder="Pourcentage %">
                                                                </div>

                                                                <div class="form-group">
                                                                    <input name="delais" type="hidden" class="form-control" value="jours" placeholder="Durée Ecoulée">
                                                                </div>
                                                            ...
                                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <input name="note" type="text" class="form-control" value="{{$suivi_action->note}}" placeholder="Note">
                                                                </div>
                                                      
                                                                <input name="action_id" type="hidden" class="form-control" value="{{$suivi_action->action_id}}" placeholder="Note">
                                                                <div class="form-group">
                                                                    <input name="delais" type="hidden" class="form-control" value="{{$suivi_action->delais}}" placeholder="Durée Ecoulée">
                                                                </div>
                                                                <!-- <div class="form-group">
                                                                    <select name="action_id" class="form-control">
                                                                      <option value="{{$suivi_action->action_id}}" selected="" disabled="">Select Action</option>
