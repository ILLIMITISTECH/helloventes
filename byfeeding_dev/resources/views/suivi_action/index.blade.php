                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                        <ul class="breadcome-menu">
                                            ...
                                            <li><a href="/suivi_actions/create">Ajouter Suivi actions</a><span class="bread-blod"></span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
                        <div class="student-inner-std res-mg-b-30">
                            <div class="student-img">
                                <img src="{{url('images',$suivi_action->photo)}}" style="height:200px;" alt="" />
                            </div>
                            <div class="student-dtl">
                                <h2>{{$suivi_action->prenom}} {{$suivi_action->nom}}</h2>
                                <p class="dp">Action: {{$suivi_action->libelle}}</p>
                                <p class="dp">{{$suivi_action->deadline}}</p>
                                <p class="dp-ag"><b>Pourcentage:</b> {{$suivi_action->pourcentage}}</p>
                                <p class="dp-ag"><b>Note:</b> {{$suivi_action->note}}</p>
                                <form action="{{ route('suivi_actions.destroy',$suivi_action->id) }}" method="POST">
                                  <a class="btn btn-success" href="{{ route('suivi_actions.edit',$suivi_action->id) }}">Modifier</a>
                                    @csrf
                                    @method('DELETE')
