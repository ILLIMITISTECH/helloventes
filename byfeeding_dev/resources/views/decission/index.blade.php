                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                        <ul class="breadcome-menu">
                                            ...
                                            <li><a href="/decissions/create">Ajouter Decissions</a><span class="bread-blod"></span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
                        <div class="student-inner-std res-mg-b-30">
                            <div class="student-img">
                                <img src="{{url('images',$decission->photo)}}" style="height:200px;" alt="" />
                            </div>
                            <div class="student-dtl">
                                <h2>{{$decission->prenom}} {{$decission->nom}}</h2>
                                <p class="dp">Décission: {{$decission->libelle}}</p>
                                <p class="dp">Délais: {{$decission->delais}}</p>
                                <p class="dp-ag"><b>Date de la Reunion:</b> {{$decission->date}}</p>
                                <p class="dp-ag"><b>Heure de début:</b> {{$decission->heure_debut}}</p>
                                <p class="dp-ag"><b>Heure de fin:</b> {{$decission->heure_fin}}</p>
                                <form action="{{ route('decissions.destroy',$decission->id) }}" method="POST">
                                  <a class="btn btn-success" href="{{ route('decissions.edit',$decission->id) }}">Modifier</a>
                                    @csrf
                                    @method('DELETE')
