                                ...
                                <div class="span12">
                                    <div id="rootwizard">
                                       ...
                                       <!--  <div id="bar" class="progress progress-striped active">
                                        ...
                                        <form action="{{route('decissions.store')}}" method="post" class="form-horizontal" id="demo1-upload" enctype="multipart/form-data">
                                    {{ csrf_field() }}
                                            <div class="tab-pane" id="tab1">
                                                  ...
                                                  <fieldset>
                                                    <div class="control-group">
                                                      ...
                                                      <input name="libelle" type="text" class="form-control" placeholder="Decission">
                                                      </div>                      
                                                    </div>
                                                    <div class="control-group">
                                                      ...
                                                      <input name="delais" type="text" class="form-control" placeholder="Délais">
                                                      </div>                      
                                                    </div>
                                                    <div class="control-group">
                                                      ...
                                                      <select name="agent_id" class="form-control">
                                                                      <option value="none" selected="" disabled="">Select Agent</option>
                                                    ...
                                                    <div class="control-group">
                                                      ...
                                                      <select name="reunion_id" class="form-control">
                                                                      <option value="none" selected="" disabled="">Select Reunion</option>
