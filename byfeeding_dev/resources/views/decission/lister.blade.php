...
<html class="no-js">
                        	...
                        	<div class="navbar">
                            	<div class="navbar-inner">
	                                <ul class="breadcrumb">
	                                    ...
	                                    <li>
	                                        <a href="/decissions/create">Ajouter une decission</a> <span class="divider">/</span>	
	                                    </li>
    ...
    <div class="row-fluid">   
        <div class="span12">
                            ...
                            <div class="block">
                                <div class="navbar navbar-inner block-header">
                                    <div class="muted pull-left">Toutes les decissions</div>
                                    <div class="pull-right"><span class="badge badge-info">{{count($decissions)}}</span>
                                ...
                                <div class="block-content collapse in">
                                    <table class="table table-striped">
                                        ...
                                        @foreach($decissions as $decission)
                                            <tr>
                                                <td>{{$decission->prenom}} {{$decission->nom}}</td>
