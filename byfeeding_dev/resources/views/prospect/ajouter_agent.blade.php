    ...
    <h5>
      ...
      <div class="row">
        <div class="col-lg-10">
          ...
          <div class="card">
            <div class="card-body">
                                <h5 class="card-title">Ajout des agents</h5>
                                            ...
                                            <div class="tab-pane" id="tab1">
                                                  ...
                                                  <fieldset>
                                                    ...
                                                    <div class="control-group">
                                                      ...
                                                      <div class="controls">
                                                      <input name="fonction" type="text" class="form-control" style="width:500px;" placeholder="Nom">
                                                      </div>                      
                                                    </div>
                                                    <div class="control-group">
                                                      <label class="control-label" for="focusedInput">Département</label>
                                                      <div class="controls">
                                                      <input name="departement" type="text" class="form-control" style="width:500px;" placeholder="Nom">
                                                      </div>                      
                                                    </div>
                                                    <div class="control-group">
                                                      <label class="control-label" for="focusedInput">Groupe</label>
                                                      <div class="controls">
                                                      <input name="groupe" type="text" class="form-control" style="width:500px;" placeholder="groupe">
                                                      </div>                      
                                                    </div>
                                                    <div class="control-group">
                                                      <label class="control-label" for="focusedInput">Numéro de Téléphone</label>
                                                      <div class="controls">
                                                      <input name="tel" type="text" class="form-control" style="width:500px;" placeholder="Nom">
                                                      </div>                      
                                                    </div>
                                                    <div class="control-group">
                                                      <label class="control-label" for="focusedInput">Numéro whatsapp</label>
                                                      <div class="controls">
                                                      <input name="whatshap" type="text" class="form-control" style="width:500px;" placeholder="Nom">
                                                      </div>                      
                                                    </div>
                                                    
                                                   <div class="control-group">
                                                      <label class="control-label" for="focusedInput">Sélecionner l'entreprise</label>
                                                      <div class="controls">
                                                                    <select name="entreprise" style="width:500px;" class="form-control">
