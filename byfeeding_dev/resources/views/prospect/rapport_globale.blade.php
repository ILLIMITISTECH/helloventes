          ...
          <div class="card">
            <div class="card-body">
                ...
                <div align="left" valign="top:10px"><span style="font-family: 'MarkOffcPro-Book', arial; color: #1561a2;; font-size: 38px; line-height: 24px; margin-left:10px;  margin-top:20px;">
                                <span class="outlookFallback">{{$entreprise->libelle}}</span></span>
						    ...
						    <br><br>
                                ...
                                <span class="outlookFallback">Team Feedback Report -  du <span style="font-size: 20px;">
                                    @isset($source)
                                    {{strftime(" %d", strtotime($source->date_debut))}} au   {{strftime("%d %B, %Y", strtotime($source->date_fin))}} @endisset
                                    </span></span></span>
