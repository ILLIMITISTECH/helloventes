    ...
    <h5>
      ...
      <div class="row">
        <div class="col-lg-10">
          ...
          <div class="card">
            <div class="card-body">
                                <h5 class="card-title">{{Auth::user()->prenom}}&nbsp;{{Auth::user()->nom}} dans 5 ans</h5>
                                
                         @php $suivi = DB::table('suivi_agent_prospects')->where('agent_id', $agent->id)->OrderBy('id' , 'desc')->first(); @endphp
                                <form action="{{route('competences.a_developperSouhait', $suivi->id)}}" method="post" class="form-horizontal" id="demo1-upload" enctype="multipart/form-data">
                                    {{ csrf_field() }}
                                            ...
                                            <div class="row mb-3">
                                              <label for="inputText" class="col-sm-12 col-form-label" required>Décrivez nous qui vous souhaitez être dans 5 ans : </label>
                                              <div class="col-sm-12">
                                                  <span style="color:red">*</span>
                                                <textarea width = "50" heigth ="400px" class="form-control" name="souhait" placeholder="Dans 5 ans, je souhaite être une personne qui…" ></textarea>
                                              </div>
                                              
                                            </div><br>
                                            <div class="row mb-3">
                                              <label for="inputText" class="col-sm-12 col-form-label" required> Décrivez nous à quel poste vous souhaitez être dans 5 ans :</label>
                                              <div class="col-sm-12">
                                                  <span style="color:red">*</span>
                                                <textarea width = "30" heigth ="400px" class="form-control" name="poste_job"  ></textarea>
                                              </div>
