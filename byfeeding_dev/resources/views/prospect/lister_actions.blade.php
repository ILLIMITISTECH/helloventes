    ...
    <h5>
      @if (session('message'))
         ...
         <section class="section">
             ...
             <!--                    <form action="/searchaction_prosE" method="get" style="margsearchfin-top:5px;">-->
             <!--                       <select name="search" style="width:200px;height:40px" required>-->
             <!--                           <option value="" disabled selected>Filtrer par source</option>-->
             <!--                           <option value="Ecofast Team Building 25 Sep 2021">Ecofast Team Building 25 Sep 2021</option>-->
             <!--                           <option value="Ecofast Team Building 12 Mar 2022">Ecofast Team Building 12 Mar 2022</option>-->
             <!--                           <option onclick="window.location.href='https://feedback.collaboratis.com/liste_actions';" value >Toutes les actions</option>-->
             <!--                       </select>-->
             <!--                           <button class="btn btn-danger" style="color:white;" type="submit">Filtrer</button>-->
             <!--                   </form> -->
             <!--               </div><br>-->
                      <div class="row">
                        <div class="col-lg-12">
                        ...
                        <div class="col-lg-12">
                          ...
                          <div class="card">
                            <div class="card-body">
                                 ...
                                 <div class="d-md-flex">
                                                <h4 class="card-title col-md-10 mb-md-0 mb-3 align-self-center">Les actions de suivi</h4>
                                            </div> 
                                        
                                         @php    $action_suivi = DB::table('suivi_agent_prospects')->where('email', Auth::user()->email)->get();   @endphp
                                         
                                    <table class="table table-borderless">
                                        <thead>
                                            <tr>
                                                <th class="border-top-0">Compétences à développer  </th>
                                                <th class="border-top-0">Vision dans 5 ans</th>
                                                <th class="border-top-0">Poste dans 5 ans</th>
                                                <th class="border-top-0">Options</th>
                                                
                                            </tr>
                                            </thead>
                                            <tbody>
                                            @if($action_suivi->isEmpty() )
                                             <p>Pas d'action de suivi</p>
                                            @else
                                            @foreach($action_suivi as $action_suivis) 
                                                @php  
                                                
                                                    $competences_dev1 = DB::table('competences')->where('id', $action_suivis->competence_dev1)->first();
                                                    $competences_dev2 = DB::table('competences')->where('id', $action_suivis->competence_dev2)->first();
                                                    $competences_dev3 = DB::table('competences')->where('id', $action_suivis->competence_dev3)->first();
                                                
                                                @endphp
                                            <tr>
                                                <td class="align-middle" > {{$competences_dev1 ? $competences_dev1->libelle : '--'}} <br> {{$competences_dev2 ? $competences_dev2->libelle : '--'}} <br> {{$competences_dev3 ? $competences_dev3->libelle : '--'}}</td>
                                                                    <td class="align-middle" >
                                                                        <div class="align-middle" >
                                                                                        {{$action_suivis->souhait}}
                                                                         </div>
                                                                    ...
                                                                    <td class="align-middle" colspan ="2">
                                                                        <div class="student-dtl" style="display:flex;">
                                                                            <span class="d-inline-block" tabindex="0" style="margin-right : 10%;" data-toggle="tooltip" title="Modifier votre action">
                                                                              <a type="submit" id="PopoverCustomT-1" class="btn btn-primary"  href="{{route('action_suivi.editer', $action_suivis->id)}}" >
                                                                                   <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pencil-square" viewBox="0 0 16 16">
                                                                                      <path d="M15.502 1.94a.5.5 0 0 1 0 .706L14.459 3.69l-2-2L13.502.646a.5.5 0 0 1 .707 0l1.293 1.293zm-1.75 2.456-2-2L4.939 9.21a.5.5 0 0 0-.121.196l-.805 2.414a.25.25 0 0 0 .316.316l2.414-.805a.5.5 0 0 0 .196-.12l6.813-6.814z"/>
                                                                                      <path fill-rule="evenodd" d="M1 13.5A1.5 1.5 0 0 0 2.5 15h11a1.5 1.5 0 0 0 1.5-1.5v-6a.5.5 0 0 0-1 0v6a.5.5 0 0 1-.5.5h-11a.5.5 0 0 1-.5-.5v-11a.5.5 0 0 1 .5-.5H9a.5.5 0 0 0 0-1H2.5A1.5 1.5 0 0 0 1 2.5v11z"/>
                                                                                    </svg>
