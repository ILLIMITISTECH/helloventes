                        	...
                        	<div class="navbar">
                            	<div class="navbar-inner">
	                                <ul class="breadcrumb">
	                                    ...
	                                    <li>
	                                        <a href="/roles/create">Ajouter Role</a> <span class="divider">/</span>	
	                                    </li>
        ...
        <div class="span12">
                            ...
                            <div class="block">
                                <div class="navbar navbar-inner block-header">
                                    ...
                                    <div class="pull-right"><span class="badge badge-info">{{count($roles)}}</span>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                   <form action="{{ route('roles.destroy',$role->id) }}" method="POST">
                                                    <a class="btn btn-success" href="{{ route('roles.edit',$role->id) }}">Modifier</a>
                                                        @csrf
                                                        @method('DELETE')
