               ...
               @php
                            ...
                            <div class="card-body">
                                ...
                                <form action="/search_participant" method="get" style="margsearchfin-top:5px;">
                                  ...
                                  @php $user_tout = DB::table('users')->where('nom_role', 'entreprise')->where('entreprise', $ent->id)->orwhere('entreprise_2', $ent->id)->get();  @endphp
                             ...
                             @php $dnow = date('d'); $dnowH = date('H:i'); $hr = date('H'); $mnt = date('i') + 20; @endphp 
                                        ...
                                        @php $nbruserss = DB::table('users')->where('entreprise', $ent->id)->orwhere('entreprise_2', $ent->id)
                                ...
                                <div class="table-responsive">
                                    <table class="table user-table no-wrap">
                                        ...
                                        <tbody>
                                            ...
                                            @if($user->entreprise == $ent->id || $user->entreprise_2 == $ent->id)
                                            <tr>
