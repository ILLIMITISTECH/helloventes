<div class="row">
                            <div class="col-md-12">
                                <div class="main-card mb-3 card">
                                    <div class="card-header" style="font-family : Montserrat; color : black;">Membres de mon équipe 
                                                    ...
                                                    <div class="widget-content-wrapper">
                                                        ...
                                                        <div class="widget-content-right w-100">
                                                            <div class="text-muted opacity-6">
                                                                <b> <a href="{{route('user_agent.voir', $agent->id)}}" class="label label-info">{{$agent->prenom}} {{$agent->nom}}</a> </b>
                                                            </div> 
                                                        </div>
                                                    </div>
                                                </div>
